    ...
    public class SmtpMail : ISmtpMail
    {
        ...
        private bool SendEmail()
        {
            ...
            */
            ...
            SendBufferstr += "To:=?" + Charset.ToUpper() + "?B?" + (Yannyo.Common.Utils.StrIsNullOrEmpty(RecipientName) ? "" : Base64Encode(RecipientName)) + "?=" + "<" + Recipient[0] + ">" + enter;
