...
namespace Yannyo.Common.Generic
{
    ...
    [Serializable]
    public class List<T> : System.Collections.Generic.List<T>, IYannyoCollection<T> //:Collection<T>  // where T : new()
    {
        ...
        public void Accept(IYannyoVisitor<T> visitor)
        {
            if (visitor == null)
            {
    ...
    //        YannyoList<person> persons = new YannyoList<person>();
    ...
    //        YannyoList<student> studentsA = new YannyoList<student>();
    //        studentsA.Add(new student("daizhj", 30,1,"bjpk"));
    //        studentsA.Add(new student("wohong", 31,2,"shfd"));

    //        YannyoList<student> studentsB = new YannyoList<student>();
