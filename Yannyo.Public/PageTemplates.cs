...
namespace Yannyo.Public
{
    ...
    /// 模板生成类
    /// </summary>
    public class PageTemplates : PageTemplate
    {
        /// <summary>
        /// 解析特殊变量
        /// </summary>
        ...
        /// <returns></returns>
        public override string GetTemplate(string forumpath, string skinName, string templateName, int nest, int templateid, string Inherits)
        {
            return base.GetTemplate(forumpath, skinName, templateName, nest, templateid, Inherits);
        }
        ...
        public static DataTable GetTemplateVarList(string forumpath, string skinName)
        {
            ...
            else
            {
                ...
                cache.AddSingleObject("/Sys/" + skinName + "/TemplateVariable", dsSrc.Tables[0], filename);
