...
namespace Top.Api.Request
{
    ...
    public class WlbOrderCreateRequest : ITopRequest<WlbOrderCreateResponse>
    {
        ...
        /// <summary>
        /// {"invoince_info": [{"bill_type":"发票类型，必选", "bill_title":"发票抬头，必选", "bill_amount":"发票金额，必选","bill_content":"发票内容，可选"}]}
        /// </summary>
        ...
        /// <summary>
        /// 发收方发货方信息必选其一 手机和电话必选其一  收货方信息  邮编^^^省^^^市^^^区^^^具体地址^^^收件方名称^^^手机^^^电话    如果某一个字段的数据为空时，必须传NA
        /// </summary>
        ...
        /// <summary>
        /// 发货方信息，发收方发货方信息必选其一 手机和电话必选其一  邮编^^^省^^^市^^^区^^^具体地址^^^收件方名称^^^手机^^^电话  如果某一个字段的数据为空时，必须传NA
        /// </summary>
