...
namespace Yannyo.Config
{
    ...
    /// 系统基本设置管理类
    /// </summary>
    class MyAttachmentsTypeConfigFileManager : Yannyo.Config.DefaultConfigFileManager
    {
        ...
        private static void ReviseConfig()
        {
            ...
            //1.0正式版升级到2.0
            if (doc.DocumentElement.Name != typeof(MyAttachmentsTypeConfigInfo).Name)
            {
                XmlDocument newdoc = new XmlDocument();
                XmlNode declarenode = newdoc.CreateXmlDeclaration("1.0", null, null);

                newdoc.AppendChild(declarenode);
                XmlNode rootnode = newdoc.CreateElement(typeof(MyAttachmentsTypeConfigInfo).Name);
        ...
        public new static IConfigInfo ConfigInfo
        {
            ...
            set { m_configinfo = (MyAttachmentsTypeConfigInfo)value; }
        }
        ...
        public new static string ConfigFilePath
        {
            get
            {
                if (filename == null)
                {
                    filename = Utils.GetMapPath(BaseConfigs.GetSysPath + "config/myattachment.config");
                }
        ...
        /// </summary>
        /// <returns></returns>
        public static MyAttachmentsTypeConfigInfo LoadConfig()
        {
            ...
            return ConfigInfo as MyAttachmentsTypeConfigInfo;
        }
