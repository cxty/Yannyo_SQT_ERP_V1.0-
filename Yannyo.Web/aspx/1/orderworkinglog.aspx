<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.orderworkinglog" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("                  打印随附单\r\n");

	}	//end if


	if (dl["oType"].ToString() == "11")
	{

	templateBuilder.Append("                  正在对账\r\n");

	}	//end if


	if (dl["oType"].ToString() == "12")
	{

	templateBuilder.Append("                  对账完成\r\n");

	}	//end if


	if (dl["oType"].ToString() == "13")
	{

	templateBuilder.Append("                  完成收付款\r\n");

	}	//end if


	if (dl["oType"].ToString() == "14")
	{
	...
	if (dl["oType"].ToString() == "15")
	{

	templateBuilder.Append("                  重新对账\r\n");
