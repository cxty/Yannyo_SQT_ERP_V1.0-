<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.buy_sales_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	/* 
		本页面代码由Yannyo模板引擎生成于 2015/6/2 16:48:52. 
	*/
	...
	templateBuilder.Append("            <input type=\"hidden\" id=\"getCategory\" name=\"getCategory\" />\r\n");
	templateBuilder.Append("            <table style=\" background-color:#cccccc; width:100%\">\r\n");
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("              <td align=\"left\">查询类别：\r\n");
	templateBuilder.Append("                <select id=\"category\" name=\"category\">\r\n");
	templateBuilder.Append("                  <option value=\"0\"\r\n");

	if (selectClasses.ToString()=="0")
	{
	...
	templateBuilder.Append(">品牌</option>\r\n");
	templateBuilder.Append("                  <option value=\"2\"\r\n");

	if (selectClasses.ToString()=="2")
	{
	...
	templateBuilder.Append(">单品</option>\r\n");
	templateBuilder.Append("                  <option value=\"3\"\r\n");

	if (selectClasses.ToString()=="3")
	{
	...
	templateBuilder.Append(">区域</option>\r\n");
	templateBuilder.Append("                  <option value=\"4\"\r\n");

	if (selectClasses.ToString()=="4")
	{
	...
	templateBuilder.Append("              <input type=\"button\" id=\"tbn_submit\" name=\"btn_submit\" value=\"查询\"  style=\"width:120px;height:25px; cursor:pointer\"/>\r\n");
	templateBuilder.Append("               &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("              <input type=\"button\" id=\"export_data\" name=\"export_data\" value=\"导出数据\" style=\"width:120px;height:25px;cursor:pointer\" />\r\n");
	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("              <!--选择类别-->\r\n");
	templateBuilder.Append("               <!--客户-->\r\n");

	if (selectClasses==0)
	{

	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">客户名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">类别</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");
	...
	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">品牌名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");

	}	//end if

	templateBuilder.Append("               <!--单品-->\r\n");

	if (selectClasses==2)
	{

	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">商品名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">商品条码</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");

	}	//end if

	templateBuilder.Append("               <!--区域-->\r\n");

	if (selectClasses==3)
	{

	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">区域名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");
	...
	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">业务员名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");

	}	//end if

	templateBuilder.Append("              <!--页面加载-->\r\n");
	...
	int sp__loop__id=0;
	foreach(DataRow sp in spList.Rows)
	{
		sp__loop__id++;

	templateBuilder.Append("                 <tr>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:5%\">" + sp__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"left\" style=\"width:35%\">" + sp["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:10%\">\r\n");

	if (sp["sType"].ToString() !="")
	{

	templateBuilder.Append("                   " + sp["sType"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("                   [无类别]\r\n");

	}	//end if

	templateBuilder.Append("                   </td>\r\n");
	templateBuilder.Append("                   <td align=\"right\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sp["oQuantity"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                   </td>\r\n");
	templateBuilder.Append("                   <td align=\"right\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sp["oMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("             <!--数据合计-->\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"3\"  style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">客户</span>&nbsp;数据合计</td>\r\n");
	...
	templateBuilder.Append("                 <tr>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:5%\">" + sp__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"left\" style=\"width:35%\">" + sp["pBrand"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td align=\"right\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sp["oQuantity"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("            <!--数据合计-->\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"2\"  style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">品牌</span>&nbsp;数据合计</td>\r\n");
	...
	templateBuilder.Append("                 <tr>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:5%\">" + sp__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"left\" style=\"width:35%\">" + sp["pName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:10%\">\r\n");

	if (sp["pBarcode"].ToString() !="")
	{

	templateBuilder.Append("                   " + sp["pBarcode"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("           <!--数据合计-->\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"3\"  style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">单品</span>&nbsp;数据合计</td>\r\n");
	...
	if (sp["rName"].ToString() !="")
	{

	templateBuilder.Append("                   " + sp["rName"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("                   [区域信息不详]\r\n");
	...
	templateBuilder.Append("           <!--数据合计-->\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"2\"  style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">区域</span>&nbsp;数据合计</td>\r\n");
	templateBuilder.Append("             <td align=\"right\">" + sumD.ToString() + "</td>\r\n");
	templateBuilder.Append("             <td align=\"right\">" + sumDD.ToString() + "</td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	if (sp["sName"].ToString() !="")
	{

	templateBuilder.Append("                   " + sp["sName"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("                   [业务员信息不详]\r\n");
	...
	templateBuilder.Append("            <!--数据合计-->\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"2\"  style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">业务员</span>&nbsp;数据合计</td>\r\n");
	templateBuilder.Append("             <td align=\"right\">" + sumE.ToString() + "</td>\r\n");
	templateBuilder.Append("             <td align=\"right\">" + sumEE.ToString() + "</td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	templateBuilder.Append("            //点击查询时候\r\n");
	templateBuilder.Append("            $(document).ready(function () {\r\n");
	templateBuilder.Append("                $(\"#tbn_submit\").click(function () {\r\n");
	templateBuilder.Append("                    var bDate = $(\"#sDate\").val();\r\n");
	templateBuilder.Append("                    var eDate = $(\"#stDate\").val();\r\n");
	templateBuilder.Append("                    $(\"#getCategory\").val($(\"#category\").children('option:selected').val());\r\n");
	templateBuilder.Append("                    if (bDate > eDate) {\r\n");
	templateBuilder.Append("                        jAlert(\"日期选择错误，请重新选择！\");\r\n");
	templateBuilder.Append("                    }\r\n");
	...
	templateBuilder.Append("            $(\"#export_data\").click(function () {\r\n");
	templateBuilder.Append("                var getCategory = $(\"#category\").children('option:selected').val();\r\n");
	templateBuilder.Append("                var _url = '/buy_sales_details.aspx?Act=act&getCategory=' + getCategory + '&sDate=' + $(\"#sDate\").val() + '&stDate=' + $(\"#stDate\").val();\r\n");
