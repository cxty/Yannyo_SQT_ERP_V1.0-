<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.storehousestorageview" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/storehouse_storage.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("    <input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:sManage.Delt();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"addData\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加数据\"  onclick=\"javascript:sManage.ShowAddUserBox();\" />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button4\" style=\"margin:5px;width:100px\" class=\"B_INPUT\" value=\"导入仓库数据\" onclick=\"javascript:sManage.ShowimportdataBox();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"匹配数据\" onclick=\"javascript:sManage.ShowSyndataBox();\"  />\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button6\" style=\"margin:5px;width:150px\" class=\"B_INPUT\" value=\"查看导入详情\" onclick=\"javascript:sManage.ShowImportData();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"download\" style=\"margin:5px;width:150px;\" class=\"B_INPUT\" value=\"导入格式点击下载\" onclick=\"javascript:ShowDownloadBox('../../images/excl/导入表格式.xls');\"/>\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append(" </tr>\r\n");
	...
	templateBuilder.Append(" <b><span style=\"color:Red;font-size:10pt\">注意：产品名称为【灰色】表示该产品未匹配或存在多条，请选择按钮【匹配数据】，若任然未匹配产品名称，请查找产品名称或编号后再次导入库！</span></b><br />\r\n");
	templateBuilder.Append(" <b><span style=\"color:Red;font-size:10pt\">提示：产品名称可以在【添加数据】或【导入数据】按钮中进行查询</span></b>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div id=\"center\">\r\n");
	templateBuilder.Append("    <form action=\"\" method=\"post\" name=\"form1\" id=\"form1\">\r\n");
	templateBuilder.Append("      <div>\r\n");
	templateBuilder.Append("       <table width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"0\" class=\"tBox\" id=\"tBoxs\" style=\"font-size:9pt\">\r\n");
	...
	templateBuilder.Append("            <td width=\"8%\" align=\"left\" rowspan=\"1\">门店编号</td>\r\n");
	templateBuilder.Append("            <td width=\"12%\">门店名称</td>\r\n");
	templateBuilder.Append("            <td width=\"8%\">仓库名称</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">产品条码</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">产品名称</td>\r\n");
	templateBuilder.Append("			<td width=\"8%\" align=\"right\">产品数量</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\" align=\"right\">产品单价</td>\r\n");
	templateBuilder.Append("			<td width=\"8%\" align=\"right\">创建时间</td>\r\n");
	templateBuilder.Append("            <td width=\"8%\" align=\"right\">更新时间</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\" align=\"center\">操作</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          </table>\r\n");
	templateBuilder.Append("          </div>\r\n");
	templateBuilder.Append("          <table width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"0\" class=\"tBox\" id=\"Table1\" style=\"font-size:9pt\">\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["productStorageID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  width=\"8%\">\r\n");

	if (dl["sCode"].ToString()=="")
	{

	templateBuilder.Append("无编号\r\n");

	}
	else
	{

	templateBuilder.Append("            " + dl["sCode"].ToString().Trim() + "\r\n");

	}	//end if

	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("            <td width=\"12%\">" + dl["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"8%\">" + dl["stName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">\r\n");

	if (dl["PBarcode"].ToString()=="null")
	{
	...
	templateBuilder.Append("            " + dl["pName"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("			<span style=\"color:#cccccc\">" + dl["pName"].ToString().Trim() + "</span>\r\n");

	}	//end if

	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("            <td align=\"right\"  width=\"8%\">" + dl["pRelityStorage"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"right\"  width=\"10%\">" + dl["pMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\" width=\"8%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["pAppendTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td align=\"right\" width=\"8%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["pUpdateTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\" align=\"center\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:sManage.ShowDelUserBox(" + dl["productStorageID"].ToString().Trim() + ");\">删除</a>\r\n");
	templateBuilder.Append("            <a href=\"javascript:void(0);\" onclick=\"javascript:sManage.ShowEditUserBox(" + dl["productStorageID"].ToString().Trim() + ");\">修改</a>			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("    var sManage = new StorehouseStorageManage();\r\n");
	templateBuilder.Append("        sManage.ini();\r\n");
	templateBuilder.Append("    function HidBox() {\r\n");
	templateBuilder.Append("        sManage.HidUserBox();\r\n");
	templateBuilder.Append("        location=location;\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("    addTableListener(document.getElementById(\"tBoxs\"), 0, 0);\r\n");
	templateBuilder.Append("    function ShowDownloadBox(str) {\r\n");
	templateBuilder.Append("        window.location.href = str;\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("</" + "script>\r\n");
