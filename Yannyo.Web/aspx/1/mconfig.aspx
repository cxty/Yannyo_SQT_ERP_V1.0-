<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.mconfig" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/mconfig.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("		<td colspan=\"2\"><b>网店系统配置信息</b></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td width=\"35%\" align=\"right\">网店状态:</td>\r\n");
	templateBuilder.Append("		<td>\r\n");
	templateBuilder.Append("		  <input name=\"Taobao_Open\" type=\"radio\" id=\"radio\" value=\"1\" class=\"B_Check\" \r\n");

	if (ManageConfig.Taobao_Open == 1)
	{
	...
	templateBuilder.Append("           />\r\n");
	templateBuilder.Append("		  开启\r\n");
	templateBuilder.Append("		  <input type=\"radio\" name=\"Taobao_Open\" id=\"radio2\" value=\"0\" class=\"B_Check\" \r\n");

	if (ManageConfig.Taobao_Open == 0)
	{
	...
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("	    <td align=\"right\">接口环境:</td>\r\n");
	templateBuilder.Append("	    <td><input name=\"Taobao_SandBox\" type=\"radio\" id=\"radio3\" value=\"1\" class=\"B_Check\" \r\n");

	if (ManageConfig.Taobao_SandBox == 1)
	{
	...
	templateBuilder.Append("           />\r\n");
	templateBuilder.Append("	      安全沙箱\r\n");
	templateBuilder.Append("	      <input type=\"radio\" name=\"Taobao_SandBox\" id=\"radio4\" value=\"0\" class=\"B_Check\" \r\n");

	if (ManageConfig.Taobao_SandBox == 0)
	{
	...
	templateBuilder.Append("/>\r\n");
	templateBuilder.Append("	      正式数据 </td>\r\n");
	templateBuilder.Append("	    </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	...
	templateBuilder.Append("       <br />\r\n");
	templateBuilder.Append("    <div id=\"m_List\" name=\"m_List\">\r\n");
	templateBuilder.Append("      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\" class=\"tBox\" id=\"tBoxs2\">\r\n");
	templateBuilder.Append("  <tr  class=\"tBar\">\r\n");
	templateBuilder.Append("    <td colspan=\"5\"><b>网店系统列表</b><input name=\"b_add\" type=\"button\" class=\"B_INPUT\" id=\"b_add\" style=\"margin:5px\" value=\"添加\"  /></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td>名称</td>\r\n");
	templateBuilder.Append("    <td width=\"15%\">对应客户</td>\r\n");
	templateBuilder.Append("    <td width=\"15%\">系统状态</td>\r\n");
	templateBuilder.Append("    <td width=\"15%\">创建时间</td>\r\n");
	...
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td>" + dl["m_Name"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td>" + dl["StoresName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td id=\"m_state_" + dl["m_ConfigInfoID"].ToString().Trim() + "\">\r\n");

	if (dl["m_State"].ToString()=="0")
	{
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td>" + dl["m_AppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td><a href=\"javascript:void(0);\" onclick=\"javascript:MConfig.edit(" + dl["m_ConfigInfoID"].ToString().Trim() + ");\">修改</a> | \r\n");
	templateBuilder.Append("    <a href=\"javascript:void(0);\" onclick=\"javascript:MConfig.state(" + dl["m_ConfigInfoID"].ToString().Trim() + ");\" state=\"dl[m_State]\" id=\"m_tool_" + dl["m_ConfigInfoID"].ToString().Trim() + "\">\r\n");

	if (dl["m_State"].ToString()=="0")
	{

	templateBuilder.Append("    关闭\r\n");
	...
	templateBuilder.Append("var MConfig = new TMConfig();\r\n");
	templateBuilder.Append("MConfig.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	MConfig.HidUserBox();\r\n");
	templateBuilder.Append("	location = location;\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("addTableListener(document.getElementById(\"tBoxs\"),0,0);\r\n");
	templateBuilder.Append("addTableListener(document.getElementById(\"tBoxs2\"),0,0);\r\n");
	templateBuilder.Append("</" + "script>\r\n");
