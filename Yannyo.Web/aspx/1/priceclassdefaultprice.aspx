<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.priceclassdefaultprice" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/PriceClassDefaultPrice.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("    <div class=\"main\" id=\"PriceClassDefaultPrice\">\r\n");
	...
	templateBuilder.Append("商品:<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\">\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:PriceClassDefaultPrice.Search();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("价格类型默认价格\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:PriceClassDefaultPrice.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">" + dl["pBarcode"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:PriceClassDefaultPrice.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">" + dl["pName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td>" + dl["ProductClass"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["pStandard"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:PriceClassDefaultPrice.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">设置</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("		  );\r\n");
	templateBuilder.Append("});\r\n");
	templateBuilder.Append("var PriceClassDefaultPrice = new TPriceClassDefaultPrice();\r\n");
	templateBuilder.Append("PriceClassDefaultPrice.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	PriceClassDefaultPrice.HidUserBox();\r\n");
