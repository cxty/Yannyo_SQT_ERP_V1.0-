<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.storehouseproductspriceinfoview" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:sManage.DeltPrice();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加数据\" onclick=\"javascript:sManage.ShowAddPriceUserBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button6\" style=\"margin:5px;width:100px\" class=\"B_INPUT\" value=\"产品单价导入\" onclick=\"javascript:sManage.ShowSynPricedataBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"匹配数据\" onclick=\"javascript:sManage.ShowSyndataPriceBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"download\" style=\"margin:5px;width:150px;\" class=\"B_INPUT\" value=\"导入格式点击下载\" onclick=\"javascript:ShowDownloadBox('../../images/excl/门店产品单价导入表.xls');\"/>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div>\r\n");
	templateBuilder.Append(" <b><span style=\"color:Red;font-size:10pt\">注意：导入门店产品期初单价之前，请确保该门店产品期初数量已经导入！</span></b></div>\r\n");
	...
	templateBuilder.Append("            <td width=\"10%\">门店名称</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">仓库名称</td>\r\n");
	templateBuilder.Append("			<td width=\"15%\">产品条码</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">产品名称</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\" align=\"right\">产品单价</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\" align=\"right\">创建时间</td>\r\n");
	templateBuilder.Append("            <td width=\"12%\" align=\"right\">更新时间</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"center\">操作</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ProductPriceID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>" + dl["StoresName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["stName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("             <td>\r\n");

	if (dl["ProductsBarcode"].ToString()=="null")
	{
	...
	templateBuilder.Append("            " + dl["ProductsBarcode"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("            " + dl["ProductsName"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("			<span style=\"color:#cccccc\">" + dl["ProductsName"].ToString().Trim() + "</span>\r\n");

	}	//end if

	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("            <td align=\"right\">" + dl["pPrice"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["pUpdateTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"center\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:sManage.ShowDelPriceUserBox(" + dl["ProductPriceID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("            <a href=\"javascript:void(0);\" onclick=\"javascript:sManage.ShowEditPriceUserBox(" + dl["ProductPriceID"].ToString().Trim() + ");\">修改</a> \r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"10\">\r\n");
