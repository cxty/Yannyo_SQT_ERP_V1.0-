<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.supplier" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/Supplier.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:SupplierManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:SupplierManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\"><INPUT TYPE=\"hidden\" NAME=\"Act\" id=\"Act\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:SupplierManage.Search();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入导出\" onclick=\"javascript:SupplierManage.dataAct();\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("供货商列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"10%\">编号</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">分类</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">地址</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">电话</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">联系人</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">对账日</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">期初应付款</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["SupplierID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:SupplierManage.ShowEditUserBox(" + dl["SupplierID"].ToString().Trim() + ");\">" + dl["sName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td>" + dl["sCode"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["SupplierClassName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sAddress"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sTel"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sLinkMan"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:SupplierManage.ShowDelUserBox(" + dl["SupplierID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:SupplierManage.ShowEditUserBox(" + dl["SupplierID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</nobr>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var SupplierManage = new TSupplierManage();\r\n");
	templateBuilder.Append("SupplierManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	SupplierManage.HidUserBox();\r\n");
