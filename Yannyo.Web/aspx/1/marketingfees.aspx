<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.marketingfees" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	/* 
		本页面代码由Yannyo模板引擎生成于 2015/6/2 16:49:12. 
	*/
	...
	templateBuilder.Append("<script src=\"public/js/marketingfees.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:MarketingFees.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加支出\" onclick=\"javascript:MarketingFees.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加收入\" onclick=\"javascript:MarketingFees.ShowAddRevenueBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"批量添加\" onclick=\"javascript:MarketingFees.ShowAddBatBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button4\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入\" onclick=\"javascript:MarketingFees.ShowImportBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td >收入/支出</td>\r\n");
	templateBuilder.Append("			<td >门店/公司</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">科目</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">经办人</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">发生费用</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["MarketingFeesID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("			支出\r\n");

	}
	else
	{

	templateBuilder.Append("			收入\r\n");
	...
	templateBuilder.Append("			公司\r\n");

	}	//end if

	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td>" + dl["FeesSubjectName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["StaffName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["mFees"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["mDateTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td>" + dl["mRemark"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["mAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:MarketingFees.ShowDelUserBox(" + dl["MarketingFeesID"].ToString().Trim() + ");\">删除</a> \r\n");

	if (dl["mIsIncomeExpenditure"].ToString() == "0")
	{

	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:MarketingFees.ShowEditUserBox(" + dl["MarketingFeesID"].ToString().Trim() + ");\">修改</a>\r\n");

	}
	else
	{

	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:MarketingFees.ShowEditRevenueBox(" + dl["MarketingFeesID"].ToString().Trim() + ");\">修改</a>\r\n");
	...
	templateBuilder.Append("var MarketingFees = new TMarketingFees();\r\n");
	templateBuilder.Append("MarketingFees.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	MarketingFees.HidUserBox();\r\n");
