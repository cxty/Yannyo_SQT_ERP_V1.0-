<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.customers_dataanalysis" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	/* 
		本页面代码由Yannyo模板引擎生成于 2015/6/2 16:48:56. 
	*/
	...
	templateBuilder.Append("    <script type=\"text/javascript\" src=\"/public/js/Customers_DataAnlysis.js \"></" + "script>\r\n");
	...
	templateBuilder.Append("        <table border=\"0\" cellspacing=\"2\" cellpadding=\"2\" style=\"width:100%\">\r\n");
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td style=\"margin:5px;width:13%\">时间:<input style=\"width:60px\" name=\"bDate\" id=\"bDate\" onclick=\"new Calendar().show(this);\" value=\"" + bDate.ToString() + "\" type=\"text\" />-<input style=\"width:60px\" name=\"eDate\" id=\"eDate\" onclick=\"new Calendar().show(this);\" value=\"" + eDate.ToString() + "\" type=\"text\" /></td>\r\n");
	templateBuilder.Append("            <td style=\"margin:5px;width:13%\">统计类型:\r\n");
	templateBuilder.Append("            <select id=\"dType\" name=\"dType\">\r\n");
	...
	templateBuilder.Append("            >产品</option>\r\n");
	...
	templateBuilder.Append("            >品牌(分类)</option>\r\n");
	...
	templateBuilder.Append("            >客户单品</option>\r\n");
	templateBuilder.Append("            </select></td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"analysis_button\" name=\"analysis_button\" value=\" 分析 \" style=\"margin:5px;width:80px\" class=\"B_INPUT\"  />\r\n");
	...
	templateBuilder.Append("<div id=\"shiyan\" class=\"topbar\" style=\"width:100%\">\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tBox\" >\r\n");
	templateBuilder.Append("        <thead id=\"col_head\" style=\"width:100%\">\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">客户</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("       		  <td align=\"left\">" + dl[0].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            	<td align=\"right\" width=\"20%\">" + dl[1].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            	<td align=\"right\" width=\"20%\">\r\n");

	if (AllSumMoney>0)
	{

	 aspxrewriteurl = (decimal.Parse(dl[1].ToString()) / AllSumMoney).ToString("P");
	...
	templateBuilder.Append("       		  <td align=\"left\"></td>\r\n");
	templateBuilder.Append("            	<td align=\"right\">" + AllSumMoney.ToString() + "</td>\r\n");
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">业务员</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">促销员</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	...
	templateBuilder.Append("<div id=\"shiyan\" class=\"topbar\" style=\"width:100%\">\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tBox\" >\r\n");
	templateBuilder.Append("        <thead id=\"col_head\" >\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">品名</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">品牌(分类)</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          	<td width=\"5%\" align=\"center\">排行</td>\r\n");
	templateBuilder.Append("          	<td align=\"left\">商超系统</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	...
	templateBuilder.Append("        <thead id=\"col_head\" >\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td width=\"15%\" align=\"left\">客户名称</td>\r\n");
	templateBuilder.Append("          	<td width=\"35%\" colspan=\"2\" align=\"center\">品名</td>\r\n");
	templateBuilder.Append("            <td width=\"15%\" align=\"right\">销售数量</td>\r\n");
	templateBuilder.Append("            <td width=\"15%\" align=\"right\">销售额</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\">占比</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </thead>\r\n");
	templateBuilder.Append("</table>\r\n");
	...
	foreach(DataRow cl in cList.Rows)
	{
	 ...
	 dList = getStoreProducts(bDate,eDate,cl["StoresID"].ToString().Trim());
	
	 count = getStoreProductsCount(bDate,eDate,cl["StoresID"].ToString().Trim());
	...
	templateBuilder.Append("        	<tr>\r\n");
	templateBuilder.Append("                <td width=\"15%\" rowspan=\"" + count.ToString() + "\" align=\"left\">" + cl["sName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                        <td width=\"10%\" align=\"center\">" + dl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("          	            <td width=\"25%\" align=\"left\">" + dl[1].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                        <td width=\"15%\" align=\"right\">" + dl[2].ToString().Trim() + "\r\n");
	 sumA = decimal.Round(sumA+Convert.ToDecimal(dl[2].ToString().Trim()));
	
	templateBuilder.Append("                        </td>\r\n");
	templateBuilder.Append("                        <td width=\"15%\" align=\"right\">" + dl[3].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                        <td width=\"20%\" align=\"right\">\r\n");

	if (AllSumMoney>0)
	{

	 aspxrewriteurl = (decimal.Parse(dl[3].ToString()) / AllSumMoney).ToString("P");
	...
	templateBuilder.Append("            </tr>\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("            	<td align=\"center\" colspan=\"3\" style=\"height:30px\"><span style=\"font-size:11pt\"><b>" + cl["sName"].ToString().Trim() + "&nbsp;&nbsp;合计</b></span></td>\r\n");
	templateBuilder.Append("                <td width=\"15%\" align=\"right\"><b>" + sumA.ToString() + "</b></td>\r\n");
	templateBuilder.Append("                <td width=\"15%\" align=\"right\"><b>" + AllSumMoney.ToString() + "</b></td>\r\n");
	templateBuilder.Append("                <td width=\"20%\" align=\"right\"></td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tBox\" >\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td align=\"left\"><b>合计</b></td>\r\n");
	templateBuilder.Append("          	<td width=\"15%\" align=\"right\">" + _AllSumMoney.ToString() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"15%\" align=\"right\">" + _sumA.ToString() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\" align=\"right\"></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("</table>\r\n");
	...
	templateBuilder.Append("		var Customers_DataAnlysis = new TCustomers_DataAnlysis();\r\n");
	templateBuilder.Append("		Customers_DataAnlysis.isIsPool = " + isIsPool.ToString() + ";\r\n");
	templateBuilder.Append("		Customers_DataAnlysis.ini();\r\n");
	templateBuilder.Append("		</" + "script>\r\n");
