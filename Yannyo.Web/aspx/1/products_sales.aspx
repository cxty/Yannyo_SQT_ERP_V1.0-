<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.products_sales" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("            <input type=\"hidden\" id=\"reginID\" name=\"tType\" />\r\n");
	templateBuilder.Append("            <table  style=\"width:100%\">\r\n");
	templateBuilder.Append("            <hr style=\"visibility:hidden\" />\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:15%\">统计类型：\r\n");
	templateBuilder.Append("                  <select id=\"tType\" style=\"width:50%\">\r\n");
	...
	templateBuilder.Append(">时间段</option>\r\n");
	...
	templateBuilder.Append(">年统计</option>\r\n");
	...
	templateBuilder.Append(">月统计</option>\r\n");
	templateBuilder.Append("                  </select> \r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:20%\">日期选择：\r\n");
	...
	templateBuilder.Append("                <div class=\"showOrhidden\" style=\"visibility:visible\">\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                 至<input name=\"eDate\" class=\"eDate\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" />\r\n");
	templateBuilder.Append("                </div>\r\n");
	...
	templateBuilder.Append("                <div class=\"showOrhidden\" style=\"visibility:hidden\">\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("                <input type=\"button\" id=\"submit_btn\" name=\"submit_btn\" value=\"查询\" style=\"width:120px;height:25px; cursor:pointer\" />\r\n");
	...
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\"  style=\"width:10%;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\"  style=\"width:28%;height:30px\"><span style=\"font-size:larger\">商品名称</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\"  style=\"width:20%\"><span style=\"font-size:larger\">商品条码</span></td>\r\n");
	templateBuilder.Append("           <!--环比控制-->\r\n");

	if (tType==2)
	{

	templateBuilder.Append("           <td align=\"center\"  colspan=\"3\"  style=\"width:21%\"><span style=\"font-size:larger\">购销日均销量</span></td>\r\n");

	}
	else
	{

	templateBuilder.Append("           <td align=\"center\"  colspan=\"2\"  style=\"width:21%\"><span style=\"font-size:larger\">购销日均销量</span></td>\r\n");
	...
	templateBuilder.Append("           <td align=\"center\"  colspan=\"3\"  style=\"width:21%\"><span style=\"font-size:larger\">客户日均销量</span></td>\r\n");

	}
	else
	{

	templateBuilder.Append("           <td align=\"center\"  colspan=\"2\"  style=\"width:21%\"><span style=\"font-size:larger\">客户日均销量</span></td>\r\n");
	...
	templateBuilder.Append("            <td align=\"center\" style=\"width:7%\">日均销量</td>\r\n");
	templateBuilder.Append("            <td align=\"center\" style=\"width:7%\">同比销量</td>\r\n");
	templateBuilder.Append("            <!--环比控制-->\r\n");
	...
	templateBuilder.Append("            <td align=\"center\" style=\"width:7%\">环比销量</td>\r\n");
	templateBuilder.Append("            </div>\r\n");

	}	//end if

	templateBuilder.Append("            <!--门店销售-->\r\n");
	templateBuilder.Append("            <td align=\"center\" style=\"width:7%\">日均销量</td>\r\n");
	templateBuilder.Append("            <td align=\"center\" style=\"width:7%\">同比销量</td>\r\n");
	...
	foreach(DataRow pl in pList.Rows)
	{
	 ...
	 tpList = getProductsDay_Sales_Details(tType,pl["ProductsID"].ToString().Trim(),bDate,eDate);
	
	templateBuilder.Append("           <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\"   style=\"width:10%\">" + pl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("             <td align=\"left\"   style=\"width:28%\"><a href=\"javascript:void(0);\" onclick=\"javascript:sendInFo('" + pl["ProductsID"].ToString().Trim() + "','" + pl["pName"].ToString().Trim() + "','" + pl["pBarcode"].ToString().Trim() + "','" + tType.ToString() + "','" + bDate.ToString() + "','" + eDate.ToString() + "')\">" + pl["pName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("             <td align=\"center\"   style=\"width:20%\"><a href=\"javascript:void(0);\" onclick=\"javascript:sendInFo('" + pl["ProductsID"].ToString().Trim() + "','" + pl["pName"].ToString().Trim() + "','" + pl["pBarcode"].ToString().Trim() + "','" + tType.ToString() + "','" + bDate.ToString() + "','" + eDate.ToString() + "')\">" + pl["pBarcode"].ToString().Trim() + "</a></td>\r\n");

	if (tType==2)
	{

	 hpList = getProducts_Sale_Details_year_annulus(tType,pl["ProductsID"].ToString().Trim(),bDate,eDate);
	
	templateBuilder.Append("             <!--购销：日均销量：如果是时间段选择-->\r\n");
	...
	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("                <!--购销：同比日均销量：如果是时间段选择-->\r\n");
	...
	int tl__loop__id=0;
	foreach(DataRow tl in tpList.Rows)
	{
		tl__loop__id++;
	...
	templateBuilder.Append("             <!--购销：如果是月选择：显示环比-->\r\n");
	templateBuilder.Append("             <div style=\" visibility:visible\">\r\n");
	...
	int hl__loop__id=0;
	foreach(DataRow hl in hpList.Rows)
	{
		hl__loop__id++;
	...
	templateBuilder.Append("             <!--购销：日均销量：如果是年选择、月选择-->\r\n");
	...
	templateBuilder.Append("                <!--购销：同比日均销量：如果是年选择、月选择-->\r\n");
	templateBuilder.Append("                <td align=\"center\" style=\"width:10.5%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(tl["oQuantity"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("             <!--门店销售：日均销量：如果是时间段选择--> \r\n");
	templateBuilder.Append("             <td align=\"center\" style=\"width:7%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(pl["sNum"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                <!--门店销售：同比销量：如果是时间段选择--> \r\n");
	templateBuilder.Append("                <td align=\"center\" style=\"width:7%\">\r\n");
	...
	templateBuilder.Append("             </div>\r\n");
	templateBuilder.Append("             <!--门店销售：日均销量：如果是年选择、月选择-->\r\n");
	...
	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("             <!--门店销售：[同比]日均销量：如果是年选择、月选择-->\r\n");
	...
	templateBuilder.Append("           <tr>\r\n");
	templateBuilder.Append("           <td align=\"center\" colspan=\"3\" style=\"height:30px\"><span style=\"font-size:larger\"><b>无信息</b></span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:7%\">0.00</td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:7%\">0.00</td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:7%\">0.00</td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:7%\">0.00</td>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("           <td align=\"center\" colspan=\"3\" style=\"height:30px\"><span style=\"font-size:larger\"><b>日均销量合计</b></span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"><b>" + sumA.ToString() + "</b></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"><b>" + sumAA.ToString() + "</b></td>\r\n");
	templateBuilder.Append("           <!--购销：环比控制-->\r\n");

	if (tType==2)
	{

	templateBuilder.Append("             <div style=\" visibility:visible\">\r\n");
	templateBuilder.Append("               <td align=\"center\"><b>" + sumAAA.ToString() + "</b></td>\r\n");
	templateBuilder.Append("             </div>\r\n");

	}	//end if

	templateBuilder.Append("           <td align=\"center\"><b>" + sumB.ToString() + "</b></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"><b>" + sumBB.ToString() + "</b></td>\r\n");
	templateBuilder.Append("           <!--门店：环比控制-->\r\n");

	if (tType==2)
	{

	templateBuilder.Append("             <div style=\" visibility:visible\">\r\n");
	templateBuilder.Append("               <td align=\"center\"><b>" + sumBBB.ToString() + "</b></td>\r\n");
	templateBuilder.Append("             </div>\r\n");
