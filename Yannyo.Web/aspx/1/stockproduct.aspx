<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.stockproduct" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/stockproducts.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("            时间点：<input type=\"text\" readonly=\"readonly\" name=\"sDate\" id=\"sDate\" value=\"" + aspxrewriteurl.ToString() + "\" onClick=\"new Calendar().show(this);\" style=\"width:145px\"/>\r\n");
	...
	templateBuilder.Append("            <input type=\"button\" id=\"bt_print\" name=\"bt_print\" style=\"margin:5px\" class=\"B_INPUT\" value=\"打印盘点表\" />\r\n");
	...
	templateBuilder.Append("			<td width=\"40%\">名称</td>\r\n");
	...
	templateBuilder.Append("			<td width=\"10%\">" + dl["pBarcode"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StockProductsManage.ShowEditBox('" + dl["ProductsID"].ToString().Trim() + "');\">更新</a> \r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var StockProductsManage = new TStockProductsManage();\r\n");
	templateBuilder.Append("StockProductsManage.ini();\r\n");
	...
	templateBuilder.Append("        $.get('/stockproduct.aspx','',function(data){\r\n");
	...
	templateBuilder.Append("        else\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            var _url = '/stockproduct.aspx?Act=Export&StorageID=' + $(\"#StorageID\").children('option:selected') + '&ProductID=' + $(\"#ProductID\").val() + '&sDate=' + $(\"#sDate\").val() + '&StorageClassNum=' + $(\"#StorageClassNum\").val();\r\n");
	...
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            $.post('/stockproduct.aspx?Aclass=aclass&sClassID='+sID,'',function(data){\r\n");
	templateBuilder.Append("                 var sName=eval(\"(\"+data+\")\").sName.split(\",\");\r\n");
	templateBuilder.Append("                 var sID=eval(\"(\"+data+\")\").sID.split(\",\");\r\n");
	templateBuilder.Append("                 var count=sName.length;\r\n");
	templateBuilder.Append("                 var StorageID=document.getElementById(\"StorageID\");;\r\n");
