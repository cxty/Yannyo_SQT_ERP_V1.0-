<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.orderfield" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/OrderField.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("    <div class=\"main\" id=\"OrderField\">\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:OrderField.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:OrderField.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td width=\"20%\">单据类型</td>\r\n");
	templateBuilder.Append("            <td>字段名称</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">类型</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">单据打印显示</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">随附单打印显示</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["OrderFieldID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			 <td>\r\n");
	 aspxrewriteurl = GetOrderType(dl["OrderType"].ToString());
	
	templateBuilder.Append("" + aspxrewriteurl.ToString() + "</td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:OrderField.ShowEditUserBox(" + dl["OrderFieldID"].ToString().Trim() + ");\">" + dl["fName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	 aspxrewriteurl = GetFieldType(dl["fType"].ToString());
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:OrderField.ShowDelUserBox(" + dl["OrderFieldID"].ToString().Trim() + ");\">删除</a>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:OrderField.ShowEditUserBox(" + dl["OrderFieldID"].ToString().Trim() + ");\">修改</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");

	}	//end loop

	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"8\">" + PageBarHTML.ToString() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var OrderField = new TOrderField();\r\n");
	templateBuilder.Append("OrderField.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	OrderField.HidUserBox();\r\n");
