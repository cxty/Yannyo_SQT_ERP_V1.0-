<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.config" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("       <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"2\" class=\"tBox tBoxI\" id=\"tBoxs\">\r\n");
	templateBuilder.Append("	  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("		<td colspan=\"2\"><b>管理平台系统配置信息</b></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td width=\"20%\" align=\"right\">初始订单号:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"OrderID\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"OrderID\" id=\"OrderID\" value=\"" + ManageConfig.OrderID.ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("		  长度小于12位</td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">初始供应商号:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"SupplierCode\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"SupplierCode\" id=\"SupplierCode\" value=\"" + ManageConfig.SupplierCode.ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("		  长度小于12位</td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">初始对账单号:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"MonthlyStatementCode\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"MonthlyStatementCode\" id=\"MonthlyStatementCode\" value=\"" + ManageConfig.MonthlyStatementCode.ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("		  长度小于12位</td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("	    <td  align=\"right\">凭证号长度:</td>\r\n");
	templateBuilder.Append("	    <td ><label for=\"CertificateCodeLen\"></label>\r\n");
	templateBuilder.Append("		<input type=\"text\" name=\"CertificateCodeLen\" id=\"CertificateCodeLen\" value=\"" + ManageConfig.CertificateCodeLen.ToString().Trim() + "\"/>系统自动在凭证号前用\"0\"补齐</td>\r\n");
	templateBuilder.Append("	    </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">金额小数保留位数:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"MoneyDecimal\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"MoneyDecimal\" id=\"MoneyDecimal\" value=\"" + ManageConfig.MoneyDecimal.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">数量小数保留位数:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"QuantityDecimal\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"QuantityDecimal\" id=\"QuantityDecimal\" value=\"" + ManageConfig.QuantityDecimal.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	<tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">单据打印机名称:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"PrinterName\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"PrinterName\" id=\"PrinterName\" value=\"" + ManageConfig.PrinterName.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">单据打印宽度(cm):</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"PrintPageWidth\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"PrintPageWidth\" id=\"PrintPageWidth\" value=\"" + ManageConfig.PrintPageWidth.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">凭证打印宽度(cm):</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"PrintCertificatePageWidth\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"PrintCertificatePageWidth\" id=\"PrintCertificatePageWidth\" value=\"" + ManageConfig.PrintCertificatePageWidth.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">凭证打印行数:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"CertificateRow\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"CertificateRow\" id=\"CertificateRow\" value=\"" + ManageConfig.CertificateRow.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">随附单打印宽度(cm):</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"PrintAddPageWidth\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"PrintAddPageWidth\" id=\"PrintAddPageWidth\" value=\"" + ManageConfig.PrintAddPageWidth.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">随附单打印行数:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"PrintAddRow\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"PrintAddRow\" id=\"PrintAddRow\" value=\"" + ManageConfig.PrintAddRow.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">企业名称:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"CompanyName\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"CompanyName\" id=\"CompanyName\" value=\"" + ManageConfig.CompanyName.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">注册号:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"RegistrationNo\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"RegistrationNo\" id=\"RegistrationNo\" value=\"" + ManageConfig.RegistrationNo.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">地址:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"Address\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"Address\" id=\"Address\" value=\"" + ManageConfig.Address.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	   <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">电话:</td>\r\n");
	templateBuilder.Append("		<td ><label for=\"Phone\"></label>\r\n");
	templateBuilder.Append("		  <input type=\"text\" name=\"Phone\" id=\"Phone\" value=\"" + ManageConfig.Phone.ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">库存盘点关闭单据操作:</td>\r\n");
	templateBuilder.Append("		<td ><input name=\"Order_lock\" type=\"checkbox\" value=\"1\" id=\"Order_lock\" class=\"B_Check\"\r\n");

	if (ManageConfig.Order_lock==1)
	{
	...
	templateBuilder.Append("                  />关闭</td>\r\n");
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td  align=\"right\">财务账期关闭凭证操作:</td>\r\n");
	templateBuilder.Append("		<td ><input name=\"Certificate_lock\" type=\"checkbox\" value=\"1\" id=\"Certificate_lock\" class=\"B_Check\"\r\n");

	if (ManageConfig.Certificate_lock==1)
	{
	...
	templateBuilder.Append("	  </tr>\r\n");
	templateBuilder.Append("	  <tr>\r\n");
	templateBuilder.Append("		<td colspan=\"2\" align=\"center\"><input type=\"submit\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"   保   存   \"  /></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
