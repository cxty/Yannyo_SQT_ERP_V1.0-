<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.departmentsclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/departmentclass.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("               <tr><td><b>部门分类</b></td></tr>\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["DepartmentsClassID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%\">" + pl["dClassName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">" + pl["dOrder"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">" + pl["dAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:upDate('" + pl["DepartmentsClassID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:delData('" + pl["DepartmentsClassID"].ToString().Trim() + "','" + pl["dParentID"].ToString().Trim() + "','" + pl["dClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
