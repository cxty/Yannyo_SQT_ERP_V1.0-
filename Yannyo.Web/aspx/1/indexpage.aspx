<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.indexpage" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<link rel=\"stylesheet\" rev=\"stylesheet\" href=\"/public/js/kandytabs.css\" />\r\n");
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/kandytabs.pack.js\"></" + "script>\r\n");
	templateBuilder.Append("<div style=\"width:100%\">\r\n");
	templateBuilder.Append("<table width=\"100%\" border=0 align=\"center\" cellPadding=\"3\" cellSpacing=\"3\">\r\n");
	templateBuilder.Append("  <tbody>\r\n");
	templateBuilder.Append("  <tr height=\"70\">\r\n");
	templateBuilder.Append("    <td width=\"15%\" height=\"70\" align=\"center\" vAlign=\"bottom\" >\r\n");
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td height=\"70\" valign=\"top\">\r\n");
	templateBuilder.Append("    <div style=\"height:50px\"></div>\r\n");
	templateBuilder.Append("<dl id=\"rollleft\" >\r\n");
	templateBuilder.Append("    <dt>&nbsp;销&nbsp;售&nbsp;</dt>\r\n");
	...
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" >&nbsp;</td>\r\n");
	...
	int ol__loop__id=0;
	foreach(DataRow ol in Order.Rows)
	{
		ol__loop__id++;

	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("  <td align=\"center\" ><div class=\"erp_028\"></div></td>\r\n");
	templateBuilder.Append("  <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" valign=\"top\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_004\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_005\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_027\"></div></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("  <td align=\"center\"><a href=\"#\">商品销售</a></td>\r\n");
	templateBuilder.Append("  <td align=\"center\"></td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|3|4|5|6|7|\">审核中<br />\r\n");
	templateBuilder.Append("      (" + ol["steps_s_a"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td align=\"center\"></td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|3|4|5|6|7|\">备货中<br />\r\n");
	templateBuilder.Append("      (" + ol["steps_s_b"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|3|4|5|6|7|\">发货中<br />\r\n");
	templateBuilder.Append("      (" + ol["steps_s_c"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|3|4|5|6|7|\">等待核销<br />\r\n");
	templateBuilder.Append("      (" + ol["steps_s_d"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("  <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("  <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("    </dd>\r\n");
	templateBuilder.Append("    <dt>&nbsp;采&nbsp;购&nbsp;</dt>\r\n");
	templateBuilder.Append("    <dd>\r\n");
	templateBuilder.Append("      <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\" >&nbsp;</td>\r\n");
	...
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_029\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">商品采购</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|1|2|\">审核中<br />\r\n");
	templateBuilder.Append("(" + ol["steps_c_a"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|1|2|\">备货中<br />\r\n");
	templateBuilder.Append("(" + ol["steps_c_b"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|1|2|\">发货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_c_c"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|1|2|\">等待核销<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_c_d"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_008\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_017\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|1|2|\">等待付款<br />\r\n");
	templateBuilder.Append("(" + ol["steps_k"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("      </table>\r\n");
	templateBuilder.Append("    </dd>\r\n");
	templateBuilder.Append("    <dt>&nbsp;仓&nbsp;库&nbsp;</dt>\r\n");
	templateBuilder.Append("    <dd>\r\n");
	templateBuilder.Append("      <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\" >&nbsp;</td>\r\n");
	...
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_031\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_014\"></div></td>\r\n");
	templateBuilder.Append("          <td><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_004\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">换货</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|11|\">换货审核中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_aa"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|11|\">备货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_bb"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|11|\">发货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_cc"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|11|\">等待核销<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_dd"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          <tr>\r\n");
	...
	templateBuilder.Append("        </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_011\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">库存调整</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|8|\">审核中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_t_a"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|8|\">备货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_t_b"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|8|\">调整中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_t_c"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|8|\">等待核销<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_t_d"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	...
	templateBuilder.Append("        </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_030\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">库存调拨</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|9|\">审核中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_d_a"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|9|\">备货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_d_b"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|9|\">发货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_d_c"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|9|\">等待核销<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_d_d"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	...
	templateBuilder.Append("        </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_007\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_003\"></div></td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">坏货报损</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=1&oState=0&ordertypeStr=|10|\">审核中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_b_a"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=2&oState=0&ordertypeStr=|10|\">备货中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_b_b"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=3&oState=0&ordertypeStr=|10|\">处理中<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_b_c"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=4&oState=0&ordertypeStr=|10|\">等待核销<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_k_b_d"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">财务环节</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	...
	templateBuilder.Append("      </table>\r\n");
	templateBuilder.Append("    </dd>\r\n");
	templateBuilder.Append("    <dt>&nbsp;财&nbsp;务&nbsp;</dt>\r\n");
	templateBuilder.Append("    <dd>\r\n");
	templateBuilder.Append("      <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\" >&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_028\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_006\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_001\"></div></td>\r\n");
	templateBuilder.Append("    <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_016\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_017\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_002\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" ><div class=\"erp_021\"></div></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">销售对账</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=5&ordertypeStr=|3|4|5|6|7|&oState=0\">等待对账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_e"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=2&sSteps=0&sState=0\">新应收对账单<br />\r\n");
	templateBuilder.Append("          (" + ol["steps_l"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\" valign=\"top\" >&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=2&sSteps=1&sState=0\">等待回款<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_la"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=2&sSteps=2&sState=0\">等待结账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_ld"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=2&sSteps=3&sState=0\">已结账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_lc"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><div class=\"erp_018\"></div></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=2&sSteps=1&sState=0&y=y\">非全额回款<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_lb"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"#\">采购对账</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=5&ordertypeStr=|1|2|&oState=0\">等待对账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_eb"].ToString().Trim() + ") </a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=1&sSteps=0&sState=0\">新应付对账单<br />\r\n");
	templateBuilder.Append("          (" + ol["steps_m"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=1&sSteps=1&sState=0\">等待付款<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_ma"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=1&sSteps=2&sState=0\">等待结账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_md"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=1&sSteps=3&sState=0\">已结账<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_mc"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\"></td>\r\n");
	templateBuilder.Append("          <td align=\"center\"><a href=\"/monthlystatementlist.aspx?sType=1&sSteps=1&sState=0&y=y\">非全额付款<br />\r\n");
	templateBuilder.Append("            (" + ol["steps_mb"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("      </table>\r\n");
	templateBuilder.Append("    </dd>\r\n");
	templateBuilder.Append("    <dt>&nbsp;其&nbsp;他&nbsp;</dt>\r\n");
	templateBuilder.Append("    <dd>\r\n");
	templateBuilder.Append("    <table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	templateBuilder.Append("        <tr>\r\n");
	templateBuilder.Append("          <td align=\"center\">&nbsp;</td>\r\n");
	...
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=-2&oState=0\" >非全额收货单<br />\r\n");
	templateBuilder.Append("      (" + ol["steps_h"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td>&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"center\"><a href=\"/orderlist-0.aspx?oSteps=-2&NextID=0&oState=0\">已处理非全额<br />\r\n");
	templateBuilder.Append("      收货单<br/>\r\n");
	templateBuilder.Append("      (" + ol["steps_i"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("    <td>&nbsp;</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td width=\"20%\" valign=\"top\">\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td width=\"30%\" valign=\"top\">\r\n");
	templateBuilder.Append("    <div style=\"height:50px\"></div>\r\n");
	templateBuilder.Append("    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td>商品库存警报</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("<tr>\r\n");
	templateBuilder.Append("<td>\r\n");
	templateBuilder.Append("  <div style=\"height:300px;overflow:scroll;overflow-x:hidden;\" >\r\n");
	templateBuilder.Append("  <table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" id=\"tBoxs\" class=\"tBox\">\r\n");

	if (ProductAlarm!=null)
	{


	int pa__loop__id=0;
	foreach(DataRow pa in ProductAlarm.Rows)
	{
		pa__loop__id++;

	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(pa["QuantityA"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("<tr title=\"\r\n");
	templateBuilder.Append("仓库:" + pa["StorageName"].ToString().Trim() + "\r\n");
	templateBuilder.Append("10日出库:" + aspxrewriteurl.ToString() + ",\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(pa["QuantityB"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("20日出库:" + aspxrewriteurl.ToString() + ",\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(pa["pStorage"])+Convert.ToDecimal(pa["BeginQuantity"])+Convert.ToDecimal(pa["pStorageIn"])-Convert.ToDecimal(pa["pStorageOut"])),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("目前库存:" + aspxrewriteurl.ToString() + "\">\r\n");
	templateBuilder.Append("    <td align=\"left\">[" + pa["StorageName"].ToString().Trim() + "]" + pa["pName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td width=\"24\">\r\n");

	if ((Convert.ToDecimal(pa["pStorage"])+Convert.ToDecimal(pa["BeginQuantity"])+Convert.ToDecimal(pa["pStorageIn"])-Convert.ToDecimal(pa["pStorageOut"]))<=Convert.ToDecimal(pa["QuantityA"]))
	{

	templateBuilder.Append("    <div class=\"erp_009\" title=\"库存偏少\"></div>\r\n");

	}
	else
	{

	templateBuilder.Append("    <div class=\"erp_010\" title=\"库存偏多\"></div>\r\n");
	...
	templateBuilder.Append("	  </td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr height=\"7\">\r\n");
	templateBuilder.Append("    <td></td></tr></tbody></table>\r\n");
	templateBuilder.Append("<div style=\"height:50px;width:100%\"></div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<script language=\"javascript\" type=\"text/javascript\">\r\n");
	templateBuilder.Append("addTableListener(document.getElementById(\"tBoxs\"),0,0);\r\n");
	templateBuilder.Append("$(\"#rollleft\").KandyTabs({\r\n");
	templateBuilder.Append("	action:\"roll\",\r\n");
	templateBuilder.Append("	trigger:\"mouseup\",\r\n");
	templateBuilder.Append("	direct:\"left\"\r\n");
	templateBuilder.Append("}); \r\n");
	templateBuilder.Append("</" + "script>   \r\n");
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/activebar2.js\"></" + "script>\r\n");
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/msg.js\"></" + "script>\r\n");
