<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.productfield" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/productfield.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("               <tr><td><b>商品分类</b></td></tr>\r\n");
	...
	templateBuilder.Append("                        <input type=\"button\" id=\"add_folder\" class=\"B_INPUT\" name=\"add_folder\" value=\"添加字段 + \"  style=\"cursor:pointer\"/>\r\n");
	templateBuilder.Append("                    </div>\r\n");
	templateBuilder.Append("                 </td>\r\n");
	templateBuilder.Append("               </tr>\r\n");
	templateBuilder.Append("               <tr>\r\n");
	...
	templateBuilder.Append("                    <td style=\"width:25%\">名称</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">类型</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">排序</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">状态</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">操作时间</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">操作</td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("               <tbody id=\"edTableBody\">\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pf["ProductFieldID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%\">" + pf["pfName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:20%\">\r\n");
	templateBuilder.Append("                    " + pf["TypeName"].ToString().Trim() + "\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">" + pf["pfOrder"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">" + pf["pfAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:ProductField.ShowEditBox('" + pf["ProductFieldID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:ProductField.DeleteNode('" + pf["ProductFieldID"].ToString().Trim() + "','" + pf["ProductClassID"].ToString().Trim() + "','" + pf["pfName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	...
	templateBuilder.Append("    var ProductField = new TProductField();\r\n");
	templateBuilder.Append("    ProductField.ini();\r\n");
	templateBuilder.Append("    function HidBox() {\r\n");
	templateBuilder.Append("        ProductField.HidBox();\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("</" + "script>\r\n");
