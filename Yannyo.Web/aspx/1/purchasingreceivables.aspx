<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.purchasingreceivables" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<input type=\"hidden\" id=\"_payType\"  name=\"_payType\" />\r\n");
	templateBuilder.Append("<input type=\"hidden\" id=\"_ReType\"   name=\"_ReType\" />\r\n");
	templateBuilder.Append(" <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"background-color:#cccccc\">\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("   <td>应收类型：\r\n");
	templateBuilder.Append("    <select id=\"payType\" name=\"payType\">\r\n");
	...
	templateBuilder.Append(">个人</option>\r\n");
	...
	templateBuilder.Append(">超市系统</option>\r\n");
	templateBuilder.Append("    </select>\r\n");
	templateBuilder.Append("    &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("    对账时间：\r\n");
	 aspxrewriteurl = sDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("    <input type=\"text\" id=\"sDate\" name=\"sDate\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" style=\"width:100px\"/>\r\n");
	templateBuilder.Append("    &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("    统计类型：<select id=\"ReType\" name=\"ReType\" >\r\n");
	templateBuilder.Append("    <option value=\"0\" \r\n");
	...
	templateBuilder.Append("    <td width=\"3%\" align=\"center\" rowspan=\"1\" style=\"height:30px\"><span style=\"font-size:11pt\">序号</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">对账单号</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">收款类型</span></td>\r\n");
	templateBuilder.Append("    <td width=\"14%\" align=\"center\">\r\n");
	templateBuilder.Append("    <span style=\"font-size:11pt\">\r\n");

	if (payType==0)
	{

	templateBuilder.Append("客户名称\r\n");
	...
	templateBuilder.Append("超市系统名称\r\n");

	}	//end if

	templateBuilder.Append("    </span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">上期余额</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">本期对账金额</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">实际对账金额</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">到款金额</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">本期余额</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">是否发票</span></td>\r\n");
	templateBuilder.Append("	<td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">添加日期</span></td>\r\n");
	templateBuilder.Append("    <td width=\"8%\" align=\"center\"><span style=\"font-size:11pt\">经办人</span></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	...
	templateBuilder.Append("    <td align=\"center\">" + dl["sCode"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["sUpMoney"].ToString().Trim()),2).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["sThisMoney"].ToString().Trim()),2).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["sMoney"].ToString().Trim()),2).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["sToMoney"].ToString().Trim()),2).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["sBalanceMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("    </td> \r\n");
	templateBuilder.Append("	<td align=\"center\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["sDateTime"].ToString()).ToString("yyyy-MM-dd");
	
	templateBuilder.Append("		" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("	</td>\r\n");
	templateBuilder.Append("    <td align=\"center\">" + dl["uName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	...
	templateBuilder.Append("            $(\"#_payType\").val($(\"#payType\").children('option:selected').val());\r\n");
	templateBuilder.Append("            $(\"#_ReType\").val($(\"#ReType\").children('option:selected').val());\r\n");
