<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.diqu" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/diqu.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("               <tr><td><b>地区分类</b></td></tr>\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["RegionID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%\">" + pl["rName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">" + pl["rOrder"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">" + pl["rAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:upDate('" + pl["RegionID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:delData('" + pl["RegionID"].ToString().Trim() + "','" + pl["rUpID"].ToString().Trim() + "','" + pl["rName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
