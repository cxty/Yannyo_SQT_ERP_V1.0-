<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.personnel_statistics" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("              <td  style=\"width:46%\">查询年度：<br />\r\n");

	if (rList !=null)
	{

	templateBuilder.Append("              <select id=\"select_Date\" style=\"width:100px\">\r\n");
	...
	templateBuilder.Append("<option  value=\"" + rl["sDateTime"].ToString().Trim() + "\" \r\n");

	if (getYear==rl["sDateTime"].ToString())
	{
	...
	templateBuilder.Append("\">" + rl["sDateTime"].ToString().Trim() + "</option> \r\n");
	...
	templateBuilder.Append("              <input type=\"hidden\" id=\"getYear\" name=\"getYear\" />\r\n");
	...
	templateBuilder.Append("人员变动月报表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("        </div>\r\n");
	...
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\">月度</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:70%;height:30px\"><span style=\"font-size:11pt\">人员数量</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("                  <tr>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:10%;\">1</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\"><b>去年加入</b></span></td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:70%;\"><span style=\"font-size:11pt\"><b>" + yl["countYear"].ToString().Trim() + "</b></span></td>\r\n");
	templateBuilder.Append("                  </tr>\r\n");
	...
	templateBuilder.Append("                   <td align=\"center\" style=\"width:10%;\">\r\n");
	 c_count = Convert.ToInt32(ml__loop__id)+1;
	
	templateBuilder.Append("" + c_count.ToString() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:20%;\">本年<b>" + ml["tMonth"].ToString().Trim() + "</b>月加入</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:70%;\">\r\n");
	templateBuilder.Append("                    " + ml["sNum"].ToString().Trim() + " \r\n");
	 sumA = sumA+Convert.ToInt32(ml["sNum"].ToString().Trim());
	...
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:10%;\">14</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\"><b>本年合计</b></span></td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:70%;\"><span style=\"font-size:11pt\"><b>" + sumA.ToString() + "</b></span></td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	...
	templateBuilder.Append("                    $(\"#getYear\").val($(\"#select_Date\").children('option:selected').val());\r\n");
