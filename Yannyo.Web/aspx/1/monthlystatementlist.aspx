<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.monthlystatementlist" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"public/js/monthlystatementlist.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("    <td>对账单号:<br/><input name=\"sCode\" id=\"sCode\" value=\"" + sCode.ToString() + "\" type=\"text\" /></td>\r\n");
	templateBuilder.Append("    <td><span id=\"sObject\">对象:</span><br />\r\n");
	templateBuilder.Append("      <input name=\"sObjectName\" id=\"sObjectName\" type=\"text\" value=\"" + sObjectName.ToString() + "\" />\r\n");
	templateBuilder.Append("      <input name=\"sObjectID\" id=\"sObjectID\" type=\"hidden\" value=\"" + sObjectID.ToString() + "\" /></td>\r\n");
	templateBuilder.Append("    <td>账单类型:<br />\r\n");
	...
	templateBuilder.Append("    <td>对账对象:<br /><select name=\"sObjectType\" id=\"sObjectType\">\r\n");
	templateBuilder.Append("          <option value=\"-1\" \r\n");
	...
	templateBuilder.Append("          </select></td>\r\n");
	templateBuilder.Append("    <td>系统状态:<br><select name=\"sState\" id=\"sState\">\r\n");
	templateBuilder.Append("          <option value=\"-1\" \r\n");
	...
	templateBuilder.Append("          </select></td>\r\n");
	templateBuilder.Append("    <td colspan=\"3\" rowspan=\"2\"><input type=\"button\" id=\"button_Search\" name=\"button_Search\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 对账单查找 \"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button_add\" name=\"button_add\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 开对账单 \"  /></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("  <td>\r\n");
	templateBuilder.Append("    凭证号:<br />\r\n");
	templateBuilder.Append("    <input name=\"cCode\" id=\"cCode\" value=\"" + cCode.ToString() + "\" type=\"text\" /></td>\r\n");
	templateBuilder.Append("  <td> 对账单时间:<br />\r\n");
	templateBuilder.Append("    <input name=\"sDateTimeB\" id=\"sDateTimeB\" style=\"width:80px\" value=\"" + sDateTimeB.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly=\"readonly\"/>\r\n");
	templateBuilder.Append("    -\r\n");
	templateBuilder.Append("    <input name=\"sDateTimeE\" id=\"sDateTimeE\" style=\"width:80px\" value=\"" + sDateTimeE.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly=\"readonly\"/></td>\r\n");
	templateBuilder.Append("  <td>处理步骤:<br />\r\n");
	templateBuilder.Append("        <select name=\"sSteps\" id=\"sSteps\">\r\n");
	templateBuilder.Append("          <option value=\"-1\" \r\n");
	...
	int sl__loop__id=0;
	foreach(DataRow sl in sStepsList.Rows)
	{
		sl__loop__id++;

	templateBuilder.Append("          <option value=\"" + sl["id"].ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("    >" + sl["Name"].ToString().Trim() + "</option>\r\n");
	...
	templateBuilder.Append("          </select></td>\r\n");
	templateBuilder.Append("  <td colspan=\"2\">是否已开票:<br />\r\n");
	...
	templateBuilder.Append("应收\r\n");

	}
	else if (sType==1)
	{

	templateBuilder.Append("应付\r\n");
	...
	templateBuilder.Append("所有\r\n");

	}	//end if

	templateBuilder.Append("对账单\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("        </div>\r\n");
	...
	templateBuilder.Append("    <td width=\"5%\">对账单号</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\">对账类型</td>\r\n");
	templateBuilder.Append("    <td>对账对象</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\">账单类型</td>\r\n");
	templateBuilder.Append("    <td width=\"10%\" align=\"right\">本期对账金额</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\">处理状态</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\">发票</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">对账时间</td>\r\n");
	...
	templateBuilder.Append("  <tr >\r\n");
	templateBuilder.Append("    <td><a href=\"javascript:void(0);\" onclick=\"javascript:MonthlyStatementList.ShowData(" + dl["MonthlyStatementID"].ToString().Trim() + ",'" + dl["sCode"].ToString().Trim() + "'," + dl["sType"].ToString().Trim() + ");\">" + dl["sCode"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("    <td>\r\n");
	...
	templateBuilder.Append("    商超系统\r\n");

	}	//end if

	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td>" + dl["sObjectName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td>\r\n");

	if (dl["sType"].ToString() == "2")
	{
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td align=\"right\">" + dl["sThisMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td align=\"center\">\r\n");

	if (dl["sSteps"].ToString() == "0")
	{

	templateBuilder.Append("      新建\r\n");
	...
	if (dl["sReceiptState"].ToString() == "1")
	{
	...
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = Convert.ToDateTime(dl["sDateTime"]).ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td width=\"50%\" align=\"right\">合计:" + SumMoney.ToString() + "</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("</table>\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("  </form>\r\n");
	templateBuilder.Append("<script language=\"javascript\" type=\"text/javascript\">\r\n");
	templateBuilder.Append("var MonthlyStatementList = new TMonthlyStatementList();\r\n");
	templateBuilder.Append("MonthlyStatementList.sType=" + sType.ToString() + ";//对账单类型,应收=2,应付=1\r\n");
	templateBuilder.Append("MonthlyStatementList.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	MonthlyStatementList.HidUserBox();\r\n");
	templateBuilder.Append("}\r\n");
