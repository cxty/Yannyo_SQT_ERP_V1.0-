<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.sales" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/sales.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:SalesManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:SalesManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button4\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入永辉数据\" onclick=\"javascript:SalesManage.ShowimportdataBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"匹配数据\" onclick=\"javascript:SalesManage.ShowSyndataBox();\"  />\r\n");
	templateBuilder.Append("<br />\r\n");
	templateBuilder.Append("发生时间:<input name=\"sDate\" id=\"sDate\" style=\"width:80px\" value=\"" + sDate.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" /><input type=\"button\" id=\"bt_s\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\"   /></div>\r\n");
	templateBuilder.Append("<div class=\"datalist\">\r\n");

	if (ddList != null)
	{

	templateBuilder.Append("<b>未匹配门店</b>\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"0\" class=\"tBox\" >\r\n");
	templateBuilder.Append("  <tr>\r\n");

	int ddl__loop__id=0;
	foreach(DataRow ddl in ddList.Rows)
	{
		ddl__loop__id++;

	templateBuilder.Append("	<td><span color=\"#FF0000\">" + ddl["sStoresName"].ToString().Trim() + "</span></td>\r\n");
	...
	templateBuilder.Append("            <td >门店</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">产品</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">销售数量</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">销售金额</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["SalesID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	...
	templateBuilder.Append("			" + dl["StoresName"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("			<span style=\"color:#cccccc\">" + dl["sStoresName"].ToString().Trim() + "</span>\r\n");
	...
	templateBuilder.Append("			<span style=\"color:#cccccc\">" + dl["sProductsName"].ToString().Trim() + "</span>\r\n");

	}	//end if

	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["sNum"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"right\">" + dl["sPrice"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:SalesManage.ShowDelUserBox(" + dl["SalesID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:SalesManage.ShowEditUserBox(" + dl["SalesID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var SalesManage = new TSalesManage();\r\n");
	templateBuilder.Append("SalesManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	SalesManage.HidUserBox();\r\n");
