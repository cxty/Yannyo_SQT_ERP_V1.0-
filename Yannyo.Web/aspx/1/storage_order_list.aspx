<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.storage_order_list" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/pqgrid/jquery.min.js\"></" + "script>\r\n");
	templateBuilder.Append("<script src=\"/public/js/pqgrid/jquery-ui.min.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("<!--PQ Grid files-->\r\n");
	templateBuilder.Append("    <link rel=\"stylesheet\" href=\"/public/js/pqgrid/pqgrid.min.css\" />\r\n");
	templateBuilder.Append("    <script src=\"/public/js/pqgrid/pqgrid.min.js\"></" + "script>\r\n");
	templateBuilder.Append("<!--PQ Grid Office theme-->\r\n");
	templateBuilder.Append("    <link rel=\"stylesheet\" href=\"/public/js/pqgrid/themes/office/pqgrid.css\" />\r\n");
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/storage_order_list.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("            时间：<input type=\"text\" readonly name=\"bDate\" id=\"bDate\" value=\"" + aspxrewriteurl.ToString() + "\" onClick=\"new Calendar().show(this);\" style=\"width:145px\"/>\r\n");
	templateBuilder.Append("            -\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("            <input type=\"text\" readonly name=\"eDate\" id=\"eDate\" value=\"" + aspxrewriteurl.ToString() + "\" onClick=\"new Calendar().show(this);\" style=\"width:145px\"/>\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"button_Search\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\"  />\r\n");
	templateBuilder.Append("            <!--<input type=\"button\" id=\"export_data\" name=\"export_data\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导出数据\" />-->\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"edit_data\" name=\"edit_data\" style=\"margin:5px\" class=\"B_INPUT\" value=\"数据调整\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"datalist\">\r\n");
	templateBuilder.Append("            <div id=\"dataTable\" style=\"width:100%\">\r\n");
	templateBuilder.Append("            </div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("var bData = '';\r\n");
	templateBuilder.Append("var dData = '';\r\n");
