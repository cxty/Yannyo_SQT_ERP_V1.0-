<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.stores_armoney" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/stores_armoney.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:StoresARMoney.Search();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("应收期初列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"20%\">地区</td>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:StoresARMoney.ShowEditUserBox(" + dl["StoresID"].ToString().Trim() + ");\">" + dl["sName"].ToString().Trim() + "</a></td>\r\n");
	...
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StoresARMoney.ShowEditUserBox(" + dl["StoresID"].ToString().Trim() + ");\">设置</a>\r\n");
	templateBuilder.Append("			</nobr>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var StoresARMoney = new TStoresARMoney();\r\n");
	templateBuilder.Append("StoresARMoney.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	StoresARMoney.HidUserBox();\r\n");
