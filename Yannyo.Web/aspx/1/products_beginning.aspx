<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.products_beginning" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/Products_Beginning.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:ProductsBeginning.Search();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("商品库存期初列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"20%\">品牌</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">规格</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">单位</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">件装数</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">期初库存<br>(合计各仓库)</td>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("			<td><a href=\"javascript:void(0);\" onclick=\"javascript:ProductsBeginning.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">" + dl["pBarcode"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td><a href=\"javascript:void(0);\" onclick=\"javascript:ProductsBeginning.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">" + dl["pName"].ToString().Trim() + "</a></td>\r\n");
	...
	templateBuilder.Append("			<td align=\"right\">" + dl["Beginning"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ProductsBeginning.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">设置</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var ProductsBeginning = new TProductsBeginning();\r\n");
	templateBuilder.Append("ProductsBeginning.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ProductsBeginning.HidUserBox();\r\n");
