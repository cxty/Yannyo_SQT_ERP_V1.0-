<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.mmembers" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/m_members.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("<div>\r\n");
	templateBuilder.Append("<div class=\"toolbar\">\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td>客户昵称:<br />\r\n");
	templateBuilder.Append("<input type=\"text\" value=\"\" id=\"buyer_nick\" name=\"buyer_nick\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_s\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" /></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td><input type=\"button\" id=\"bt_DownLoad\" style=\"margin:5px\" class=\"B_INPUT\" value=\"下载数据\" />\r\n");
	templateBuilder.Append("      <input type=\"button\" id=\"bt_Delt\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" /></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	...
	templateBuilder.Append("            <td width=\"10%\">数字ID</td>\r\n");
	templateBuilder.Append("            <td width=\"18%\">昵称</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">级别</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">总交易额</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">总交易量</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">上次交易时间</td>\r\n");
	...
	templateBuilder.Append("          <tr id=\"tr_" + dl["m_MemberInfoID"].ToString().Trim() + "\">\r\n");
	templateBuilder.Append("            <td width=\"2%\">\r\n");
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["m_MemberInfoID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("		    <td width=\"10%\">" + dl["buyer_id"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"18%\"><a href=\"javascript:void(0);\" onclick=\"javascript:M_Members.Edit(" + dl["m_MemberInfoID"].ToString().Trim() + ");\">" + dl["buyer_nick"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">" + dl["member_grade"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">\r\n");
	templateBuilder.Append("			" + dl["trade_amount"].ToString().Trim() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">" + dl["trade_count"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">" + dl["laste_time"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">" + dl["status"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"center\">\r\n");
	templateBuilder.Append("              <a href=\"javascript:void(0);\" onclick=\"javascript:M_Members.Edit(" + dl["m_MemberInfoID"].ToString().Trim() + ");\">查看</a>            </td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"9\">" + PageBarHTML.ToString() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          </tfoot>\r\n");
	...
	templateBuilder.Append("var M_Members = new TM_Members();\r\n");
	templateBuilder.Append("M_Members.MConfigID = " + M_Config.m_ConfigInfoID.ToString().Trim() + ";\r\n");
	templateBuilder.Append("M_Members.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	M_Members.HidUserBox();\r\n");
