<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.productclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/productclass.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("                    <td style=\"width:20%\">上级分类</td>\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["ProductClassID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%\">" + pl["pClassName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">" + pl["pOrder"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">" + pl["pAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:ProductClass.ShowEditBox('" + pl["ProductClassID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:ProductClass.DeleteNode('" + pl["ProductClassID"].ToString().Trim() + "','" + pl["pParentID"].ToString().Trim() + "','" + pl["pClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	...
	templateBuilder.Append("    var ProductClass = new TProductClass();\r\n");
	templateBuilder.Append("    ProductClass.ini();\r\n");
	templateBuilder.Append("    function HidBox() {\r\n");
	templateBuilder.Append("        ProductClass.HidBox();\r\n");
	templateBuilder.Append("    }\r\n");
	templateBuilder.Append("</" + "script>\r\n");
