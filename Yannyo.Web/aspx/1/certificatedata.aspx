<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.certificatedata" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"public/js/certificatedata.js \"></" + "script>\r\n");
	...
	templateBuilder.Append("<!--\r\n");
	templateBuilder.Append("    <td>查看方式:<br>\r\n");
	templateBuilder.Append("<select id=\"ShowType\" name=\"ShowType\">\r\n");
	...
	templateBuilder.Append(">列表方式</option>\r\n");
	...
	templateBuilder.Append(">账本方式</option>\r\n");
	templateBuilder.Append("</select></td>\r\n");
	templateBuilder.Append("-->\r\n");
	templateBuilder.Append("    <td>单位:<br>\r\n");
	templateBuilder.Append("    <input name=\"cObjectName\" id=\"cObjectName\" type=\"text\" value=\"" + cObjectName.ToString() + "\"/>\r\n");
	templateBuilder.Append("    <input name=\"cObjectType\" id=\"cObjectType\" type=\"hidden\" value=\"" + cObjectType.ToString() + "\"/>\r\n");
	templateBuilder.Append("    <input name=\"cObjectID\" id=\"cObjectID\" type=\"hidden\" value=\"" + cObjectID.ToString() + "\"/>\r\n");
	templateBuilder.Append("    <input name=\"cObjectIsRoot\" id=\"cObjectIsRoot\" type=\"hidden\" value=\"" + cObjectIsRoot.ToString() + "\"/>\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td>科目:<br>\r\n");
	templateBuilder.Append("    <input name=\"FeesSubject\" id=\"FeesSubject\" type=\"text\" value=\"" + FeesSubject.ToString() + "\"/>\r\n");
	templateBuilder.Append("    <input name=\"FeesSubjectID\" id=\"FeesSubjectID\" type=\"hidden\" value=\"" + FeesSubjectID.ToString() + "\"/>\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td>经办人:(检索可输入*):<br>\r\n");
	...
	templateBuilder.Append("    </select></td>\r\n");
	templateBuilder.Append("    <td>发生时间:<br><input name=\"TimeB\" id=\"TimeB\" style=\"width:80px\" value=\"" + TimeB.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/>-<input name=\"TimeE\" id=\"TimeE\" style=\"width:80px\" value=\"" + TimeE.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/></td>\r\n");
	templateBuilder.Append("    <td><input type=\"button\" id=\"bt_sub\" name=\"bt_sub\" style=\"margin:5px\" class=\"B_INPUT\" value=\" 查看 \"  />\r\n");
	templateBuilder.Append("      <input type=\"button\" id=\"bt_exp\" name=\"bt_exp\" style=\"margin:5px\" class=\"B_INPUT\" value=\" 导出 \"  /></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	...
	templateBuilder.Append("    <td width=\"20%\" align=\"right\">借方金额</td>\r\n");
	templateBuilder.Append("    <td width=\"20%\" align=\"right\">贷方金额</td>\r\n");
	templateBuilder.Append("    <td width=\"20%\" align=\"right\">余额</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	...
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td>\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["cDateTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td>\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["cDateTime"].ToString()).ToString("yyyyMMdd");
	
	templateBuilder.Append("	<a href=\"javascript:void(0);\" onClick=\"javascript:CertificateData.ShowBox(" + dl["CertificateID"].ToString().Trim() + ",'" + aspxrewriteurl.ToString() + "-" + dl["cNumber"].ToString().Trim() + "');\">" + dl["cdName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("    <td>\r\n");
	 aspxrewriteurl = GetFeesSubjectClassParentStr( int.Parse(dl["FeesSubjectID"].ToString()),">");
	
	templateBuilder.Append("			" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("	</td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["cdMoney"]),2).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["cdMoneyB"]),2).ToString();
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(SumMoneyA,2).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(SumMoneyB,2).ToString();
	...
	templateBuilder.Append("var CertificateData = new TCertificateData();\r\n");
	templateBuilder.Append("CertificateData.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	CertificateData.HidUserBox();\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("//单位回调\r\n");
	templateBuilder.Append("function cObjReCall(sID,sType,sName,isRoot)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	HidBox();\r\n");
	templateBuilder.Append("	CertificateData.ShowcObjectBox_ReCall(sID,sType,sName,isRoot);\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("//科目对调\r\n");
	templateBuilder.Append("function sObjReCall(sID,sName)\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	HidBox();\r\n");
	templateBuilder.Append("	CertificateData.ShowFeesSubjectBox_ReCall(sID,sName);\r\n");
	templateBuilder.Append("}\r\n");
