<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.productsloss" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("               <td align=\"left\">查询日期：\r\n");
	...
	templateBuilder.Append("                 &nbsp; &nbsp; &nbsp; &nbsp;\r\n");
	templateBuilder.Append("                 联营：<select id=\"Associated\">\r\n");
	templateBuilder.Append("                 <option value=\"-1\" \r\n");

	if (associated.ToString()=="-1")
	{
	...
	templateBuilder.Append("                <input type=\"button\" id=\"submit_btn\" name=\"submit_btn\" value=\"查询\" style=\"width:120px;height:25px\" />&nbsp; &nbsp; &nbsp; &nbsp;\r\n");
	...
	templateBuilder.Append("           <td align=\"center\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">仓库名称</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" colspan=\"2\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">品牌</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:35%;height:30px;\"><span style=\"font-size:larger\">商品名称</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">商品条码</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">数量</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">金额</span></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	int wl__loop__id=0;
	foreach(DataRow wl in wList.Rows)
	{
		wl__loop__id++;
	...
	templateBuilder.Append("           <!--如果post的话-->\r\n");
	 rList = getProductsInfoOnLoad(sDate,eDate,associated,wl["StorageID"].ToString().Trim());
	
	 cList = productsCount(sDate,eDate,associated,wl["StorageID"].ToString().Trim());
	...
	templateBuilder.Append("rowspan=\"" + cList.ToString() + "\"\r\n");

	}	//end if

	templateBuilder.Append(" align=\"center\" style=\"width:10%\">" + wl["sName"].ToString().Trim() + "</td>\r\n");

	if (rList ==null)
	{

	templateBuilder.Append("              <td colspan=\"6\">无任何商品信息</td>\r\n");
	...
	templateBuilder.Append("             <td align=\"center\" style=\"width:3%\">" + rl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("             <td align=\"center\" style=\"width:7%\">" + rl["pBrand"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("             <td style=\"width:35%\"><a href=\"javascript:void(0);\" class=\"orderInfo\" onClick=\"javascript:sendInfo('" + wl["StorageID"].ToString().Trim() + "','" + wl["sName"].ToString().Trim() + "','" + rl["ProductsID"].ToString().Trim() + "','" + rl["pName"].ToString().Trim() + "','" + rl["pBarcode"].ToString().Trim() + "','" + sDate.ToString() + "','" + eDate.ToString() + "')\">" + rl["pName"].ToString().Trim() + "</a></td>\r\n");
	...
	templateBuilder.Append("             <a href=\"javascript:void(0);\" class=\"orderInfo\" onClick=\"javascript:sendInfo('" + wl["StorageID"].ToString().Trim() + "','" + wl["sName"].ToString().Trim() + "','" + rl["ProductsID"].ToString().Trim() + "','" + rl["pName"].ToString().Trim() + "','" + rl["pBarcode"].ToString().Trim() + "','" + sDate.ToString() + "','" + eDate.ToString() + "')\">" + rl["pBarcode"].ToString().Trim() + "</a>\r\n");

	}	//end if

	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("             <!--客户端post时候，获取该仓库联营产品详情-->\r\n");
	templateBuilder.Append("                 <td align=\"right\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(rl["oQuantity"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                 <td align=\"right\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(rl["oMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                 <td align=\"right\" style=\"width:15%\">无权限</td>\r\n");
	...
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("           <td align=\"center\" colspan=\"5\" style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">" + wl["sName"].ToString().Trim() + "</span>&nbsp;报损数据合计</td>\r\n");
	...
	templateBuilder.Append("           " + sumB.ToString() + "\r\n");
