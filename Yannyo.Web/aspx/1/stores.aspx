<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.stores" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/stores.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:StoresManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:StoresManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<!--<input type=\"button\" id=\"button6\" style=\"margin:5px\" class=\"B_INPUT\" value=\"自动导入\" onclick=\"javascript:StoresManage.ShowImportBox();\"  />-->\r\n");
	templateBuilder.Append("<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\">\r\n");
	templateBuilder.Append("状态:\r\n");
	templateBuilder.Append("    <select id=\"sState\" name=\"sState\" >\r\n");
	...
	templateBuilder.Append(">屏蔽</option>\r\n");
	templateBuilder.Append("    </select>\r\n");
	templateBuilder.Append("<INPUT TYPE=\"hidden\" NAME=\"Act\" id=\"Act\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:StoresManage.Search();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入导出\" onclick=\"javascript:StoresManage.dataAct();\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("客户列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"8%\">编号</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">类型</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">客户分类</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">价格分类</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">超市系统</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">结算系统</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">地区</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">对账日</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">期初应收款</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">状态</td>\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:StoresManage.ShowEditUserBox(" + dl["StoresID"].ToString().Trim() + ");\">" + dl["sName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td>" + dl["sCode"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sType"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["CustomersClassName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["PriceClassName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["YHsysName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["PaymentSystemName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	 aspxrewriteurl = GetRegionPaterStr(dl["RegionID"].ToString());
	
	templateBuilder.Append("" + aspxrewriteurl.ToString() + "</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">" + dl["sDoDay"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">" + dl["sDoDayMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <!--<td>" + dl["sAppendTime"].ToString().Trim() + "</td>-->\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<nobr>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StoresManage.ShowDelUserBox(" + dl["StoresID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StoresManage.ShowEditUserBox(" + dl["StoresID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</nobr>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"13\">\r\n");
	...
	templateBuilder.Append("var StoresManage = new TStoresManage();\r\n");
	templateBuilder.Append("StoresManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	StoresManage.HidUserBox();\r\n");
