<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.priceclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/priceclass.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("               <tr><td><b>价格分类</b></td></tr>\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["PriceClassID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	...
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:upDate('" + pl["PriceClassID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:delData('" + pl["PriceClassID"].ToString().Trim() + "','" + pl["pParentID"].ToString().Trim() + "','" + pl["pClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
