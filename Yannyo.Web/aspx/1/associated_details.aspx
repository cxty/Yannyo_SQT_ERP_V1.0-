<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.associated_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("            <div style=\"background-color:#cccccc\">\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"reginID\" name=\"reginID\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"aID\" name=\"aID\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"tType\" name=\"tType\" />\r\n");
	templateBuilder.Append("            <table  style=\"width:100%\">\r\n");
	templateBuilder.Append("            <hr style=\"visibility:hidden\" />\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("              <td style=\"width:15%\">统计方式：\r\n");
	templateBuilder.Append("              <select id=\"tjType\" style=\"width:100px;\">\r\n");
	...
	templateBuilder.Append(">合成统计</option>\r\n");
	...
	templateBuilder.Append(">分步统计</option>\r\n");
	templateBuilder.Append("              </select>\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("               <td style=\"width:15%\">\r\n");
	templateBuilder.Append("               <div id=\"div_region\" style=\"visibility:hidden\">\r\n");
	templateBuilder.Append("                区域选择：\r\n");

	if (rList !=null)
	{

	templateBuilder.Append("                   <select id=\"sel_regionName\">\r\n");
	templateBuilder.Append("                     <option value=\"0\">查看全部</option>\r\n");
	...
	templateBuilder.Append("                     <option value=\"" + rl["RegionID"].ToString().Trim() + "\" \r\n");

	if (sel_rId.ToString()==rl["RegionID"].ToString())
	{
	...
	templateBuilder.Append(">" + rl["rName"].ToString().Trim() + "</option>\r\n");
	...
	templateBuilder.Append("               </div>      \r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td  align=\"left\" style=\"width:20%\">日期选择：\r\n");
	 aspxrewriteurl = bDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                 <input name=\"bDate\" id=\"bDate\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" />\r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td  align=\"left\" style=\"width:15%\">联营：\r\n");
	templateBuilder.Append("                <select id=\"Associated\">\r\n");
	templateBuilder.Append("                 <option value=\"-1\"\r\n");
	...
	templateBuilder.Append("                <input type=\"button\" id=\"submit_btn\" name=\"submit_btn\" value=\"查询\" class=\"B_INPUT\" style=\"cursor:pointer\" />&nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("                <input type=\"button\" id=\"export_data\" name=\"export_data\" value=\"导出数据\" class=\"B_INPUT\" style=\"cursor:pointer\" />\r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("              <tr>\r\n");
	...
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("               <td colspan=\"6\"><span style=\"font-size:13px; color:Red\"><b>友情提示：查看门店详情请点击[分步统计]</b></span></td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("            </table>\r\n");
	templateBuilder.Append("         </div>\r\n");
	templateBuilder.Append("         <div id=\"space\"></div>\r\n");
	templateBuilder.Append("         <!--合成统计-->\r\n");
	...
	templateBuilder.Append("          <table id=\"get_data\" class=\"tBox\" border=\"0\" cellpadding=\"0\" cellspacing=\"2\" style=\"width:100%\">\r\n");
	...
	templateBuilder.Append("              <td align=\"center\"  colspan=\"2\" rowspan=\"2\" style=\"width:35%\"><span style=\"font-size:larger\"><b>商品名称</b></span></td>\r\n");
	...
	templateBuilder.Append("              <td align=\"center\"  rowspan=\"2\" style=\"width:10%\"><span style=\"font-size:larger\"><b>截止日期</b></span></td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	templateBuilder.Append("          </table>\r\n");
	...
	foreach(DataRow sl in sList.Rows)
	{
	 ...
	 pList = getProductDetails(sl["StoresID"].ToString().Trim(),tType);
	
	 pCount = p_count(sl["StoresID"].ToString().Trim(),tType);
	...
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" rowspan=\"" + pCount.ToString() + "\" style=\"width:15%\">" + sl["sName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                  <td align=\"left\"  style=\"width:30%\">" + pl["pName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                  </td>\r\n");
	templateBuilder.Append("                  <td align=\"center\"  style=\"width:10%\">\r\n");
	 aspxrewriteurl = Convert.ToDateTime(pl["pAppendtime"].ToString().Trim()).ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("            </tr>\r\n");
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("              <td align=\"center\" colspan=\"5\" style=\"height:30px;font-size:11pt;\"><span style=\"font-size:11pt; font-weight:bold\">" + sl["sName"].ToString().Trim() + "</span>&nbsp;客户费用合计</td>\r\n");
	templateBuilder.Append("              <td align=\"center\" >" + sumD.ToString() + "</td>\r\n");
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\" style=\"width:5%;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\" style=\"width:30%\"><span style=\"font-size:larger\">门店名称</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\" style=\"width:15%\"><span style=\"font-size:larger\">门店类型</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\" style=\"width:15%\"><span style=\"font-size:larger\">库存数量</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  colspan=\"2\" style=\"width:20%\"><span style=\"font-size:larger\">库存金额</span></td>\r\n");
	templateBuilder.Append("           <td align=\"center\"  rowspan=\"2\" style=\"width:15%\"><span style=\"font-size:larger\">截止日期</span></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("           <td align=\"right\">销售金额</td>\r\n");
	templateBuilder.Append("           <td align=\"right\">成本金额</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	int sll__loop__id=0;
	foreach(DataRow sll in mList.Rows)
	{
		sll__loop__id++;

	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("                 <td align=\"center\" style=\"width:5%;\">" + sll__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                 <td align=\"center\" style=\"width:30%\"><a href=\"javascript:void(0);\" onclick=\"javascript:sendInFo(" + sll["StoresID"].ToString().Trim() + "," + sType.ToString() + ",'" + sll["pAppendTime"].ToString().Trim() + "','" + sll["sName"].ToString().Trim() + "')\">" + sll["sName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("                 <td align=\"center\" style=\"width:15%\">" + sll["sType"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                 <td align=\"center\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sll["pRelityStorage"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                 <td align=\"right\" style=\"width:10%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sll["pMoney"].ToString().Trim()),2).ToString();
	...
	if (Show=="1")
	{
	 ...
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sll["qMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("                 </td>\r\n");
	templateBuilder.Append("                 <td align=\"center\" style=\"width:15%\">\r\n");
	 aspxrewriteurl = Convert.ToDateTime(sll["pAppendTime"].ToString().Trim()).ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("               <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" colspan=\"3\" style=\"height:30px\"><span style=\"font-size:larger\"><b>合&nbsp;&nbsp;计</b></span></td>\r\n");
