<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.logs" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("    <td width=\"5%\">编号</td>\r\n");
	templateBuilder.Append("    <td width=\"10%\">人员</td>\r\n");
	templateBuilder.Append("    <td>事件</td>\r\n");
	...
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td align=\"center\">" + dl["EventLogID"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td align=\"left\">" + dl["UserName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td align=\"left\">" + dl["eMSG"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td align=\"left\">" + dl["eAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
