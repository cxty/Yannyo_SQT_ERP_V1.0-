<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.apmoney" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/apmoney.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ApmoneyManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:ApmoneyManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button4\" style=\"margin:5px\" class=\"B_INPUT\" value=\"批量添加\" onclick=\"javascript:ApmoneyManage.ShowAddBatBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button2\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入\" onclick=\"javascript:ApmoneyManage.ShowImportUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"3%\">类型</td>\r\n");
	templateBuilder.Append("			<td >名称</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">科目</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">新增应付金额</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">实际应付金额</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">已付金额</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">备注</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">发生时间</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">创建时间</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["APMoneyID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td><nobr><a href=\"javascript:void(0);\" onclick=\"javascript:ApmoneyManage.ShowEditUserBox(" + dl["APMoneyID"].ToString().Trim() + ");\">" + dl["APObjName"].ToString().Trim() + "</a></nobr></td>\r\n");
	templateBuilder.Append("			<td align=\"center\">" + dl["FeesSubjectName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["aNPMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"right\">" + dl["aPMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["aPayMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["aReMake"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["aDoDateTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td>" + dl["aAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ApmoneyManage.ShowDelUserBox(" + dl["APMoneyID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ApmoneyManage.ShowEditUserBox(" + dl["APMoneyID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var ApmoneyManage = new TApmoneyManage();\r\n");
	templateBuilder.Append("ApmoneyManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ApmoneyManage.HidUserBox();\r\n");
