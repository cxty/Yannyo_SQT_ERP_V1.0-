<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.warehouseinventory_view" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/warehouseview.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("<script src=\"/public/js/WebCalendar.js\" type=\"text/javascript\" ></" + "script>\r\n");
	templateBuilder.Append("<script type=\"text/javascript\" language=\"javascript\" src=\"/public/js/jTable.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("  <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width:100%;background-color:#cccccc\">\r\n");
	...
	templateBuilder.Append("         &nbsp; &nbsp; &nbsp; &nbsp;\r\n");
	templateBuilder.Append("         时间点：<input type=\"text\" readonly=\"readonly\" name=\"sDate\" id=\"sDate\" onClick=\"new Calendar().show(this);\"/>\r\n");
	templateBuilder.Append("          &nbsp; &nbsp; &nbsp; &nbsp;\r\n");
	templateBuilder.Append("          <input type=\"button\" id=\"add\" name=\"add\" style=\"margin:5px;width:150px\" class=\"B_INPUT\" value=\"添加盘点信息\"/>\r\n");
	templateBuilder.Append("         </td>\r\n");
	templateBuilder.Append("     </tr>\r\n");
	...
	templateBuilder.Append("            <td width=\"5%\" height=\"30px\" align=\"center\" rowspan=\"1\"><span style=\"font-size:11pt\">序号</span></td>\r\n");
	templateBuilder.Append("            <td width=\"15%\"><span style=\"font-size:11pt\">盘点时间</span></td>\r\n");
	templateBuilder.Append("            <td width=\"20%\"><span style=\"font-size:11pt\">仓库名称</span></td>\r\n");
	templateBuilder.Append("			<td width=\"15%\"><span style=\"font-size:11pt\">仓管员</span></td>\r\n");
	templateBuilder.Append("			<td width=\"15%\"><span style=\"font-size:11pt\">盘点人</span></td>\r\n");
	templateBuilder.Append("			<td width=\"15%\"><span style=\"font-size:11pt\">库存点</span></td>\r\n");
	templateBuilder.Append("            <td width=\"15%\"><span style=\"font-size:11pt\">操作员</span></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">" + dl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("             <td width=\"15%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["sUpdateTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("              <a href=\"javascript:void(0);\" onclick=\"javascript:StockProductsManage.ShowHouseInventoryList(" + dl["StockID"].ToString().Trim() + ");\">" + aspxrewriteurl.ToString() + "</a>\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"sUpdateTime\" name=\"sUpdateTime\"  value=\"" + dl["sUpdateTime"].ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td width=\"20%\">\r\n");
	templateBuilder.Append("             <a href=\"javascript:void(0);\" onclick=\"javascript:StockProductsManage.ShowHouseInventoryList(" + dl["StockID"].ToString().Trim() + ");\">\r\n");
	templateBuilder.Append("              " + dl["StorageName"].ToString().Trim() + "\r\n");
	templateBuilder.Append("             </a>  \r\n");
	templateBuilder.Append("             <input type=\"hidden\" id=\"StorageName\" name=\"StorageName\"  value=\"" + dl["StorageID"].ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td width=\"15%\">" + dl["StorageStaff"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"15%\">" + dl["InventoryName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"15%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["sAppendTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("           " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("           </td>\r\n");
	templateBuilder.Append("            <td width=\"15%\">" + dl["StaffName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
