<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.bankmoney" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/bankmoney.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<!--\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:BankMoney.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"管理银行\" onclick=\"javascript:BankMoney.ShowAddBankBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:BankMoney.ShowAddMoneyBox();\"  />\r\n");
	templateBuilder.Append("-->\r\n");
	templateBuilder.Append("<!--<input type=\"button\" id=\"button4\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入\" onclick=\"javascript:BankMoney.ShowImportBox();\"  />-->\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("					<td width=\"5%\">" + fl["bName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("				<input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["tdate"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>-->\r\n");
	templateBuilder.Append("			<td width=\"5%\">" + dl["tdate"].ToString().Trim() + "</td>\r\n");
	 sumMoney = 0;
	...
	templateBuilder.Append("					<td width=\"5%\"  align=\"right\">\r\n");
	 sumMoney = sumMoney+decimal.Parse(dl["Bank_"+(fl__loop__id-1).ToString()].ToString());
	
	 tStr = dl["Bank_"+(fl__loop__id-1).ToString()].ToString();
	
	templateBuilder.Append("					" + tStr.ToString() + "\r\n");
	templateBuilder.Append("					</td>\r\n");
	...
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">\r\n");
	templateBuilder.Append("			" + sumMoney.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<!--<td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:BankMoney.ShowEditBox('" + dl["tdate"].ToString().Trim() + "');\">修改</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:BankMoney.ShowDelBox('" + dl["tdate"].ToString().Trim() + "');\">删除</a> \r\n");
	templateBuilder.Append("			</td>-->\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var BankMoney = new TBankMoney();\r\n");
	templateBuilder.Append("BankMoney.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	BankMoney.HidUserBox();\r\n");
