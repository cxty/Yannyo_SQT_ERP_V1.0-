<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.certificateworkinglog" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("        <h2>凭证编号:" + ci.cCode.ToString().Trim() + "</h2>\r\n");
	...
	if (dl["cType"].ToString() == "4")
	{

	templateBuilder.Append("                  撤回重审\r\n");

	}	//end if

	templateBuilder.Append("                  </td>\r\n");
	templateBuilder.Append("                  <td>" + dl["cMsg"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
