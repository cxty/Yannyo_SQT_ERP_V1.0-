<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.orderlist" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	/* 
		本页面代码由Yannyo模板引擎生成于 2016-03-09 22:07:22. 
	*/
	...
	templateBuilder.Append("<script src=\"public/js/orderlist.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/jquery.jFlash.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("        <input type=\"button\" id=\"button_o\" style=\"margin:3px\" class=\"B_INPUT\" value=\" 开 单 \"  />\r\n");
	templateBuilder.Append("        <input type=\"button\" id=\"button_e\" style=\"margin:3px;\" class=\"B_INPUT\" value=\" 导 出 \"   />\r\n");

	if (CheckUserPopedoms("X"))
	{

	templateBuilder.Append("        <input type=\"button\" id=\"button_a\" style=\"margin:3px;\" class=\"B_INPUT\" value=\" 导出（含子单据）\"   />\r\n");

	}	//end if

	templateBuilder.Append("        <input type=\"button\" id=\"button_s\" style=\"margin:3px;\" class=\"B_INPUT\" value=\" 查 找 \"   />\r\n");
	templateBuilder.Append("        </div>\r\n");

	if (oSteps!=-2)
	{

	templateBuilder.Append("<!--非查询非全额单据-->\r\n");
	templateBuilder.Append("        <table border=\"0\" cellspacing=\"2\" cellpadding=\"2\" id=\"s_box\">\r\n");
	...
	templateBuilder.Append("(检索输入*)<br/>\r\n");
	templateBuilder.Append("                <input name=\"StoresSupplier\" id=\"StoresSupplier\" type=\"text\" value=\"" + StoresSupplier.ToString() + "\" />\r\n");
	templateBuilder.Append("                <input name=\"StoresSupplierID\" id=\"StoresSupplierID\" type=\"hidden\" value=\"" + StoresSupplierID.ToString() + "\" />\r\n");

	}	//end if

	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("        业务员:(检索输入*)<br/>\r\n");
	templateBuilder.Append("                <input name=\"StaffName\" id=\"StaffName\" type=\"text\" value=\"" + StaffName.ToString() + "\" />\r\n");
	templateBuilder.Append("                <input name=\"StaffID\" id=\"StaffID\" type=\"hidden\" value=\"" + StaffID.ToString() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <!--\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("        操作员:(检索输入*)<br/>\r\n");
	templateBuilder.Append("                <input name=\"UserName\" style=\"width:120px\" id=\"UserName\" type=\"text\" value=\"" + UserName.ToString() + "\" />\r\n");
	templateBuilder.Append("                <input name=\"UserID\" id=\"UserID\" type=\"hidden\" value=\"" + UserID.ToString() + "\" />\r\n");
	templateBuilder.Append("            </td>-->\r\n");
	templateBuilder.Append("			<td>\r\n");
	templateBuilder.Append("商品:(检索可输入*)<br />\r\n");
	templateBuilder.Append("              <input name=\"ProductsName\" id=\"ProductsName\" type=\"text\" value=\"" + ProductsName.ToString() + "\" />\r\n");
	templateBuilder.Append("            <input name=\"ProductsID\" id=\"ProductsID\" type=\"hidden\" value=\"" + ProductsID.ToString() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td> 单据号:<br/>\r\n");
	templateBuilder.Append("            <input name=\"oOrderNum\" style=\"width:140px\" id=\"oOrderNum\" value=\"" + oOrderNum.ToString() + "\" type=\"text\" /></td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append(" 客户订单号:<br/>\r\n");
	templateBuilder.Append("            <input name=\"oCustomersOrderID\" style=\"width:120px\" id=\"oCustomersOrderID\" value=\"" + oCustomersOrderID.ToString() + "\" type=\"text\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("          <td colspan=\"5\">\r\n");
	templateBuilder.Append("<table border=\"0\" cellspacing=\"2\" cellpadding=\"2\">\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("                <td>单据状态:<br/>\r\n");
	templateBuilder.Append("              <select name=\"oState\" id=\"oState\">\r\n");
	...
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            单据步骤:<br/>\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            <input class=\"B_Check\" type=\"radio\" name=\"sType\" id=\"sType_a\" value=\"1\" \r\n");
	...
	templateBuilder.Append(" />\r\n");
	templateBuilder.Append("            <label for=\"sType_a\">单据时间:</label><br/>\r\n");
	templateBuilder.Append("              <nobr>\r\n");
	templateBuilder.Append("              <input name=\"oOrderDateTimeB\" id=\"oOrderDateTimeB\" style=\"width:70px\" value=\"" + oOrderDateTimeB.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly/>\r\n");
	templateBuilder.Append("              -\r\n");
	templateBuilder.Append("              <input name=\"oOrderDateTimeE\" id=\"oOrderDateTimeE\" style=\"width:70px\" value=\"" + oOrderDateTimeE.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly/>\r\n");
	templateBuilder.Append("            </nobr>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            <input name=\"sType\" type=\"radio\" class=\"B_Check\" id=\"sType_b\" value=\"2\" \r\n");
	...
	templateBuilder.Append(" />\r\n");
	templateBuilder.Append("            <label for=\"sType_b\">操作时间:</label><br />\r\n");
	templateBuilder.Append("              <nobr>\r\n");
	templateBuilder.Append("              <input name=\"dDateTimeB\" id=\"dDateTimeB\" style=\"width:70px\" value=\"" + dDateTimeB.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly/>\r\n");
	templateBuilder.Append("-\r\n");
	templateBuilder.Append("<input name=\"dDateTimeE\" id=\"dDateTimeE\" style=\"width:70px\" value=\"" + dDateTimeE.ToString() + "\" type=\"text\" onclick=\"new Calendar().show(this);\" readonly/>\r\n");
	templateBuilder.Append("            </nobr></td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            仓库:(检索输入*)<br/>\r\n");
	templateBuilder.Append("                <input name=\"StorageName\" id=\"StorageName\" type=\"text\" value=\"" + StorageName.ToString() + "\" />\r\n");
	templateBuilder.Append("                <input name=\"StorageID\" id=\"StorageID\" type=\"hidden\" value=\"" + StorageID.ToString() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	...
	templateBuilder.Append("            <INPUT TYPE=\"hidden\" NAME=\"ordertype\" id=\"ordertype\">\r\n");
	templateBuilder.Append("              <nobr>\r\n");
	...
	templateBuilder.Append("              <input type=\"button\" id=\"button5\" style=\"margin:3px;width:88px\" class=\"B_INPUT\" value=\"" + aspxrewriteurl.ToString() + "单查找\" onclick=\"javascript:OrderList.Search();\"  />\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button6\" style=\"margin:3px;width:120px\" class=\"B_INPUT\"   \r\n");

	if ((ordertype==1) || (ordertype==2)  || ordertypeStr.IndexOf("|1|")>-1 || ordertypeStr.IndexOf("|2|")>-1)
	{

	 aspxrewriteurl = "供应商(采购/退货)";
	
	templateBuilder.Append("    ordertypeStr=\"|1|2|\"\r\n");
	...
	templateBuilder.Append("          ordertypeStr=\"|9|\"\r\n");

	}
	else
	{

	 aspxrewriteurl = "客户(销售/退货)";
	
	templateBuilder.Append("           ordertypeStr=\"|3|4|\"\r\n");
	...
	templateBuilder.Append(" value=\"所有" + aspxrewriteurl.ToString() + "查找\" onclick=\"javascript:OrderList.SearchC(this);\"  />\r\n");

	}	//end if

	templateBuilder.Append("                <input type=\"button\" id=\"button7\" style=\"margin:3px;width:88px\" class=\"B_INPUT\" value=\"所有单据查找\" onclick=\"javascript:OrderList.SearchB();\"  />\r\n");
	templateBuilder.Append("                  <input type=\"button\" id=\"print_show_bt\" style=\"margin:3px;width:88px\" class=\"B_INPUT\" value=\"批量打印\" >\r\n");
	templateBuilder.Append("                  <input type=\"button\" id=\"print_all_bt\" style=\"margin:3px;width:88px\" class=\"B_INPUT\" value=\"打印选择单据\" />\r\n");
	templateBuilder.Append("                </nobr>\r\n");
	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </table>\r\n");
	...
	templateBuilder.Append("                		销售(出货/退货),赠品,样品,代购\r\n");

	if (oSteps==1)
	{

	templateBuilder.Append("                        待审中\r\n");
	...
	templateBuilder.Append("                		销售(出货/退货)\r\n");
	...
	templateBuilder.Append("                		采购(进货/退货)\r\n");
	...
	templateBuilder.Append("                所有类型\r\n");

	}	//end if

	templateBuilder.Append("单据\r\n");
	...
	templateBuilder.Append("        <h2>已处理非全额收货单据</h2>\r\n");

	}
	else
	{

	templateBuilder.Append("        <h2>未处理非全额收货单据</h2>\r\n");
	...
	templateBuilder.Append("                    <td width=\"8%\"><nobr><input type=\"checkbox\" name=\"CheckAll\" class=\"CheckAll\" id=\"CheckAll\" style=\"width:30px;\" /> 单据编号</nobr></td>\r\n");
	templateBuilder.Append("                     <td width=\"5%\"><nobr>单据类型</nobr></td>\r\n");
	...
	templateBuilder.Append("                            	<td >仓库</td>\r\n");

	}
	else
	{

	templateBuilder.Append("                                <td >客户</td>\r\n");
	templateBuilder.Append("                                <td width=\"10%\">客户订单号</td>\r\n");
	templateBuilder.Append("                                <td width=\"10%\">客户门店</td>\r\n");
	...
	templateBuilder.Append("                    <td width=\"8%\" align=\"right\">单据时间</td>\r\n");

	if (ordertype!=8 && ordertype!=9 && ordertype!=10 && ordertype!=1 && ordertype!=2 || ordertypeStr=="|3|4|5|6|7|")
	{

	templateBuilder.Append("                    <td width=\"5%\" align=\"center\">业务员</td>\r\n");

	}	//end if

	templateBuilder.Append("                    <td width=\"5%\" align=\"center\">操作员</td>\r\n");
	templateBuilder.Append("                    <td width=\"10%\" align=\"center\">完成步骤</td>\r\n");
	templateBuilder.Append("                    <td width=\"5%\" align=\"center\">状态</td>\r\n");
	templateBuilder.Append("                    <td width=\"5%\" align=\"center\"><nobr>打印</nobr></td>\r\n");
	templateBuilder.Append("                    <td width=\"8%\" align=\"right\">总金额</td>\r\n");
	templateBuilder.Append("                  </tr>\r\n");
	templateBuilder.Append("                  </thead> \r\n");
	...
	templateBuilder.Append("                  <tr >\r\n");
	templateBuilder.Append("                    <td width=\"8%\">\r\n");
	templateBuilder.Append("                        <input type=\"checkbox\" name=\"CheckAll\" orderid=\"" + dl["orderid"].ToString().Trim() + "\" otype=\"" + dl["otype"].ToString().Trim() + "\" style=\"width:30px;\" />\r\n");
	templateBuilder.Append("                        <a href=\"javascript:void(0);\" onclick=\"javascript:OrderList.ShowEditUserBox(" + dl["OrderID"].ToString().Trim() + "," + dl["oType"].ToString().Trim() + ");\">" + dl["oOrderNum"].ToString().Trim() + "</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	...
	templateBuilder.Append("                        <td >\r\n");
	templateBuilder.Append("						" + dl["StoresSupplierName"].ToString().Trim() + "\r\n");
	templateBuilder.Append("						</td>\r\n");
	...
	templateBuilder.Append("                            " + dl["StoresSupplierName"].ToString().Trim() + "\r\n");
	templateBuilder.Append("                            </td>\r\n");
	templateBuilder.Append("                            <td width=\"10%\">" + dl["oCustomersOrderID"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                            <td width=\"10%\">" + dl["oCustomersNameB"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    <td width=\"5%\" align=\"center\" >\r\n");
	...
	templateBuilder.Append("                    <td width=\"10%\" align=\"center\">\r\n");
	 aspxrewriteurl = GetOrderStpes(dl["oSteps"].ToString());
	...
	templateBuilder.Append("					" + dl["PrintTime"].ToString().Trim() + "\r\n");

	}
	else
	{

	templateBuilder.Append("					 <span style=\"color:#F00\" >未打印</span>\r\n");

	}	//end if

	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"text-align:right;\" width=\"8%\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["SumMoney"].ToString()),config.MoneyDecimal).ToString();
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td>" + PageBarHTML.ToString() + " </td>\r\n");
	templateBuilder.Append("            <td align=\"right\"> 合计:<b> " + SUMMoney.ToString() + "</b></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          </table>\r\n");
	...
	templateBuilder.Append("		}\r\n");
	templateBuilder.Append("	  );\r\n");
	templateBuilder.Append("	  $('#UserName').autocomplete('Services/CAjax.aspx',{ \r\n");
	templateBuilder.Append("		width: 200,\r\n");
	templateBuilder.Append("		scroll: true,\r\n");
	templateBuilder.Append("		autoFill: true,\r\n");
	templateBuilder.Append("		scrollHeight: 200,\r\n");
	...
	templateBuilder.Append("			'RCode':Math.random(),\r\n");
	templateBuilder.Append("			'UserName':function(){return $('#UserName').val();}\r\n");
	templateBuilder.Append("		},\r\n");
	templateBuilder.Append("		parse: function(data) {\r\n");
	templateBuilder.Append("				var rows = [];  \r\n");
	templateBuilder.Append("				var tArray = data.results;\r\n");
	...
	templateBuilder.Append("		}\r\n");
	templateBuilder.Append("	  }).result(function(event, data, formatted) {\r\n");
	templateBuilder.Append("			$(\"#UserID\").val((formatted!=null)?formatted:\"0\");\r\n");
	templateBuilder.Append("		}\r\n");
	templateBuilder.Append("	  );\r\n");
	...
	templateBuilder.Append("	$('#StoresSupplier').autocomplete('Services/CAjax.aspx',{ \r\n");
	templateBuilder.Append("		width: 200,\r\n");
	templateBuilder.Append("		scroll: true,\r\n");
	templateBuilder.Append("		autoFill: true,\r\n");
	templateBuilder.Append("		scrollHeight: 200,\r\n");
	...
	templateBuilder.Append("			'RCode':Math.random(),\r\n");
	templateBuilder.Append("			'SupplierName':function(){return $('#StoresSupplier').val();\r\n");
	templateBuilder.Append("			}\r\n");
	...
	templateBuilder.Append("			'do':'GetStorageList',\r\n");
	templateBuilder.Append("			'RCode':Math.random(),\r\n");
	templateBuilder.Append("			'StorageName':function(){return $('#StoresSupplier').val();\r\n");
	templateBuilder.Append("			}\r\n");
	...
	templateBuilder.Append("			'RCode':Math.random(),\r\n");
	templateBuilder.Append("			'StoresName':function(){return $('#StoresSupplier').val();\r\n");
	templateBuilder.Append("			}\r\n");
	...
	templateBuilder.Append("		}\r\n");
	templateBuilder.Append("	  }).result(function(event, data, formatted) {\r\n");
	templateBuilder.Append("			$(\"#StoresSupplierID\").val((formatted!=null)?formatted:\"0\");\r\n");
	templateBuilder.Append("		}\r\n");
	templateBuilder.Append("	  );\r\n");
	...
	templateBuilder.Append("var OrderList = new TOrderList();\r\n");
	templateBuilder.Append("OrderList.ordertypeStr = '" + ordertypeStr.ToString() + "';\r\n");
	templateBuilder.Append("OrderList.UserCode = '" + UserCode.ToString() + "';\r\n");
	templateBuilder.Append("OrderList.PrintPageWidth = '" + config.PrintPageWidth.ToString().Trim() + "';\r\n");
	templateBuilder.Append("OrderList.PrintAddPageWidth = '" + config.PrintAddPageWidth.ToString().Trim() + "';\r\n");
	templateBuilder.Append("OrderList.PrinterName = '" + config.PrinterName.ToString().Trim() + "';\r\n");
	templateBuilder.Append("OrderList.ini();\r\n");
	templateBuilder.Append("OrderList.ordertype = " + ordertype.ToString() + ";\r\n");

	if (Act.IndexOf("Search") > -1)
	{

	templateBuilder.Append("$('#button_s').click();\r\n");

	}	//end if

	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	OrderList.HidUserBox();\r\n");
