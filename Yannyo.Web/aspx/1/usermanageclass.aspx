<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.usermanageclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/UserManageClass.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("    <div class=\"main\" id=\"UserManageClass\">\r\n");
	...
	templateBuilder.Append("            <td >组名称</td>\r\n");
	...
	int utl__loop__id=0;
	foreach(DataRow utl in UserTypeList.Rows)
	{
		utl__loop__id++;

	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:UserManageClass.ShowEditBox(" + utl["id"].ToString().Trim() + ");\">" + utl["name"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:UserManageClass.ShowDelBox(" + utl["id"].ToString().Trim() + ");\">删除</a>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:UserManageClass.ShowEditBox(" + utl["id"].ToString().Trim() + ");\">修改</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var UserManageClass = new TUserManageClass();\r\n");
	templateBuilder.Append("UserManageClass.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	UserManageClass.HidUserBox();\r\n");
