<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.report_certificate_summary" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("        <script src=\"public/js/report_certificate_summary.js\" type=\"text/javascript\" ></" + "script>\r\n");
	...
	templateBuilder.Append("            <td align=\"left\">凭证时间:<br/><input name=\"bDate\" id=\"bDate\" style=\"width:80px\" value=\"" + bDate.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/>-<input name=\"eDate\" id=\"eDate\" style=\"width:80px\" value=\"" + eDate.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"left\"><input type=\"button\" id=\"button_Summary\" name=\"button_Summary\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 凭证汇总 \"  />&nbsp;\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"button_print\" name=\"button_print\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 打印汇总表 \"  /></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </table>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("凭证汇总\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("    <td colspan=\"2\"><span style=\"width:100%\">凭证范围:" + bDate.ToString() + "~" + eDate.ToString() + " </span></td>\r\n");
	templateBuilder.Append("    <td colspan=\"2\" align=\"right\"><span style=\"width:100%\">共" + cCount.ToString() + "张 </span></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	...
	templateBuilder.Append("    <td width=\"15%\" align=\"right\">" + dl["cdMoneyB"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("    <td width=\"15%\" align=\"right\">" + cdMoneyBSum.ToString() + "</td>\r\n");
	templateBuilder.Append("</tr>\r\n");
	...
	templateBuilder.Append("		var Report_Certificate_Summary = new TReport_Certificate_Summary();\r\n");
	templateBuilder.Append("        Report_Certificate_Summary.PrintPageWidth = '" + config.PrintCertificatePageWidth.ToString().Trim() + "';\r\n");
	templateBuilder.Append("		Report_Certificate_Summary.UserCode = '" + UserCode.ToString() + "';\r\n");
	templateBuilder.Append("        Report_Certificate_Summary.ini();\r\n");
	templateBuilder.Append("        function HidBox()\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            Report_Certificate_Summary.HidUserBox();\r\n");
