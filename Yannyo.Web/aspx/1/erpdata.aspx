<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.erpdata" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/erpdata.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ErpDataManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入Erp数据\" onclick=\"javascript:ErpDataManage.ShowimportErpdataBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button6\" style=\"margin:5px\" class=\"B_INPUT\" value=\"匹配数据\" onclick=\"javascript:ErpDataManage.ShowSyncErpdataBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"10%\">单据编号</td>\r\n");
	templateBuilder.Append("			<td >产品名称</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">单价</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">数量</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">小计</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">客户名称</td>\r\n");
	templateBuilder.Append("			<td width=\"8%\">单据类型</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">业务员</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">单据时间</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">导入时间</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ErpOrderID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td>" + dl["O_ORDERNUM"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("				<span style=\"color:##FF0000\">[促销]</span>\r\n");
	...
	templateBuilder.Append("			<span style=\"color:#cccccc\">\r\n");
	templateBuilder.Append("			(" + dl["P_CODE"].ToString().Trim() + ")<br/>" + dl["P_NAME"].ToString().Trim() + "\r\n");
	templateBuilder.Append("			</span>\r\n");

	}	//end if

	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td align=\"right\">" + dl["S_PRICE"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("				" + dl["SupplierName"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("				<span style=\"color:#cccccc\">\r\n");
	templateBuilder.Append("				" + dl["C_NAME"].ToString().Trim() + "\r\n");
	templateBuilder.Append("				</span>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td>" + dl["R_NAME"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>\r\n");

	if (dl["StaffID"].ToString().Trim() != "0")
	{

	templateBuilder.Append("			" + dl["SA_NAME"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td>" + dl["O_CREATETIME"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["eAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ErpDataManage.ShowDelUserBox(" + dl["ErpOrderID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var ErpDataManage = new TErpDataManage();\r\n");
	templateBuilder.Append("ErpDataManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ErpDataManage.HidUserBox();\r\n");
