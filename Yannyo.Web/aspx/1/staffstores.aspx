<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.staffstores" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/staffstores.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:StaffStoresManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:StaffStoresManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<!--<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入\" onclick=\"javascript:StaffStoresManage.ShowimportdataBox();\"  />-->\r\n");
	templateBuilder.Append("姓名:<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\">\r\n");
	templateBuilder.Append("门店:<INPUT TYPE=\"text\" NAME=\"StoresName\" id=\"StoresName\" value=\"" + StoresName.ToString() + "\">\r\n");
	templateBuilder.Append("岗位状态:<SELECT NAME=\"sType\">\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:StaffStoresManage.Search();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button6\" style=\"margin:5px\" class=\"B_INPUT\" value=\"未离岗记录\" onclick=\"javascript:StaffStoresManage.SearchB();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button7\" style=\"margin:5px\" class=\"B_INPUT\" value=\"人员岗位记录\" onclick=\"javascript:StaffStoresManage.SearchC();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("人员岗位变动记录\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			 <td >人员姓名</td>\r\n");
	templateBuilder.Append("			 <td width=\"20%\">门店名称</td>\r\n");
	...
	templateBuilder.Append("			<tr>\r\n");
	templateBuilder.Append("				 <td ><a href=\"javascript:void(0);\" onclick=\"javascript:StaffStoresManage.ShowDownBox(" + dl["StaffID"].ToString().Trim() + ");\">" + dl["StaffName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("				 <td width=\"20%\">" + dl["StoresName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("				 <td width=\"10%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["bdate"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("				 </td>\r\n");
	templateBuilder.Append("				 <td width=\"10%\"><a href=\"javascript:void(0);\" onclick=\"javascript:StaffStoresManage.ShowDownBox(" + dl["StaffID"].ToString().Trim() + ");\">离岗</a></td>\r\n");
	templateBuilder.Append("			  </tr>\r\n");
	...
	templateBuilder.Append("			 <td >人员姓名</td>\r\n");
	templateBuilder.Append("			 <td width=\"20%\">门店名称</td>\r\n");
	templateBuilder.Append("			 <td width=\"10%\">上岗时间</td>\r\n");
	templateBuilder.Append("			 <td width=\"10%\">离岗时间</td>\r\n");
	templateBuilder.Append("			 <td width=\"10%\">操作</td>\r\n");
	templateBuilder.Append("		  </tr>\r\n");
	templateBuilder.Append("          </thead> \r\n");
	templateBuilder.Append("          <tbody>\r\n");
	...
	if (DateTime.Parse(dl["edate"].ToString())<=DateTime.Now)
	{
	 ...
	 aspxrewriteurl = DateTime.Parse(dl["edate"].ToString()).ToShortDateString().ToString();
	...
	templateBuilder.Append("			<td width=\"10%\">上岗离岗</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["StaffStoresID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:StaffStoresManage.ShowEditUserBox(" + dl["StaffStoresID"].ToString().Trim() + ");\">" + dl["StaffName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">" + dl["StoresName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["sDateTime"].ToString()).ToShortDateString().ToString();
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["sAppendTime"].ToString()).ToShortDateString().ToString();
	
	templateBuilder.Append("					" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StaffStoresManage.ShowDelUserBox(" + dl["StaffStoresID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<!--<a href=\"javascript:void(0);\" onclick=\"javascript:StaffStoresManage.ShowEditUserBox(" + dl["StaffStoresID"].ToString().Trim() + ");\">修改</a>-->\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var StaffStoresManage = new TStaffStoresManage();\r\n");
	templateBuilder.Append("StaffStoresManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	StaffStoresManage.HidUserBox();\r\n");
