<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.storage_order" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/storage_order.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("                    <td width=\"5%\"><nobr>单据编号</nobr></td>\r\n");
	...
	templateBuilder.Append("                    <td width=\"5%\" align=\"center\">发货状态</td>\r\n");
	templateBuilder.Append("                    </tr>\r\n");
	templateBuilder.Append("                  </thead> \r\n");
	...
	templateBuilder.Append("                  <tr >\r\n");
	templateBuilder.Append("                    <td width=\"5%\"><a href=\"javascript:void(0);\" onclick=\"javascript:OrderList.ShowEditUserBox(" + dl["OrderID"].ToString().Trim() + "," + dl["oType"].ToString().Trim() + ");\">" + dl["oOrderNum"].ToString().Trim() + "</a></td>\r\n");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("                    <td width=\"5%\" align=\"center\">\r\n");
	 aspxrewriteurl = GetIsOK(Convert.ToInt32(dl["OrderID"].ToString()));
