<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.products_sales_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/highcharts.js\" type=\"text/javascript\" language=\"javascript\" ></" + "script>\r\n");
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/myFrontPageJs/products_sales_details_garph.js \"></" + "script>\r\n");
	...
	templateBuilder.Append("            <input type=\"hidden\" id=\"SalesType\" name=\"SalesType\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"regionID\" name=\"regionID\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"graph_Type\" name=\"graph_Type\" />\r\n");
	templateBuilder.Append("            <table  style=\"width:100%\">\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("              <td>\r\n");
	templateBuilder.Append("                 销量类型：<select id=\"tType\">\r\n");
	...
	templateBuilder.Append(">月销量</option>\r\n");
	...
	templateBuilder.Append(">年销量</option>\r\n");
	templateBuilder.Append("                  </select>\r\n");
	templateBuilder.Append("                  &nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("                数据比较:\r\n");
	templateBuilder.Append("                <input type=\"text\" id=\"DataCompare\" name=\"DataCompare\" onblur=\"hide()\" style=\"width:125px;\" />\r\n");
	templateBuilder.Append("                 &nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("                日期选择：\r\n");
	...
	templateBuilder.Append("                 &nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("                 <input type=\"button\" id=\"submit_btn\" name=\"submit_btn\" class=\"B_INPUT\" value=\"查询\" style=\"cursor:pointer\" />\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("            </table>\r\n");
	templateBuilder.Append("         </div>\r\n");
	templateBuilder.Append("         <div>\r\n");
	templateBuilder.Append("            <table border=\"0\" cellpadding=\"2\" cellspacing=\"0\" width=\"100%\" style=\"background-color:#EDEDED\">\r\n");
	templateBuilder.Append("                <tr>\r\n");
	templateBuilder.Append("                    <td style=\"width:100%;height:450px;\">\r\n");
	templateBuilder.Append("                        <div style=\"border:1px solid #cccccc;height:410px;width:98%\">\r\n");
	templateBuilder.Append("                         <table  border=\"0\" cellpadding=\"2\" cellspacing=\"0\" width=\"100%\">\r\n");
	templateBuilder.Append("                                <tr class=\"tBar\">\r\n");
	templateBuilder.Append("                                    <td align=\"left\"><span style=\"color:Red\">注意：数据比较至多同时比较3个地区、客户或商品的数据</span></td>\r\n");
	templateBuilder.Append("                                    <td align=\"right\">图表类型：\r\n");
	templateBuilder.Append("                                        <select id=\"graphType\">\r\n");
	templateBuilder.Append("                                            <option value=\"0\">折线图</option>\r\n");
	templateBuilder.Append("                                            <option value=\"1\">条形图</option>\r\n");
	templateBuilder.Append("                                        </select>\r\n");
	templateBuilder.Append("                                    </td>\r\n");
	templateBuilder.Append("                                </tr>\r\n");
	templateBuilder.Append("                                <tr>\r\n");
	templateBuilder.Append("                                  <td colspan=\"2\">\r\n");
	templateBuilder.Append("                                      <div id=\"graph\" style=\"height:360px;width:100%;\"></div>\r\n");
	templateBuilder.Append("                                  </td>\r\n");
	templateBuilder.Append("                                </tr>\r\n");
	templateBuilder.Append("                                <tr class=\"tBar\">\r\n");
	templateBuilder.Append("                                   <td colspan=\"2\" align=\"right\">\r\n");
	templateBuilder.Append("                                    <span id=\"showDate\">" + mDate.ToString() + "</span> <span id=\"unit\">\r\n");

	if (SalesType==0)
	{

	templateBuilder.Append("[单位：日]\r\n");

	}
	else
	{

	templateBuilder.Append("[单位：月]\r\n");
	...
	templateBuilder.Append("               <tr>\r\n");
	templateBuilder.Append("                <td style=\"background-color:#AABE4D;height:35px\"><span id=\"sTitle\" style=\"color:White;font-size:larger; padding-left:10px\"><b>区域选择</b></span><span id=\"winClose\">关闭</span></td>\r\n");
	templateBuilder.Append("               </tr>\r\n");
	templateBuilder.Append("               <tr>\r\n");
	templateBuilder.Append("                 <td>\r\n");
	templateBuilder.Append("                  <div id=\"treeNode\" class=\"treeNode\"></div>\r\n");
	templateBuilder.Append("                 </td>\r\n");
	templateBuilder.Append("               </tr>\r\n");
	templateBuilder.Append("               <tr>\r\n");
	...
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("        <div id=\"showSelect\">\r\n");
	templateBuilder.Append("           <div id=\"sRegion\" class=\"showType\">按区域</div>\r\n");
	templateBuilder.Append("           <div id=\"sCustorm\" class=\"showType\">按客户</div>\r\n");
	templateBuilder.Append("           <div id=\"sProduct\" class=\"showType\">按商品</div>\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("        </form>\r\n");
	templateBuilder.Append("  <script type=\"text/javascript\">\r\n");
	templateBuilder.Append("      var divValue = \"\";\r\n");
	templateBuilder.Append("      var divTitle = \"\";\r\n");
	templateBuilder.Append("      var ckName = \"\"; //每次点击保存Name\r\n");
	templateBuilder.Append("      var cName = \"\";\r\n");
	templateBuilder.Append("      var text_attr = \"\"; //文本重组\r\n");
	templateBuilder.Append("      var selectType;\r\n");
	templateBuilder.Append("      //1.页面加载执行\r\n");
	templateBuilder.Append("      $(window).load(function () {\r\n");
	templateBuilder.Append("          var get_graphType = $(\"#graph_Type\").val();\r\n");
	templateBuilder.Append("          if (get_graphType == 0) {\r\n");
	templateBuilder.Append("              $(\"#winAll\").fadeIn(\"slow\");\r\n");
	templateBuilder.Append("              getJsonToGchar(\"line\", \"\", 0,\"\");\r\n");
	templateBuilder.Append("          }\r\n");
	templateBuilder.Append("          if (get_graphType == 1) {\r\n");
	templateBuilder.Append("              $(\"#winAll\").fadeIn(\"slow\");\r\n");
	templateBuilder.Append("              getJsonToGchar(\"column\", \"\", 0,\"\");\r\n");
	templateBuilder.Append("          }\r\n");
	templateBuilder.Append("          //获得树\r\n");
	templateBuilder.Append("          getdoValue(\"region\");\r\n");
	templateBuilder.Append("      });\r\n");
	templateBuilder.Append("</" + "script>\r\n");
