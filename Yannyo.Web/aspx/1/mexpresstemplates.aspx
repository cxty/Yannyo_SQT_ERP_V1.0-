<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.mexpresstemplates" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/m_mexpresstemplates.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("<div >\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"bt_Add\" style=\"margin:5px\" class=\"B_INPUT\" value=\"创建模板\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td>模板名称</td>\r\n");
	templateBuilder.Append("            <td width=\"18%\">物流公司名称</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["m_ExpressTemplatesID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("		    <td><a href=\"javascript:void(0);\" onclick=\"javascript:MexpressTemplates.Edit(" + dl["m_ExpressTemplatesID"].ToString().Trim() + ");\">" + dl["mName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td width=\"18%\">" + dl["mExpName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">" + dl["mAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:MexpressTemplates.Edit(" + dl["m_ExpressTemplatesID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("            <a href=\"javascript:void(0);\" onclick=\"javascript:MexpressTemplates.Del(" + dl["m_ExpressTemplatesID"].ToString().Trim() + ");\">删除</a>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"5\">" + PageBarHTML.ToString() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          </tfoot>\r\n");
	...
	templateBuilder.Append("var MexpressTemplates = new TMexpressTemplates();\r\n");
	templateBuilder.Append("MexpressTemplates.MConfigID = " + M_Config.m_ConfigInfoID.ToString().Trim() + ";\r\n");
	templateBuilder.Append("MexpressTemplates.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	MexpressTemplates.HidUserBox();\r\n");
