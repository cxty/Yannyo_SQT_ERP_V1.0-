<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.cost_class_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\"><b>科目名称</b></span></td>\r\n");
	...
	templateBuilder.Append("           <table id=\"tBoxs\"  class=\"tBox\" border=\"0\" cellpadding=\"0\" cellspacing=\"2\" style=\"width:100%\">\r\n");
	              ...
	              foreach(DataTable ct in rDateSet.Tables)
	               {
	...
	int cl__loop__id=0;
	foreach(DataRow cl in ct.Rows)
	{
		cl__loop__id++;

	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:5%;\">" + cl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;\">" + className.ToString() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:20%;\"><b>" + cl["cClassName"].ToString().Trim() + "—﹥" + cl["cdName"].ToString().Trim() + "</b></td>\r\n");
	...
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;\">" + cl["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;\">\r\n");
	 aspxrewriteurl = Convert.ToDateTime(cl["cDateTime"].ToString().Trim()).ToString("yyyy-MM-dd");
