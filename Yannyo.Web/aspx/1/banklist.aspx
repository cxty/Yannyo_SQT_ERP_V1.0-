<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.banklist" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("        <script type=\"text/javascript\" src=\"/public/js/banklist.js\"></" + "script>\r\n");
	templateBuilder.Append("        <div class=\"toolbar\" >\r\n");
	templateBuilder.Append("        <div class=\"toolbox\">\r\n");
	templateBuilder.Append("        <input type=\"button\" id=\"bt_del\" style=\"margin:5px; cursor:pointer\" class=\"B_INPUT\" value=\"删除选中\"  />\r\n");
	templateBuilder.Append("        <input type=\"button\" id=\"bt_add\" style=\"margin:5px; cursor:pointer\" class=\"B_INPUT\" value=\"添加\"  />\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("        <div class=\"list_title\">\r\n");
	templateBuilder.Append("        资金帐户\r\n");
	templateBuilder.Append("        </div>\r\n");
	templateBuilder.Append("        </div>\r\n");
	...
	templateBuilder.Append("          <td rowspan=\"2\" style=\"width:2%\"><input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"\" onclick=\"javascript:selectCheck(document.getElementById('form1'),this);\"/></td>\r\n");
	templateBuilder.Append("          <td rowspan=\"2\" align=\"center\" style=\"width:5%;\"><span style=\"font-size:11pt\"><b>编号</b></span></td>\r\n");
	templateBuilder.Append("          <td rowspan=\"2\" align=\"center\" style=\"width:40%;\"><span style=\"font-size:11pt\"><b>账户名称</b></span></td>\r\n");
	templateBuilder.Append("          <td colspan=\"2\" align=\"center\" style=\"width:20%;\"><span style=\"font-size:11pt\"><b>账户金额</b></span></td>\r\n");
	templateBuilder.Append("          <td rowspan=\"2\" align=\"right\" style=\"width:10%;\"><span style=\"font-size:11pt\"><b>创建日期</b></span></td>\r\n");
	templateBuilder.Append("          <td width=\"10%\" rowspan=\"2\" align=\"center\"><span style=\"font-size:11pt\"><b>操作</b></span></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        <tr class=\"tBar\">\r\n");
	templateBuilder.Append("          <td align=\"right\" ><span style=\"font-size:11pt\"><b>借方金额</b></span></td>\r\n");
	templateBuilder.Append("          <td align=\"right\" ><span style=\"font-size:11pt\"><b>贷方金额</b></span></td>\r\n");
	templateBuilder.Append("        </tr>\r\n");
	...
	foreach(DataRow dl in dList.Rows)
	{
	 ...
	 count = getCount(dl["FeesSubjectClassID"].ToString().Trim());
	
	templateBuilder.Append("          <tr >\r\n");
	templateBuilder.Append("            <td style=\"width:2%\">\r\n");

	if (count==0)
	{

	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["CapitalAccountID"].ToString().Trim() + "\" />\r\n");
	...
	templateBuilder.Append("            <input type=\"checkbox\" class=\"B_Check\" disabled=\"disabled\" />\r\n");
	...
	templateBuilder.Append("            <td style=\"width:5%\" align=\"left\">" + dl["cCode"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("            <td align=\"right\" >\r\n");
	 cMoney = decimal.Round(Convert.ToDecimal(dl["cAccountMoney"].ToString().Trim()),2);
	...
	templateBuilder.Append("" + cMoney.ToString() + "\r\n");
	 sumA = decimal.Round(sumA+cMoney,2);
	...
	if (cMoney<0)
	{
	 ...
	 cMoney = decimal.Round(Convert.ToDecimal(-cMoney),2);
	...
	templateBuilder.Append("               " + cMoney.ToString() + "\r\n");
	 sumB = decimal.Round(sumB+cMoney,2);
	...
	templateBuilder.Append("            <td align=\"right\" style=\"width:10%\">\r\n");
	 aspxrewriteurl = Convert.ToDateTime(dl["pAppendTime"]).ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("<a href=\"javascript:void(0);\" onclick=\"javascript:BankList.ShowEditBox(" + dl["CapitalAccountID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:BankList.ShowDelBox(" + dl["CapitalAccountID"].ToString().Trim() + ");\">删除</a> \r\n");
	...
	templateBuilder.Append("              <td align=\"right\" style=\"width:10%;\"><span style=\"font-size:11pt\"><b>" + sumA.ToString() + "</b></span></td>\r\n");
	templateBuilder.Append("              <td align=\"right\" style=\"width:10%;\"><span style=\"font-size:11pt\"><b>" + sumB.ToString() + "</b></span></td>\r\n");
	templateBuilder.Append("              <td align=\"right\" style=\"width:10%;\"><span style=\"font-size:11pt\"><b></b></span></td>\r\n");
	templateBuilder.Append("              <td align=\"right\" style=\"width:10%;\"><span style=\"font-size:11pt\"><b></b></span></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("        </table>\r\n");
	templateBuilder.Append("        </form>\r\n");
	templateBuilder.Append("<script language=\"javascript\" type=\"text/javascript\">\r\n");
	templateBuilder.Append("var BankList = new TBankList();\r\n");
	templateBuilder.Append("BankList.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	BankList.HidBox();\r\n");
	templateBuilder.Append("}\r\n");
