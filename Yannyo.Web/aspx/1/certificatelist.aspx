<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.certificatelist" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("        <script src=\"/public/js/certificatelist.js\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("   <!-- <td align=\"left\">凭证编号:<br/>\r\n");
	...
	templateBuilder.Append("    <input type=\"button\" id=\"button_print\" name=\"button_print\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 批量打印 \"  />&nbsp;\r\n");
	templateBuilder.Append("	<input type=\"button\" style=\"margin:5px;width:120px\" name=\"subbutton_add\" id=\"subbutton_add\" value=\" 新建凭证 \" class=\"B_INPUT\"></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("</table>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("凭证列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("	<a href=\"javascript:void(0);\" onClick=\"javascript:CertificateList.ShowData(" + dl["CertificateID"].ToString().Trim() + ",'" + aspxrewriteurl.ToString() + "');\">\r\n");
	templateBuilder.Append("	" + aspxrewriteurl.ToString() + "</a></td>\r\n");
	...
	templateBuilder.Append("    <tr class=\"tBar\">\r\n");
	templateBuilder.Append("      <td width=\"50%\">\r\n");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("      <td align=\"right\">合计:" + SumMoney.ToString() + "</td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  </table>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("        <script language=\"javascript\" type=\"text/javascript\">\r\n");
	templateBuilder.Append("        var CertificateList = new TCertificateList();\r\n");
	templateBuilder.Append("        CertificateList.ini();\r\n");
	templateBuilder.Append("        function HidBox()\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            CertificateList.HidUserBox();\r\n");
