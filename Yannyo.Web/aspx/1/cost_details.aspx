<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.cost_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/cost_details.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("          <div id=\"Query List\">\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"tType\" name=\"tType\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"feeType\" name=\"feeType\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"moriType\" name=\"moriType\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"get_treeNode\" name=\"get_treeNode\"/>\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"get_direction\" name=\"get_direction\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"get_sID\" name=\"get_sID\" />\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"maori_ID\" name=\"maori_ID\" />\r\n");
	templateBuilder.Append("            <input type='hidden' id='className_val' name='className_val'/>\r\n");
	templateBuilder.Append("            <input type=\"hidden\" id=\"cookie_className\" name=\"cookie_className\" value=\"" + getTreeNode.ToString() + "\" />\r\n");
	templateBuilder.Append("            <table >\r\n");
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("              <td style=\"width:15%\">统计类型：\r\n");
	templateBuilder.Append("               <select id=\"tjType\">\r\n");
	...
	templateBuilder.Append(">毛利统计</option>\r\n");
	...
	templateBuilder.Append(">费用统计</option>\r\n");
	templateBuilder.Append("               </select>\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              <td id=\"getType\" align=\"left\" style=\"width:10%\">类别：\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              <td id=\"classType\" style=\"width:25%\" align=\"left\">\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              <td align=\"left\" style=\"width:35%\">查询日期：\r\n");
	 aspxrewriteurl = sDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                 <input name=\"sDate\" id=\"sDate\" style=\"width:100px;\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" />至\r\n");
	 aspxrewriteurl = stDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                <input name=\"stDate\" id=\"stDate\" style=\"width:100px;\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" />\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              <td align=\"right\" style=\"width:5%\">\r\n");
	templateBuilder.Append("                <input type=\"button\" id=\"tbn_submit\" name=\"btn_submit\" value=\"查询\"  style=\"width:120px;height:25px\"/>\r\n");
	templateBuilder.Append("              </td>\r\n");
	templateBuilder.Append("              <td align=\"right\" style=\"width:5%\">\r\n");
	templateBuilder.Append("              <input type=\"button\" id=\"export_data\" name=\"export_data\" value=\"导出数据\" style=\"width:120px;height:25px\" />\r\n");
	templateBuilder.Append("             </td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	templateBuilder.Append("            </table>\r\n");
	templateBuilder.Append("           </div>\r\n");
	...
	templateBuilder.Append("           <span style=\"color:Red\">友情提示：当前<b>[统计费用]</b>为您选择科目节点下所有节点数据</span>\r\n");
	...
	templateBuilder.Append("           <tr>\r\n");
	templateBuilder.Append("            <td style=\"width:100%;\"><hr /></td>\r\n");
	templateBuilder.Append("           </tr>\r\n");
	...
	templateBuilder.Append("           <span><b>统计科目:</b></span> \r\n");
	...
	templateBuilder.Append("               <b><span>[</span><span style=\"color:#7A378B\">" + dl["cClassName"].ToString().Trim() + "</span><span>]</span></b>\r\n");
	...
	templateBuilder.Append("费用统计\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("          <div id=\"tb_title\">\r\n");
	...
	templateBuilder.Append("            <!--费用统计_门店-->\r\n");

	if (tType==1 && feeType==0)
	{

	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px;\"><span style=\"font-size:larger\">区域</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" colspan=\"2\" style=\"width:40%;height:30px;\"><span style=\"font-size:larger\">客户名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">类别</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px;\"><span style=\"font-size:larger\">发生金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">查看详情</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");

	}	//end if

	templateBuilder.Append("            <!--费用统计_科目-->\r\n");

	if (tType==1 && feeType==1)
	{

	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:40%;height:30px;\"><span style=\"font-size:larger\">科目名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px;\"><span style=\"font-size:larger\">发生金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">查看详情</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");

	}	//end if

	templateBuilder.Append("             <!--费用统计_业务员-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:40%;height:30px;\"><span style=\"font-size:larger\">业务员名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px;\"><span style=\"font-size:larger\">发生金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">查看详情</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            <!--费用统计_赠品-->\r\n");

	if (tType==1 && feeType==3)
	{

	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"left\" rowspan=\"2\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">门店名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" rowspan=\"2\" colspan=\"2\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">商品名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" rowspan=\"2\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">商品条码</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" colspan=\"2\" style=\"width:20%;height:15px;\"><span style=\"font-size:larger\">商品数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" colspan=\"2\" style=\"width:10%;height:15px;\"><span style=\"font-size:larger\">发生金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" rowspan=\"2\" style=\"width:10%;height:30px;\"><span style=\"font-size:larger\">查看详情</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:15px;\"><span style=\"font-size:11pt\">赠品单数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:15px;\"><span style=\"font-size:11pt\">销售单数量</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" colspan=\"2\" style=\"width:10%;height:15px;\"><span style=\"font-size:11pt\">赠品金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");

	}	//end if

	templateBuilder.Append("            <!--毛利统计_区域-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">区域名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">销售金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">成本金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">利润金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");

	}	//end if

	templateBuilder.Append("            <!--毛利统计_客户-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">客户名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">销售金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">成本金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">利润金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            <!--毛利统计_业务员-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">业务名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">销售金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">成本金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">利润金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            <!--毛利统计_品牌-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">品牌名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">销售金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">成本金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">利润金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            <!--毛利统计_商品-->\r\n");
	...
	templateBuilder.Append("             <tr class=\"tBar\">\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px;\"><span style=\"font-size:larger\">商品名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">销售金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">成本金额</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;height:30px;\"><span style=\"font-size:larger\">利润金额</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	int rl__loop__id=0;
	foreach(DataRow rl in nTable.Rows)
	{
		rl__loop__id++;

	 tLoopid = 1;
	
	 sList = getStoresName(rl["RegionID"].ToString().Trim());
	
	 s_count = getStoresCount(rl["RegionID"].ToString().Trim());
	
	 sumA = 0;
	
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("                  <td rowspan=\"" + s_count.ToString() + "\" align=\"center\" style=\"width:20%;\">" + rl["rName"].ToString().Trim() + "</td>\r\n");
	...
	foreach(DataRow sl in sList.Rows)
	{
	 ...
	 SdateSetCost = getCostOfStorehouse(sl["StoresID"].ToString().Trim());
	...
	templateBuilder.Append("                  <td align=\"center\" style=\"width:10%;\">" + sl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\" style=\"width:30%;\">" + sl["sName"].ToString().Trim() + " </td>\r\n");
	templateBuilder.Append("                  <td align=\"center\" style=\"width:10%;\">" + sl["sType"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                   <td align=\"center\" style=\"width:20%;\">\r\n");

	                   foreach(DataTable ct in SdateSetCost.Tables)
	                    {
	                   
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(test),2).ToString();
	...
	templateBuilder.Append("                  </td>\r\n");
	templateBuilder.Append("                  <td align=\"center\" style=\"width:10%;\"><a href=\"javascript:void(0)\" onclick=\"javascript:sendInFo('" + sl["StoresID"].ToString().Trim() + "','" + get_direction.ToString() + "','" + sDate.ToString() + "','" + stDate.ToString() + "','" + sl["sName"].ToString().Trim() + "','" + sl["sType"].ToString().Trim() + "','" + getTreeNode.ToString() + "')\">查看</a></td>\r\n");
	...
	templateBuilder.Append("             </tr>\r\n");
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("             <td align=\"center\" colspan=\"4\" style=\"height:30px;font-size:larger;\"><span style=\"font-size:large; font-weight:bold\">" + rl["rName"].ToString().Trim() + "</span>&nbsp;客户费用合计</td>\r\n");
	templateBuilder.Append("             <td align=\"center\" ><b>" + sumA.ToString() + "</b></td>\r\n");
	...
	foreach(DataRow cl in newTable.Rows)
	{
	 ...
	 test = getCostOfClass(cl["FeesSubjectClassID"].ToString().Trim());
	
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;\">\r\n");
	templateBuilder.Append("              " + cl__loop__id.ToString() + "\r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:40%;\">" + cl["cClassName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(test),2).ToString();
	
	templateBuilder.Append("               " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;\"><a href=\"javascript:void(0)\" onclick=\"javascript:sendInFoClass('" + get_direction.ToString() + "','" + sDate.ToString() + "','" + stDate.ToString() + "','" + cl["cClassName"].ToString().Trim() + "','" + cl["FeesSubjectClassID"].ToString().Trim() + "')\">查看</a></td> \r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	int sl__loop__id=0;
	foreach(DataRow sl in tnTable.Rows)
	{
		sl__loop__id++;

	 sTest = getCostOFStaff(sl["StaffID"].ToString().Trim());
	
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;\">" + sl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:40%;\">" + sl["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(sTest),2).ToString();
	
	templateBuilder.Append("               " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;\"><a href=\"javascript:void(0)\" onclick=\"javascript:sendInFoStaff('" + get_direction.ToString() + "','" + sDate.ToString() + "','" + stDate.ToString() + "','" + sl["sName"].ToString().Trim() + "','" + getTreeNode.ToString() + "','" + sl["StaffID"].ToString().Trim() + "')\">查看</a></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("               <td align=\"left\"  style=\"width:15%;\">" + gl["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td align=\"center\" style=\"width:5%;\">" + gl__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%;\">" + gl["pName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td align=\"center\" style=\"width:15%;\">" + gl["pBarcode"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"center\" style=\"width:10%;\"><a href=\"javascript:void(0)\" onclick=\"javascript:sendInFoGifts('" + gl["StoresID"].ToString().Trim() + "','" + gl["sName"].ToString().Trim() + "','" + gl["ProductsID"].ToString().Trim() + "','" + gl["pName"].ToString().Trim() + "','" + gl["pBarcode"].ToString().Trim() + "','" + sDate.ToString() + "','" + stDate.ToString() + "')\">查看</a></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("              <td align=\"center\" colspan=\"4\" style=\"height:30px;\"><span style=\"font-size:11pt\"><b>合计：</b></span></td>\r\n");
	templateBuilder.Append("              <td align=\"center\" ><b>" + sumC.ToString() + "</b></td>\r\n");
	templateBuilder.Append("              <td align=\"center\" ><b>" + sumCC.ToString() + "</b></td>\r\n");
	templateBuilder.Append("              <td align=\"right\" ><b>" + sumB.ToString() + "</b></td>\r\n");
	templateBuilder.Append("              <td align=\"center\" ></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");

	}	//end if

	templateBuilder.Append("           <!--毛利统计-->\r\n");
	...
	int ml__loop__id=0;
	foreach(DataRow ml in mList.Rows)
	{
		ml__loop__id++;

	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:15%;\">" + ml__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:30%;\">\r\n");

	if (moriType==0)
	{

	templateBuilder.Append("               " + ml["rName"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("               " + ml["sName"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("               " + ml["pBrand"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("               " + ml["pName"].ToString().Trim() + "\r\n");

	}	//end if

	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(ml["oMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(ml["sMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"right\" style=\"width:15%;\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(ml["qMoney"].ToString().Trim()),2).ToString();
	...
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("              <td align=\"center\" colspan=\"2\" style=\"height:30px;\"><span style=\"font-size:11pt\"><b>合计：</b></span></td>\r\n");
	templateBuilder.Append("              <td align=\"right\">" + sumD.ToString() + "</td>\r\n");
	templateBuilder.Append("              <td align=\"right\">" + sumE.ToString() + "</td>\r\n");
	templateBuilder.Append("              <td align=\"right\">" + sumF.ToString() + "</td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            var getTreeVal = new CostDetails();\r\n");
	templateBuilder.Append("            getTreeVal.Checked();\r\n");
	templateBuilder.Append("            $(document).ready(function () { \r\n");
	templateBuilder.Append("              //页面加载时生成\r\n");
	templateBuilder.Append("    $(window).load(function () {\r\n");
	templateBuilder.Append("        var getType = $(\"#tjType\").children('option:selected').val();\r\n");
	templateBuilder.Append("        var saleType= $(\"#saleType\").children('option:selected').val();\r\n");
	templateBuilder.Append("            if (getType == 0) {\r\n");
	templateBuilder.Append("            if(" + moriType.ToString() + "==0){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='Maori_val' style='width:50%'><option value='0' selected='selected'>区域</option><option value='1'>客户</option><option value='2'>业务员</option><option value='3'>品牌</option> <option value='4'>单品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            if(" + moriType.ToString() + "==1){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='Maori_val' style='width:50%'><option value='0' >区域</option><option value='1' selected='selected'>客户</option><option value='2'>业务员</option><option value='3'>品牌</option> <option value='4'>单品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            if(" + moriType.ToString() + "==2){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='Maori_val' style='width:50%'><option value='0' >区域</option><option value='1'>客户</option><option value='2' selected='selected'>业务员</option><option value='3'>品牌</option> <option value='4'>单品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            if(" + moriType.ToString() + "==3){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='Maori_val' style='width:50%'><option value='0' >区域</option><option value='1'>客户</option><option value='2'>业务员</option><option value='3' selected='selected'>品牌</option> <option value='4'>单品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            if(" + moriType.ToString() + "==4){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='Maori_val' style='width:50%'><option value='0' >区域</option><option value='1'>客户</option><option value='2'>业务员</option><option value='3'>品牌</option> <option value='4' selected='selected'>单品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("        if (getType == 1) {\r\n");
	templateBuilder.Append("            if (" + feeType.ToString() + "==0){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='category_val' style='width:50%'><option value='0' selected='selected'>客户</option><option value='1'>科目</option><option value='2'>业务员</option><option value='3'>赠品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("                if(" + get_direction.ToString() + "==0)\r\n");
	templateBuilder.Append("                {\r\n");
	templateBuilder.Append("                    var kTypeDiv=\"<span id='classN'>科目选择：</span><input type='text' id='className' name='className' value='" + TreeName.ToString() + "' style='width:120px;' /><span id='kDirection'>&nbsp;&nbsp;&nbsp;借贷方向：</span><select id='direction'><option value='0' selected='selected'>借方</option> <option value='1'>贷方</option></select>\";\r\n");
	templateBuilder.Append("                    $(\"#classType\").append(kTypeDiv);\r\n");
	templateBuilder.Append("                }\r\n");
	templateBuilder.Append("                if(" + get_direction.ToString() + "==1)\r\n");
	templateBuilder.Append("                {\r\n");
	templateBuilder.Append("                    var kTypeDiv=\"<span id='classN'>科目选择：</span><input type='text' id='className' name='className' value='" + TreeName.ToString() + "' style='width:120px;' /><span id='kDirection'>&nbsp;&nbsp;&nbsp;借贷方向：</span><select id='direction'><option value='0'>借方</option> <option value='1' selected='selected'>贷方</option></select>\";\r\n");
	templateBuilder.Append("                    $(\"#classType\").append(kTypeDiv);\r\n");
	templateBuilder.Append("                }\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("            if (" + feeType.ToString() + "==1){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='category_val' style='width:50%'><option value='0' >客户</option><option value='1' selected='selected'>科目</option><option value='2'>业务员</option><option value='3'>赠品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("                if(" + get_direction.ToString() + "==0)\r\n");
	templateBuilder.Append("                {\r\n");
	templateBuilder.Append("                    var kTypeDiv=\"<span id='classN'>科目选择：</span><input type='text' id='className' name='className' value='" + TreeName.ToString() + "' style='width:120px;' /><span id='kDirection'>&nbsp;&nbsp;&nbsp;借贷方向：</span><select id='direction'><option value='0' selected='selected'>借方</option> <option value='1'>贷方</option></select>\";\r\n");
	...
	templateBuilder.Append("                }\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("                if (" + feeType.ToString() + "==2){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='category_val' style='width:50%'><option value='0' >客户</option><option value='1' >科目</option><option value='2' selected='selected'>业务员</option><option value='3'>赠品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("                if(" + get_direction.ToString() + "==0)\r\n");
	templateBuilder.Append("                {\r\n");
	templateBuilder.Append("                    var kTypeDiv=\"<span id='classN'>科目选择：</span><input type='text' id='className' name='className' value='" + TreeName.ToString() + "' style='width:120px;' /><span id='kDirection'>&nbsp;&nbsp;&nbsp;借贷方向：</span><select id='direction'><option value='0' selected='selected'>借方</option> <option value='1'>贷方</option></select>\";\r\n");
	...
	templateBuilder.Append("                }\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("                if (" + feeType.ToString() + "==3){\r\n");
	templateBuilder.Append("                var boardDiv = \"<select class='category_val' style='width:50%'><option value='0' >客户</option><option value='1'>科目</option><option value='2'>业务员</option><option value='3' selected='selected'>赠品</option></select>\";\r\n");
	templateBuilder.Append("                $(\"#getType\").append(boardDiv);\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("        }            \r\n");
	templateBuilder.Append("    });\r\n");
