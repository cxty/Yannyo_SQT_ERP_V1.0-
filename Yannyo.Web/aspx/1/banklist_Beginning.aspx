<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.banklist_Beginning" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("        <div class=\"toolbar\"></div>\r\n");
	...
	templateBuilder.Append("          <td width=\"30%\" align=\"right\" >期初金额</td>\r\n");
	...
	templateBuilder.Append("          <tr >\r\n");
	templateBuilder.Append("            <td >" + dl["bName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"right\" >" + dl["BeginMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"center\"><a href=\"javascript:void(0);\" onClick=\"javascript:BankList.ShowSetBeginBox(" + dl["BankID"].ToString().Trim() + ");\">设置</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
