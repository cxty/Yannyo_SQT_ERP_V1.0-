<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.product_price" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/jquery.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<script src=\"/public/js/products_price.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("value=\"" + className.ToString() + "\"\r\n");
	...
	templateBuilder.Append("value=\"" + StorageClassID.ToString() + "\"\r\n");
	...
	if (StorageName !=null && " + Act.ToString() + " !="")
	{
	...
	int sl__loop__id=0;
	foreach(DataRow sl in StorageName.Rows)
	{
		sl__loop__id++;
	...
	templateBuilder.Append("            商品：<input TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\" style=\"width:145px\">(可输入名称,条码或者*查询)\r\n");
	...
	templateBuilder.Append("            时间点：<input type=\"text\" readonly name=\"sDate\" id=\"sDate\" value=\"" + aspxrewriteurl.ToString() + "\" onClick=\"new Calendar().show(this);\" style=\"width:145px\"/>\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:StockProductsManage.Search();\"  />\r\n");
	templateBuilder.Append("            <input type=\"button\" id=\"export_data\" name=\"export_data\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导出数据\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("商品实时库存\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("            </div>\r\n");
	...
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">库存</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">入库未核销</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">出库未核销</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\" align=\"right\">不可用库存</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\" align=\"center\">成本(单价)</td>\r\n");
	...
	templateBuilder.Append("			" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td  align=\"center\" id=\"" + dl__loop__id.ToString() + "_priceBox\">\r\n");

	if (dl["pPrice"].ToString() != "")
	{

	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["pPrice"].ToString()),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("            <nobr>€<input class=\"ProductPriceBox\" pType=\"Price\" style=\"text-align:right;width:50px;\" BoxIndex = \"" + dl__loop__id.ToString() + "\" type=\"text\" oldValue=\"" + aspxrewriteurl.ToString() + "\" value=\"" + aspxrewriteurl.ToString() + "\" ProductsID=\"" + dl["ProductsID"].ToString().Trim() + "\"/></nobr>\r\n");

	if (dl["pPriceRMB"].ToString() != "")
	{

	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["pPriceRMB"].ToString()),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("			<nobr>¥<input class=\"ProductPriceRRMBBox\" pType=\"Price\" style=\"text-align:right;width:50px;\" BoxIndex = \"" + dl__loop__id.ToString() + "\" type=\"text\" oldValue=\"" + aspxrewriteurl.ToString() + "\" value=\"" + aspxrewriteurl.ToString() + "\" ProductsID=\"" + dl["ProductsID"].ToString().Trim() + "\"/></nobr>\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"" + dl__loop__id.ToString() + "_priceBT\" BoxIndex = \"" + dl__loop__id.ToString() + "\" ProductsID=\"" + dl["ProductsID"].ToString().Trim() + "\" name=\"save_price\" style=\"margin:5px\" class=\"B_INPUT\" value=\"保存\" />\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	StockProductsManage.HidUserBox();\r\n");
	templateBuilder.Append("	location=location;\r\n");
	templateBuilder.Append("}\r\n");
	templateBuilder.Append("$().ready(function () {\r\n");
	templateBuilder.Append("    $(window).load(function(){\r\n");
	templateBuilder.Append("		/*\r\n");
	templateBuilder.Append("        $.get('/product_price.aspx','',function(data){\r\n");
	templateBuilder.Append("                 var sName=eval(\"(\"+data+\")\").sName.split(\",\");\r\n");
	templateBuilder.Append("                 var sID=eval(\"(\"+data+\")\").sID.split(\",\");\r\n");
	templateBuilder.Append("                 var count=sName.length;\r\n");
	templateBuilder.Append("                 var StorageID=document.getElementById(\"StorageID\");;\r\n");
	templateBuilder.Append("                 if(count>1)\r\n");
	templateBuilder.Append("                 {\r\n");
	templateBuilder.Append("                     StorageID.length=0;\r\n");
	templateBuilder.Append("                     StorageID.options.add(new Option(\"选择全部\", \"0\"));\r\n");
	templateBuilder.Append("                     for (var i = 0; i < count - 1; i++) {\r\n");
	templateBuilder.Append("                       StorageID.options.add(new Option(sName[i], sID[i]));\r\n");
	templateBuilder.Append("                     }\r\n");
	templateBuilder.Append("                 }\r\n");
	...
	templateBuilder.Append("			*/\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append("    //数据搜索\r\n");
	templateBuilder.Append("    $('#S_key').autocomplete('Services/CAjax.aspx', {\r\n");
	...
	templateBuilder.Append("                'ProductsName': function () { return $('#S_key').val(); }\r\n");
	templateBuilder.Append("            },\r\n");
	...
	templateBuilder.Append("        var StorageClassName=$(\"#StorageClassName\").val();\r\n");
	templateBuilder.Append("        if(StorageClassName =='')\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            jAlert(\"请选择仓库类别！\",\"友情提示\");\r\n");
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("        else\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            var _url = '/product_price.aspx?Act=Export&StorageID=' + $(\"#StorageID\").children('option:selected') + '&ProductID=' + $(\"#ProductID\").val() + '&sDate=' + $(\"#sDate\").val() + '&StorageClassNum=' + $(\"#StorageClassNum\").val();\r\n");
	...
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append("    //仓库分类树\r\n");
	templateBuilder.Append("    $(\"#treeNode\").jstree({   \r\n");
	templateBuilder.Append("	\"json_data\":{\"data\":[{\"data\":\"仓库分类\",\"state\":\"closed\",\"children\":[" + StorageClassJson.ToString() + "]}\r\n");
	templateBuilder.Append("                ]}, \r\n");
	...
	templateBuilder.Append("        var sName = $(\"#treeNode\").jstree('get_text');\r\n");
	templateBuilder.Append("        //document.getElementById(\"StorageClassName\").value=sName;\r\n");
	templateBuilder.Append("        $(\"#StorageClassName\").val(sName);\r\n");
	templateBuilder.Append("        $(\"#StorageClassNum\").val(sID);\r\n");
	templateBuilder.Append("        $(\"#winType\").fadeOut(\"slow\");\r\n");
	templateBuilder.Append("        if(sID !='')\r\n");
	templateBuilder.Append("        {\r\n");
	templateBuilder.Append("            $.post('/product_price.aspx?Aclass=aclass&sClassID='+sID,'',function(data){\r\n");
	templateBuilder.Append("                 var sName=eval(\"(\"+data+\")\").sName.split(\",\");\r\n");
	templateBuilder.Append("                 var sID=eval(\"(\"+data+\")\").sID.split(\",\");\r\n");
	templateBuilder.Append("                 var count=sName.length;\r\n");
	templateBuilder.Append("                 var StorageID=document.getElementById(\"StorageID\");;\r\n");
	...
	templateBuilder.Append("        }\r\n");
	templateBuilder.Append("	 });\r\n");
	templateBuilder.Append("    //打开仓库树\r\n");
	templateBuilder.Append("    $(\"#StorageClassName\").click(function () {\r\n");
	templateBuilder.Append("        $(\"#winType\").fadeIn(\"slow\");\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append("    //关闭仓库树\r\n");
	templateBuilder.Append("    $(\"#winClose\").click(function () {\r\n");
	templateBuilder.Append("        $(\"#winType\").fadeOut(\"slow\");\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append("    $(\"#res_btn\").click(function () {\r\n");
	templateBuilder.Append("        $(\"#winType\").fadeOut(\"slow\");\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append(" });\r\n");
	templateBuilder.Append("</" + "script>\r\n");
