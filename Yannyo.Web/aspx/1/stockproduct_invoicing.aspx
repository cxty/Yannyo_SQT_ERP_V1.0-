<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.stockproduct_invoicing" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("    <script src=\"public/js/stockproduct_invoicing.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("    <form action=\"\" method=\"post\" name=\"form1\" id=\"form1\">\r\n");
	templateBuilder.Append("    <div class=\"toolbar\">\r\n");
	templateBuilder.Append("    &nbsp;&nbsp;\r\n");
	templateBuilder.Append("    仓库:<select id=\"StorageID\" name=\"StorageID\" >\r\n");
	...
	templateBuilder.Append("    时间点:<input type=\"text\" readonly=\"readonly\" name=\"sDate\" id=\"sDate\" value=\"" + sDate.ToString() + "\" onClick=\"new Calendar().show(this);\"/>\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"bt_ok\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\"  />\r\n");
	templateBuilder.Append("	<input type=\"button\" id=\"bt_reset\" style=\"margin:5px\" class=\"B_INPUT\" value=\"重置该日后数据\"  />\r\n");
	templateBuilder.Append("    </div>\r\n");
	...
	templateBuilder.Append("          <td>产品名称</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">期初数量</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">期初金额</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">本期进货数量</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">本期进货金额</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">本期出货数量</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\">本期出货金额</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\" align=\"right\">结存数量</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\" align=\"right\">结存单价</td>\r\n");
	templateBuilder.Append("          <td width=\"5%\" align=\"right\">结存金额</td>\r\n");
	...
	templateBuilder.Append("          <tr id=\"tr_" + dl["ReportInvoicingID"].ToString().Trim() + "\">\r\n");
	templateBuilder.Append("            <td>" + dl["pBarcode"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["pName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"bQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"bQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["bQuantity"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"bMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"bMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["bMoney"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"InQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"InQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["InQuantity"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"InMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"InMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["InMoney"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"OutQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"OutQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["OutQuantity"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"OutMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"OutMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["OutMoney"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"eQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"eQuantity_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["eQuantity"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\">\r\n");

	if (Convert.ToDecimal(dl["eQuantity"].ToString())!=0)
	{

	 aspxrewriteurl = (Convert.ToDecimal(dl["eMoney"].ToString())/Convert.ToDecimal(dl["eQuantity"].ToString())).ToString();
	...
	templateBuilder.Append("            <input style=\"width:90%\" type=\"text\" id=\"Price_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"Price_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + aspxrewriteurl.ToString() + "\"/></td>\r\n");
	templateBuilder.Append("            <td align=\"right\"><input style=\"width:90%\" type=\"text\" id=\"eMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" name=\"eMoney_" + dl["ReportInvoicingID"].ToString().Trim() + "\" value=\"" + dl["eMoney"].ToString().Trim() + "\"/></td>\r\n");
	templateBuilder.Append("			<td align=\"center\"><input type=\"button\" id=\"bt_ok_" + dl["ReportInvoicingID"].ToString().Trim() + "\" style=\"margin:5px\" class=\"B_INPUT\" value=\"保存\"  /></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("	var StockProduct_invoicing = new TStockProduct_invoicing();\r\n");
	templateBuilder.Append("	StockProduct_invoicing.ini();\r\n");
