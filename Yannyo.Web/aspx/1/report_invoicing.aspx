<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.report_invoicing" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script language=\"javascript\" src=\"/public/js/My97DatePicker/WdatePicker.js\"></" + "script>\r\n");
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/jTable.js\"></" + "script>\r\n");
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/report_invoicing.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("                <td align=\"left\" valign=\"top\">仓库:<br/><select id=\"StorageID\" name=\"StorageID\" >\r\n");
	...
	templateBuilder.Append(">" + sl["sName"].ToString().Trim() + "</option>\r\n");
	...
	templateBuilder.Append(">区间</option>\r\n");
	templateBuilder.Append("                </select></td>\r\n");
	templateBuilder.Append("                <td align=\"left\" valign=\"top\">日期:<br />\r\n");

	                string _sDate = DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd");
	                
	 aspxrewriteurl = sDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                <input name=\"day_sDate\" id=\"day_sDate\"  value=\"" + aspxrewriteurl.ToString() + "\" class=\"Wdate\" type=\"text\" onClick=\"WdatePicker({maxDate:'" + _sDate.ToString() + "'})\" />\r\n");
	templateBuilder.Append("                <input name=\"month_sDate\" id=\"month_sDate\"  value=\"" + aspxrewriteurl.ToString() + "\" class=\"Wdate\" type=\"text\" onClick=\"WdatePicker({maxDate:'" + _sDate.ToString() + "',dateFmt:'yyyy-MM'})\" />\r\n");
	templateBuilder.Append("                <input name=\"year_sDate\" id=\"year_sDate\"  value=\"" + aspxrewriteurl.ToString() + "\" class=\"Wdate\" type=\"text\" onClick=\"WdatePicker({maxDate:'" + _sDate.ToString() + "',dateFmt:'yyyy'})\" />\r\n");
	templateBuilder.Append("            <span id=\"sDate_Box\">\r\n");
	templateBuilder.Append("                <input name=\"b_sDate\" id=\"b_sDate\"  value=\"" + aspxrewriteurl.ToString() + "\" class=\"Wdate\" type=\"text\" onClick=\"WdatePicker({maxDate:'" + _sDate.ToString() + "'})\" />\r\n");
	templateBuilder.Append("                -\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                <input name=\"e_sDate\" id=\"e_sDate\"  value=\"" + aspxrewriteurl.ToString() + "\" class=\"Wdate\" type=\"text\" onClick=\"WdatePicker({maxDate:'" + _sDate.ToString() + "'})\" />\r\n");
	templateBuilder.Append("            </span>\r\n");
	templateBuilder.Append("                </td>\r\n");
	templateBuilder.Append("                <td><INPUT TYPE=\"hidden\" NAME=\"sDate\" id=\"sDate\">\r\n");
	templateBuilder.Append("                <INPUT TYPE=\"hidden\" NAME=\"eDate\" id=\"eDate\">\r\n");
	templateBuilder.Append("                <input type=\"button\"  id=\"bt_sub\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 确 定 \" /></td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("            </table>\r\n");
	templateBuilder.Append("            </div>\r\n");
	templateBuilder.Append("            <div class=\"list_title\">\r\n");
	templateBuilder.Append("                进销存 \r\n");
	...
	templateBuilder.Append("                日报表 (" + aspxrewriteurl.ToString() + ")\r\n");
	...
	if (ReType==1)
	{
	 ...
	 aspxrewriteurl = sDate.ToString("yyyy年MM月");
	
	templateBuilder.Append("                月报表 (" + aspxrewriteurl.ToString() + ")\r\n");
	...
	if (ReType==2)
	{
	 ...
	 aspxrewriteurl = sDate.ToString("yyyy年");
	
	templateBuilder.Append("                年报表 (" + aspxrewriteurl.ToString() + ")\r\n");
	...
	templateBuilder.Append("        <thead  style=\"width:100%\">\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td width=\"3%\" rowspan=\"2\" align=\"center\">序号</td>\r\n");
	templateBuilder.Append("            <td width=\"8%\" rowspan=\"2\" align=\"center\">商品条码</td>\r\n");
	templateBuilder.Append("            <td rowspan=\"2\" \r\n");

	if (ShowPrice==true)
	{

	templateBuilder.Append("width=\"20%\"\r\n");

	}
	else
	{

	templateBuilder.Append("width=\"15%\"\r\n");

	}	//end if

	templateBuilder.Append(" align=\"center\">商品名称</td>\r\n");
	...
	templateBuilder.Append("colspan=\"4\"\r\n");
	...
	templateBuilder.Append(" align=\"center\">期初结存</td>\r\n");
	templateBuilder.Append("            <td \r\n");
	...
	templateBuilder.Append(" align=\"center\">本期入库</td>\r\n");
	templateBuilder.Append("            <td \r\n");
	...
	templateBuilder.Append(" align=\"center\">本期出库</td>\r\n");
	templateBuilder.Append("            <td \r\n");
	...
	templateBuilder.Append(" align=\"center\">期末结存</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td width=\"3%\" align=\"right\" class=\"dboxleft\">数量</td>\r\n");
	templateBuilder.Append("            <td width=\"3%\" align=\"right\">件数</td>\r\n");

	if (ShowPrice==true)
	{

	templateBuilder.Append("            <td width=\"3%\" align=\"right\">单价</td>\r\n");
	...
	templateBuilder.Append("            <td width=\"3%\" align=\"right\">单价</td>\r\n");
	templateBuilder.Append("            <td width=\"3%\" align=\"center\">金额</td>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td  align=\"center\">" + dl__loop__id.ToString() + "</td>\r\n");
	...
	templateBuilder.Append("            <td  align=\"center\">" + dl["pToBoxNo"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["bQuantity"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("            " + aspxrewriteurl.ToString() + "\r\n");
	 numA = Convert.ToDecimal(numA+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["bQuantity"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("            " + aspxrewriteurl.ToString() + "\r\n");
	 numAA = Convert.ToDecimal(numAA+Convert.ToDecimal(aspxrewriteurl));
	...
	if (Convert.ToDecimal(dl["bQuantity"])!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["bMoney"])/Convert.ToDecimal(dl["bQuantity"])),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["bMoney"])),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["InQuantity"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("             " + aspxrewriteurl.ToString() + "\r\n");
	 numB = Convert.ToDecimal(numB+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["InQuantity"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("             " + aspxrewriteurl.ToString() + "\r\n");
	 numBB = Convert.ToDecimal(numBB+Convert.ToDecimal(aspxrewriteurl));
	...
	if (Convert.ToDecimal(dl["InQuantity"])!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["InMoney"])/Convert.ToDecimal(dl["InQuantity"])),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["InMoney"]),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["OutQuantity"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("             " + aspxrewriteurl.ToString() + "\r\n");
	 numC = Convert.ToDecimal(numC+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["OutQuantity"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("             " + aspxrewriteurl.ToString() + "\r\n");
	 numCC = Convert.ToDecimal(numCC+Convert.ToDecimal(aspxrewriteurl));
	...
	if (Convert.ToDecimal(dl["OutQuantity"])!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["OutMoney"])/Convert.ToDecimal(dl["OutQuantity"])),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["OutMoney"]),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["eQuantity"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("            " + aspxrewriteurl.ToString() + "\r\n");
	 numD = Convert.ToDecimal(numD+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["eQuantity"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("            " + aspxrewriteurl.ToString() + "\r\n");
	 numDD = Convert.ToDecimal(numDD+Convert.ToDecimal(aspxrewriteurl));
	...
	if (Convert.ToDecimal(dl["eQuantity"])!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["eMoney"])/Convert.ToDecimal(dl["eQuantity"])),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["eMoney"])),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"center\">" + dl["pToBoxNo"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["UpStorage"])+Convert.ToDecimal(dl["UpStorageIn"])-Convert.ToDecimal(dl["UpStorageOut"]),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["UpStorage"])+Convert.ToDecimal(dl["UpStorageIn"])-Convert.ToDecimal(dl["UpStorageOut"]))/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	...
	if ((Convert.ToDecimal(dl["UpStorage"])+Convert.ToDecimal(dl["UpStorageIn"])-Convert.ToDecimal(dl["UpStorageOut"]))!=0)
	{

	 aspxrewriteurl = decimal.Round(((Convert.ToDecimal(dl["UpStorageMoney"])+Convert.ToDecimal(dl["UpStorageInMoney"])-Convert.ToDecimal(dl["UpStorageOutMoney"]))/(Convert.ToDecimal(dl["UpStorage"])+Convert.ToDecimal(dl["UpStorageIn"])-Convert.ToDecimal(dl["UpStorageOut"]))),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["UpStorageMoney"])+Convert.ToDecimal(dl["UpStorageInMoney"])-Convert.ToDecimal(dl["UpStorageOutMoney"])),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageIn"]),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageIn"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	...
	if ((Convert.ToDecimal(dl["StorageIn"]))!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round(((Convert.ToDecimal(dl["StorageInMoney"]))/(Convert.ToDecimal(dl["StorageIn"]))),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageInMoney"]),2).ToString();
	...
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageOut"]),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageOut"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	...
	if ((Convert.ToDecimal(dl["StorageOut"]))!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round(((Convert.ToDecimal(dl["StorageOutMoney"]))/(Convert.ToDecimal(dl["StorageOut"]))),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["StorageOutMoney"]),2).ToString();
	...
	templateBuilder.Append("            <td align=\"right\" class=\"dboxleft\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["LastStorage"]),config.QuantityDecimal).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["LastStorage"]))/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	...
	if ((Convert.ToDecimal(dl["LastStorage"]))!=0)
	{
	 ...
	 aspxrewriteurl = decimal.Round(((Convert.ToDecimal(dl["LastStorageMoney"]))/(Convert.ToDecimal(dl["LastStorage"]))),2).ToString();
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round((Convert.ToDecimal(dl["LastStorageMoney"])),2).ToString();
	...
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td colspan=\"2\" align=\"center\">合计:</td>\r\n");
	templateBuilder.Append("            <td colspan=\"2\" align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\"><span>" + numA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + numAA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + MoneyA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\"><span>" + numB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + numBB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + MoneyB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\"><span>" + numC.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + numCC.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + MoneyC.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\" class=\"dboxleft\"><span>" + numD.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td  align=\"right\"><span>" + numDD.ToString() + "</span></td>\r\n");
	templateBuilder.Append("            <td></td>\r\n");
	...
	templateBuilder.Append("            tf.Clone();//表格结构修改后应重新Clone\r\n");

	}	//end if

	templateBuilder.Append("            var Report_Invoicing = new TReport_Invoicing();\r\n");
	templateBuilder.Append("            Report_Invoicing.ini();\r\n");
	templateBuilder.Append("            </" + "script>\r\n");
