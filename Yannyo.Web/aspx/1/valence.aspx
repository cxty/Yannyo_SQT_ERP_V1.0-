<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.valence" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/valence.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ValenceManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:ValenceManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td >产品</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">变价开始时间</td>\r\n");
	templateBuilder.Append("			<td width=\"20%\">变价结束时间</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">变价期间价格</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ValenceID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:ValenceManage.ShowEditUserBox(" + dl["ValenceID"].ToString().Trim() + ");\">" + dl["ProductsName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td>" + dl["bDateTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["eDateTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["vPrice"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["vAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ValenceManage.ShowDelUserBox(" + dl["ValenceID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ValenceManage.ShowEditUserBox(" + dl["ValenceID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var ValenceManage = new TValenceManage();\r\n");
	templateBuilder.Append("ValenceManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ValenceManage.HidUserBox();\r\n");
