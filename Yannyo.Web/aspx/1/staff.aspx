<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.staff" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/staff.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:StaffManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:StaffManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("姓名:\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:StaffManage.Search();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	if (DepartmentsClassID>0)
	{
	 ...
	 aspxrewriteurl = GetDepartmentsPaterStr(DepartmentsClassID.ToString());
	...
	templateBuilder.Append("			<td width=\"5%\">性别</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">身份证</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">联系电话</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\" align=\"center\">类型</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["StaffID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.ShowEditUserBox(" + dl["StaffID"].ToString().Trim() + ");\">" + dl["sName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td>" + dl["sSex"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sCarID"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["sTel"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"center\">\r\n");
	 aspxrewriteurl = GetStaffTypeStr(dl["sType"].ToString());
	
	templateBuilder.Append("" + aspxrewriteurl.ToString() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"center\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.State(" + dl["StaffID"].ToString().Trim() + ");\" id=\"s_" + dl["StaffID"].ToString().Trim() + "\">\r\n");
	...
	templateBuilder.Append("            <span style=\"color:#F00\" >屏蔽</span>\r\n");

	}	//end if

	templateBuilder.Append("			</a></td>\r\n");
	templateBuilder.Append("            <td align=\"center\">\r\n");
	templateBuilder.Append("<a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.ShowUpBox(" + dl["StaffID"].ToString().Trim() + ");\">上岗</a> \r\n");
	templateBuilder.Append("<a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.ShowDownBox(" + dl["StaffID"].ToString().Trim() + ");\">离岗</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.ShowEditUserBox(" + dl["StaffID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:StaffManage.ShowDelUserBox(" + dl["StaffID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var StaffManage = new TStaffManage();\r\n");
	templateBuilder.Append("StaffManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	StaffManage.HidUserBox();\r\n");
