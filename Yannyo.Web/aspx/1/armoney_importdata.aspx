<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.armoney_importdata" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("	<script src=\"public/js/armoney_importdata.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查看\" onClick=\"javascript:Armoney_ImportdataManage.Search();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"确定导入\" onClick=\"javascript:Armoney_ImportdataManage.OK();\"  />\r\n");
	...
	templateBuilder.Append("        <table width=\"630\" border=\"0\" align=\"left\" cellpadding=\"0\" cellspacing=\"2\" class=\"tBox\">\r\n");
	templateBuilder.Append("          <tr class=\"tBar\">\r\n");
	templateBuilder.Append("            <td >名称</td>\r\n");
	templateBuilder.Append("			<td width=\"70px\">销售额</td>\r\n");
	templateBuilder.Append("			<td width=\"70px\">退货额</td>\r\n");
	templateBuilder.Append("			<td width=\"70px\">新增应收</td>\r\n");
	templateBuilder.Append("			<td width=\"70px\">累计应收</td>\r\n");
	templateBuilder.Append("            <td width=\"70px\">累计实收</td>\r\n");
	templateBuilder.Append("			<td width=\"100px\">实际应收</td>\r\n");
	...
	templateBuilder.Append("		  <div style=\"overflow:scroll;height:400px;overflow-x:hidden;\r\n");
	templateBuilder.Append("          clear:left;\" align=\"left\">\r\n");
	templateBuilder.Append("		  <table width=\"630px\" border=\"0\" align=\"left\" cellpadding=\"0\" cellspacing=\"2\" class=\"tBox\"  >\r\n");
	...
	templateBuilder.Append("            <input name=\"_StoresID_" + loop_count.ToString() + "\" id=\"_StoresID_" + loop_count.ToString() + "\" type=\"hidden\" value=\"" + dl["StoresID"].ToString().Trim() + "\">\r\n");
	...
	templateBuilder.Append("	var Armoney_ImportdataManage = new TArmoney_ImportdataManage();\r\n");
	templateBuilder.Append("	Armoney_ImportdataManage.ini();\r\n");
	templateBuilder.Append("	function HidBox()\r\n");
	templateBuilder.Append("	{\r\n");
	templateBuilder.Append("		Armoney_ImportdataManage.HidUserBox();\r\n");
