<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.sales_do" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("value=\"" + si.ProductsName.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("value=\"" + si.ProductsID.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("                  <td align=\"left\">\r\n");
	templateBuilder.Append("                  <input name=\"sNum\" id=\"sNum\"  type=\"text\" \r\n");

	if (Act=="Edit")
	{

	templateBuilder.Append("value=\"" + si.sNum.ToString().Trim() + "\"\r\n");

	}	//end if

	templateBuilder.Append(" showtitle=\"只能为数字格式\"\r\n");
	templateBuilder.Append("                  </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("                  <td  align=\"right\">金额</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\">\r\n");
	templateBuilder.Append("                  <input name=\"sPrice\" id=\"sPrice\" type=\"text\" \r\n");

	if (Act=="Edit")
	{

	templateBuilder.Append("value=\"" + si.sPrice.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("	};\r\n");
	templateBuilder.Append("	var as_json2 = new bsn.AutoSuggest('ProductsName', options2);\r\n");
	templateBuilder.Append("	*/\r\n");
	...
	templateBuilder.Append("					{\r\n");
	templateBuilder.Append("						if(Sys.getObj('sNum').value != '')\r\n");
	templateBuilder.Append("						{\r\n");
	templateBuilder.Append("							if(Sys.getObj('sPrice').value != '')\r\n");
	templateBuilder.Append("							{\r\n");
	templateBuilder.Append("								if(Sys.getObj('sDateTime').value != '')\r\n");
	templateBuilder.Append("								{\r\n");
	...
	templateBuilder.Append("							}else\r\n");
	templateBuilder.Append("							{\r\n");
	templateBuilder.Append("								alert('金额不能为空!');	\r\n");
	templateBuilder.Append("							}\r\n");
	templateBuilder.Append("						}else\r\n");
	templateBuilder.Append("						{\r\n");
