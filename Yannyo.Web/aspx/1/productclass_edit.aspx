<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.productclass_edit" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(" value=\"" + pi.pClassName.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("" + pi.pClassName.ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("value=\"" + pi.pOrder.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("value=\"" + pAppendTime.ToString() + "\"\r\n");
	...
	templateBuilder.Append("<input type=\"button\" name=\"bt_ok\" id=\"bt_ok\" value=\" 确定 \" class=\"B_INPUT\" style=\"cursor:pointer\"/>&nbsp; &nbsp;<input type=\"button\" name=\"bt_cancel\" id=\"bt_cancel\" value=\" 取消 \" class=\"B_INPUT\" onClick=\"javascript:window.parent.HidBox();\" style=\"cursor:pointer\"/>\r\n");
	templateBuilder.Append("              </div>  \r\n");
	...
	templateBuilder.Append("                jAlert(\"请确保商品分类名称不为空！\", \"友情提示\");\r\n");
	templateBuilder.Append("            }\r\n");
	templateBuilder.Append("        });\r\n");
	templateBuilder.Append("    });\r\n");
	templateBuilder.Append("</" + "script>\r\n");
