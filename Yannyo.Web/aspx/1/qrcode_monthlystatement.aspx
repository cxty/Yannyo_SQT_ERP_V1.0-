<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.qrcode_monthlystatement" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("            <h2>对账单编号:" + msi.sCode.ToString().Trim() + " 该对账单打印时间:" + printdatetime.ToString() + "</h2>\r\n");
	templateBuilder.Append("            <h2>对账单信息:</h2>\r\n");
	templateBuilder.Append("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td align=\"left\">单号:" + msi.sCode.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td align=\"left\">单位:\r\n");
	templateBuilder.Append("" + msi.sObjectName.ToString().Trim() + " </td>\r\n");
	templateBuilder.Append("    <td align=\"left\"> 对账单日期:\r\n");
	 aspxrewriteurl = msi.sDateTime.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("      " + aspxrewriteurl.ToString() + " </td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td align=\"left\">上期余额:" + msi.sUpMoney.ToString().Trim() + " </td>\r\n");
	templateBuilder.Append("    <td align=\"left\">本期新增金额:" + msi.sThisMoney.ToString().Trim() + " </td>\r\n");
	templateBuilder.Append("    <td align=\"left\">本期实际对账金额:" + msi.sMoney.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td align=\"left\">到款金额:" + msi.sToMoney.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td colspan=\"2\" align=\"left\">本期余额:" + msi.sBalanceMoney.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
