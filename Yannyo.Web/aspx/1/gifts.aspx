<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.gifts" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/gifts.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:GiftsManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:GiftsManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["GiftsID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>" + dl["StoresName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["ProductsName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["gNum"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["gDateTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["gAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:GiftsManage.ShowDelUserBox(" + dl["GiftsID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:GiftsManage.ShowEditUserBox(" + dl["GiftsID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var GiftsManage = new TGiftsManage();\r\n");
	templateBuilder.Append("GiftsManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	GiftsManage.HidUserBox();\r\n");
