<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.productpool" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/productpool.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ProductPoolManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:ProductPoolManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\"><INPUT TYPE=\"hidden\" NAME=\"Act\" id=\"Act\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:ProductPoolManage.Search();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("联营商品列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ProductPoolID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td><a href=\"javascript:void(0);\" onclick=\"javascript:ProductPoolManage.ShowEditUserBox(" + dl["ProductPoolID"].ToString().Trim() + ");\">" + dl["pBarcode"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td><a href=\"javascript:void(0);\" onclick=\"javascript:ProductPoolManage.ShowEditUserBox(" + dl["ProductPoolID"].ToString().Trim() + ");\">" + dl["pName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td align=\"center\">\r\n");

	if (dl["pType"].ToString() == "0")
	{
	...
	if (dl["pType"].ToString() == "1")
	{

	templateBuilder.Append("            结束联营\r\n");

	}	//end if

	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("			<td> \r\n");
	 aspxrewriteurl = Convert.ToDateTime(dl["pDateTime"]).ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                    " + aspxrewriteurl.ToString() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["pAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"center\">\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ProductPoolManage.ShowDelUserBox(" + dl["ProductPoolID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<!--<a href=\"javascript:void(0);\" onclick=\"javascript:ProductPoolManage.ShowEditUserBox(" + dl["ProductPoolID"].ToString().Trim() + ");\">修改</a>-->\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var ProductPoolManage = new TProductPoolManage();\r\n");
	templateBuilder.Append("ProductPoolManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ProductPoolManage.HidUserBox();\r\n");
