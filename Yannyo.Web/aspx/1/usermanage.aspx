<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.usermanage" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/usermanage.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:UserManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:UserManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td>操作员登名</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\">登录IP</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">状态</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">最后登录时间</td>\r\n");
	...
	int uil__loop__id=0;
	foreach(DataRow uil in UserInfoList.Rows)
	{
		uil__loop__id++;
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + uil["UserID"].ToString().Trim() + "\" />\r\n");

	}	//end if

	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:UserManage.ShowEditUserBox(" + uil["UserID"].ToString().Trim() + ");\">" + uil["uName"].ToString().Trim() + " (" + uil["StaffName"].ToString().Trim() + ")</a></td>\r\n");
	templateBuilder.Append("            <td>" + uil["uLastIP"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td>" + uil["uUpAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + uil["uAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>\r\n");

	if (uil["uPermissions"].ToString() != "X")
	{

	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:UserManage.ShowDelUserBox(" + uil["UserID"].ToString().Trim() + ");\">删除</a>\r\n");

	}	//end if

	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:UserManage.ShowEditUserBox(" + uil["UserID"].ToString().Trim() + ");\">修改</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");

	}	//end loop

	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"7\">" + PageBarHTML.ToString() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var UserManage = new TUserManage();\r\n");
	templateBuilder.Append("UserManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	UserManage.HidUserBox();\r\n");
	templateBuilder.Append("	location='/usermanage.aspx';\r\n");
	templateBuilder.Append("}\r\n");

	if (Act=="Add")
	{

	templateBuilder.Append("UserManage.ShowAddUserBox();\r\n");
