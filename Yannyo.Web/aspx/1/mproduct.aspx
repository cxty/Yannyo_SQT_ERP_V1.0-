<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.mproduct" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/m_product.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("<div >\r\n");
	templateBuilder.Append("<div class=\"toolbar\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_DownLoad\" style=\"margin:5px\" class=\"B_INPUT\" value=\"下载数据\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_Delt\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_UpList\" style=\"margin:5px\" class=\"B_INPUT\" value=\"上架选中\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_DownList\" style=\"margin:5px\" class=\"B_INPUT\" value=\"下架选中\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_Recommend\" style=\"margin:5px\" class=\"B_INPUT\" value=\"推荐选中\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_NORecommend\" style=\"margin:5px\" class=\"B_INPUT\" value=\"取消推荐选中\" />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"bt_UpdateNum\" style=\"margin:5px\" class=\"B_INPUT\" value=\"设置商品库存\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td width=\"10%\">所属网店分类</td>\r\n");
	templateBuilder.Append("            <td width=\"18%\">网店商品名称</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">对应商品名称</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">商品类型</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">消保类型</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">上架时间</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">下架时间</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">有效期</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">价格</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">会员打折</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">橱窗推荐</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">修改时间</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">商品状态</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">是否违规</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["m_GoodsID"].ToString().Trim() + "\" num_iid=\"" + dl["num_iid"].ToString().Trim() + "\" cid=\"" + dl["cid"].ToString().Trim() + "\"/>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("		    <td width=\"10%\">" + dl["mCatName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"18%\"><a href=\"javascript:void(0);\" onclick=\"javascript:M_Product.Edit(" + dl["m_GoodsID"].ToString().Trim() + ");\">" + dl["title"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">" + dl["ProductsName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">\r\n");
	 aspxrewriteurl = GetGoods_Typess(dl["type"].ToString());
	
	templateBuilder.Append("			" + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">" + dl["promoted_service"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">" + dl["list_time"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">" + dl["delist_time"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">" + dl["valid_thru"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"right\">" + dl["price"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\">\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\" id=\"recommend_" + dl["num_iid"].ToString().Trim() + "\">\r\n");
	...
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">" + dl["modified"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\" align=\"center\" id=\"list_" + dl["num_iid"].ToString().Trim() + "\">\r\n");
	 aspxrewriteurl = GetApprove_status(dl["approve_status"].ToString());
	...
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:M_Product.Edit(" + dl["m_GoodsID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"16\">" + PageBarHTML.ToString() + "</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	templateBuilder.Append("          </tfoot>\r\n");
	...
	templateBuilder.Append("var M_Product = new TM_Product();\r\n");
	templateBuilder.Append("M_Product.MConfigID = " + M_Config.m_ConfigInfoID.ToString().Trim() + ";\r\n");
	templateBuilder.Append("M_Product.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	M_Product.HidUserBox();\r\n");
