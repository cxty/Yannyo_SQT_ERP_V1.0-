<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.customersclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/customersclass.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("               <tr><td><b>客户分类</b></td></tr>\r\n");
	...
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["CustomersClassID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:25%\">" + pl["cClassName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">" + pl["cOrder"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">" + pl["cAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:upDate('" + pl["CustomersClassID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:delData('" + pl["CustomersClassID"].ToString().Trim() + "','" + pl["cParentID"].ToString().Trim() + "','" + pl["cClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
