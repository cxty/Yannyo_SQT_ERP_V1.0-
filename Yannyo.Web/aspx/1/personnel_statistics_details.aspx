<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.personnel_statistics_details" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("              <td  >查询日期：<br /><nobr>\r\n");
	 aspxrewriteurl = bDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                 <input style=\"width:100px;\" name=\"bDate\" id=\"bDate\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" />至\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("                <input style=\"width:100px;\" name=\"eDate\" id=\"eDate\" type=\"text\" value=\"" + aspxrewriteurl.ToString() + "\" onclick=\"new Calendar().show(this);\" /></nobr>\r\n");
	templateBuilder.Append("               </td><td>\r\n");
	templateBuilder.Append("                岗位状态：<br />\r\n");
	templateBuilder.Append("                <select id=\"state\">\r\n");
	...
	templateBuilder.Append(">上岗</option>\r\n");
	...
	templateBuilder.Append(">离岗</option>\r\n");
	templateBuilder.Append("                </select>\r\n");
	templateBuilder.Append("                <input type=\"hidden\" id=\"dType\" name=\"dType\" />\r\n");
	...
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;height:30px\"><span style=\"font-size:11pt\">编号</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\">人员名称</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;height:30px\"><span style=\"font-size:11pt\">所属部门</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\">状态</span></td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;height:30px\"><span style=\"font-size:11pt\">日期</span></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	...
	templateBuilder.Append("            <tr>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:10%;\">" + ml__loop__id.ToString() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:20%;\">" + ml["sName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("               <td align=\"center\" style=\"width:30%;\">" + ml["dClassName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("               </td>\r\n");
	templateBuilder.Append("               <td align=\"left\" style=\"width:20%;\">" + ml["sDateTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            </tr>\r\n");
	...
	templateBuilder.Append("                var head = document.getElementById(\"title_space\");\r\n");
	templateBuilder.Append("                if ((t + document.getElementById(\"space\").offsetTop) < 0) {\r\n");
	templateBuilder.Append("                    head.style.position = \"absolute\";\r\n");
	templateBuilder.Append("                    document.getElementById(\"title_space\").style.top = (-t) + \"px\";\r\n");
	templateBuilder.Append("                }\r\n");
	...
	templateBuilder.Append("                    $(\"#dType\").val($(\"#state\").children('option:selected').val());\r\n");
