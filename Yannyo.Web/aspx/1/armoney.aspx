<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.armoney" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/armoney.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ArmoneyManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:ArmoneyManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button4\" style=\"margin:5px\" class=\"B_INPUT\" value=\"批量添加\" onclick=\"javascript:ArmoneyManage.ShowAddBatBox();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button2\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入\" onclick=\"javascript:ArmoneyManage.ShowImportUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"10%\">类型</td>\r\n");
	templateBuilder.Append("			<td >名称</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">新增金额</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">实际对账金额</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">开票日期</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">开票金额</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">预计到款日期</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">实际收款日期</td>\r\n");
	templateBuilder.Append("            <td width=\"80\">实际收款金额</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">是否已完成</td>\r\n");
	templateBuilder.Append("			<td width=\"80\">最后操作时间</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ARMoneyID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td>\r\n");
	...
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("			<td><nobr><a href=\"javascript:void(0);\" onclick=\"javascript:ArmoneyManage.ShowEditUserBox(" + dl["ARMoneyID"].ToString().Trim() + ");\">" + dl["ARObjName"].ToString().Trim() + "</a></nobr></td>\r\n");
	templateBuilder.Append("            <td align=\"right\">" + dl["aAMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["aBMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["aOpenDate"].ToString()).ToString("yyyy-MM-dd");
	
	templateBuilder.Append("			<nobr>" + aspxrewriteurl.ToString() + "</nobr></td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["aOpenMoney"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">\r\n");
	 aspxrewriteurl = DateTime.Parse(dl["aDate"].ToString()).ToString("yyyy-MM-dd");
	...
	if (dl["aSteps"].ToString()=="2")
	{
	 ...
	 aspxrewriteurl = DateTime.Parse(dl["aActualDate"].ToString()).ToString("yyyy-MM-dd");
	...
	templateBuilder.Append("			" + dl["aActualMoney"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("            完成\r\n");

	}	//end if

	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("			<td align=\"right\"><nobr>" + dl["aUpdateTime"].ToString().Trim() + "</nobr></td>\r\n");
	templateBuilder.Append("			<td align=\"right\"><nobr>" + dl["aAppendTime"].ToString().Trim() + "</nobr></td>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ArmoneyManage.ShowDelUserBox(" + dl["ARMoneyID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ArmoneyManage.ShowEditUserBox(" + dl["ARMoneyID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"14\">\r\n");
	...
	templateBuilder.Append("var ArmoneyManage = new TArmoneyManage();\r\n");
	templateBuilder.Append("ArmoneyManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ArmoneyManage.HidUserBox();\r\n");
	...
	templateBuilder.Append("    </div></form>\r\n");
