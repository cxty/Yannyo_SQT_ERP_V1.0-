<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.storage" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/Storage.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	templateBuilder.Append("    <div class=\"main\" id=\"Storage\">\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:Storage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:Storage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入导出\" onclick=\"javascript:Storage.dataAct();\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("仓库列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("            <td >仓库名称</td>\r\n");
	templateBuilder.Append("            <td width=\"20%\">所属分类</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">编码</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">管理员</td>\r\n");
	templateBuilder.Append("            <td width=\"10%\">联系电话</td>\r\n");
	templateBuilder.Append("			<td width=\"10%\">地址</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["StorageID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:Storage.ShowEditUserBox(" + dl["StorageID"].ToString().Trim() + ");\">" + dl["sName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td>" + dl["storageName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["sCode"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td>" + dl["Manager"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:Storage.State(" + dl["StorageID"].ToString().Trim() + ");\" id=\"s_" + dl["StorageID"].ToString().Trim() + "\">\r\n");
	...
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:Storage.ShowDelUserBox(" + dl["StorageID"].ToString().Trim() + ");\">删除</a>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:Storage.ShowEditUserBox(" + dl["StorageID"].ToString().Trim() + ");\">修改</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var Storage = new TStorage();\r\n");
	templateBuilder.Append("Storage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	Storage.HidUserBox();\r\n");
