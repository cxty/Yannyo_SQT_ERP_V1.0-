<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.yhsys_do" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("                  <td width=\"20%\" align=\"right\" class=\"ltd\">系统名称</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\" class=\"rtd\">\r\n");
	templateBuilder.Append("                  <input name=\"yName\" id=\"yName\" type=\"text\" \r\n");

	if (Act=="Edit")
	{

	templateBuilder.Append("value=\"" + YHsys.yName.ToString().Trim() + "\"\r\n");

	}	//end if

	templateBuilder.Append(" showtitle=\"客户进销存系统名称\"\r\n");
	...
	templateBuilder.Append("                  	<input type=\"submit\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"确定\" />\r\n");
