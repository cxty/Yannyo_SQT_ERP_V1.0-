<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.report_purchase" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	/* 
		本页面代码由Yannyo模板引擎生成于 2015/6/2 16:49:34. 
	*/
	...
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/report_purchase.js\"></" + "script>        \r\n");
	...
	templateBuilder.Append("    <td align=\"left\" valign=\"top\">时间:<br />\r\n");
	 aspxrewriteurl = bDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("      <input name=\"bDate\" id=\"bDate\" style=\"width:100px;\" value=\"" + aspxrewriteurl.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/>-\r\n");
	 aspxrewriteurl = eDate.ToString("yyyy-MM-dd");
	
	templateBuilder.Append("      <input name=\"eDate\" id=\"eDate\" style=\"width:100px;\" value=\"" + aspxrewriteurl.ToString() + "\" type=\"text\" onClick=\"new Calendar().show(this);\" readonly=\"readonly\"/>\r\n");
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td align=\"left\" valign=\"top\">统计类型:<br><select id=\"ReType\" name=\"ReType\" >\r\n");
	...
	templateBuilder.Append("    <td align=\"left\" valign=\"top\"><input type=\"button\"  id=\"bt_sub\" style=\"margin:5px;width:120px\" class=\"B_INPUT\" value=\" 确 定 \" /></td>\r\n");
	templateBuilder.Append("    </tr>\r\n");
	...
	templateBuilder.Append("供应商进货统计\r\n");
	...
	templateBuilder.Append(">进货(未核销)</td>\r\n");
	templateBuilder.Append("    <td \r\n");
	...
	templateBuilder.Append(" align=\"center\">退货(未核销)</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" \r\n");
	...
	templateBuilder.Append(">进货(已核销)</td>\r\n");
	templateBuilder.Append("    <td \r\n");
	...
	templateBuilder.Append(" align=\"center\">退货(已核销)</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\">数量</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\">件数</td>\r\n");

	if (ShowPrice==true)
	{

	templateBuilder.Append("    <td width=\"5%\" align=\"center\">金额</td>\r\n");
	...
	templateBuilder.Append("    <td width=\"5%\" align=\"left\">" + dl["pBarcode"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooQuantity"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyAAAo = Convert.ToDecimal(MoneyAAAo+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooQuantity"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyAAo = Convert.ToDecimal(MoneyAAo+Convert.ToDecimal(aspxrewriteurl));
	...
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooMoney"]),2).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyAo = Convert.ToDecimal(MoneyAo+Convert.ToDecimal(aspxrewriteurl));
	...
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooQuantity_t"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyBBBo = Convert.ToDecimal(MoneyBBBo+Convert.ToDecimal(aspxrewriteurl));
	
	templateBuilder.Append("    </td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooQuantity_t"])/Convert.ToDecimal(dl["pToBoxNo"]),config.QuantityDecimal).ToString();
	
	templateBuilder.Append("    " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyBBo = Convert.ToDecimal(MoneyBBo+Convert.ToDecimal(aspxrewriteurl));
	...
	templateBuilder.Append("    <td width=\"5%\" align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["ooMoney_t"]),2).ToString();
	
	templateBuilder.Append("     " + aspxrewriteurl.ToString() + "\r\n");
	 MoneyBo = Convert.ToDecimal(MoneyBo+Convert.ToDecimal(aspxrewriteurl));
	...
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyAAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyBBBo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyBBo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + MoneyBo.ToString() + "</span></td>\r\n");
	...
	templateBuilder.Append("<table  border=\"0\" cellspacing=\"1\" cellpadding=\"1\" class=\"tBox\" id=\"tBox\" width=\"100%\">\r\n");
	templateBuilder.Append("<thead >\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td width=\"3%\" rowspan=\"2\" align=\"center\">序号</td>\r\n");
	templateBuilder.Append("    <td rowspan=\"2\" width=\"15%\" align=\"center\">供应商</td>\r\n");
	templateBuilder.Append("    <td colspan=\"3\" width=\"30%\" align=\"center\">商品</td>\r\n");
	templateBuilder.Append("    <td align=\"center\" \r\n");
	...
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("  	<td width=\"10%\"  align=\"left\">商品条码</td>\r\n");
	templateBuilder.Append("    <td align=\"left\" width=\"10%\">商品名称</td>\r\n");
	templateBuilder.Append("    <td width=\"10%\"  align=\"center\">装件数</td>\r\n");
	templateBuilder.Append("    <td width=\"3%\" align=\"center\">数量</td>\r\n");
	templateBuilder.Append("    <td width=\"3%\" align=\"center\">件数</td>\r\n");
	...
	int sdl__loop__id=0;
	foreach(DataRow sdl in sdList.Rows)
	{
		sdl__loop__id++;
	...
	templateBuilder.Append("rowspan=\"" + sdl["pCount"].ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append(">" + sdl["sName"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("                    <td align=\"center\">小计:</td>\r\n");
	templateBuilder.Append("                    <td colspan=\"4\" align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("                   <td align=\"right\"><span>" + MoneyAAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("                    <td align=\"right\"><span>" + MoneyAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("                    <td align=\"right\"><span>" + MoneyAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("                    <td align=\"right\"><span>" + MoneyBBBo.ToString() + "</span></td>\r\n");
	...
	templateBuilder.Append("                    <td align=\"right\"><span>" + MoneyBB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("                    <td align=\"right\"><span>" + MoneyB.ToString() + "</span></td>\r\n");
	 sMoneyAAAo = sMoneyAAAo+MoneyAAAo;
	
	 sMoneyAAo = sMoneyAAo+MoneyAAo;
	
	 sMoneyAo = sMoneyAo+MoneyAo;
	
	 sMoneyBBBo = sMoneyBBBo+MoneyBBBo;
	
	 sMoneyBBo = sMoneyBBo+MoneyBBo;
	
	 sMoneyBo = sMoneyBo+MoneyBo;
	
	 sMoneyAAA = sMoneyAAA+MoneyAAA;
	
	 sMoneyAA = sMoneyAA+MoneyAA;
	
	 sMoneyA = sMoneyA+MoneyA;
	
	 sMoneyBBB = sMoneyBBB+MoneyBBB;
	
	 sMoneyBB = sMoneyBB+MoneyBB;
	
	 sMoneyB = sMoneyB+MoneyB;
	...
	templateBuilder.Append("    <td align=\"center\">合计:</td>\r\n");
	templateBuilder.Append("    <td colspan=\"4\" align=\"center\">&nbsp;</td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyAAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyAAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyAo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyBBBo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyBBo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyBo.ToString() + "</span></td>\r\n");
	templateBuilder.Append("	<td align=\"right\"><span>" + sMoneyAAA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyAA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyA.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyBBB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyBB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("    <td align=\"right\"><span>" + sMoneyB.ToString() + "</span></td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("</tfoot>\r\n");
	...
	templateBuilder.Append("var Report_Purchase = new TReport_Purchase();\r\n");
	templateBuilder.Append("Report_Purchase.ini();\r\n");
	templateBuilder.Append("</" + "script>\r\n");
