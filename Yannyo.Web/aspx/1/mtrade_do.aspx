<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.mtrade_do" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"/public/js/mtrade_do.js\" type=\"text/javascript\" ></" + "script>\r\n");
	...
	templateBuilder.Append("                <td >交易订单号</td>\r\n");
	templateBuilder.Append("                <td width=\"30%\">买家昵称</td>\r\n");
	templateBuilder.Append("				<td width=\"10%\" align=\"right\">总金额</td>\r\n");
	templateBuilder.Append("                <td width=\"15%\" align=\"center\">交易类型</td>\r\n");
	templateBuilder.Append("                <td width=\"15%\"  align=\"right\">交易时间</td>\r\n");
	...
	templateBuilder.Append("                <td align=\"center\" width=\"2%\"><input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" title=\"" + dl["title"].ToString().Trim() + "\" id=\"ch_" + dl["tid"].ToString().Trim() + "\" value=\"" + dl["tid"].ToString().Trim() + "\" /></td>\r\n");
	templateBuilder.Append("                <td >" + dl["tid"].ToString().Trim() + "\r\n");
	...
	templateBuilder.Append("                <td width=\"30%\"  >" + dl["buyer_nick"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("				<td width=\"10%\"  align=\"right\">" + dl["total_fee"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                <td width=\"15%\" align=\"center\">\r\n");
	 aspxrewriteurl = GetTrade_Types(dl["type"].ToString());
	
	templateBuilder.Append("            " + aspxrewriteurl.ToString() + "\r\n");
	templateBuilder.Append("                </td>\r\n");
	templateBuilder.Append("                <td width=\"15%\"  align=\"right\">\r\n");
	templateBuilder.Append("                " + dl["created"].ToString().Trim() + "\r\n");
	templateBuilder.Append("                </td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	...
	templateBuilder.Append("                <a href=\"javascript:void(0);\" onclick=\"M_Trade_do.PageUp();\"><-上一页</a>\r\n");

	}	//end if

	templateBuilder.Append("                <a href=\"javascript:void(0);\" onclick=\"M_Trade_do.PageDown();\">下一页-></a></td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("              </tfoot>\r\n");
	...
	templateBuilder.Append("var M_Trade_do = new TM_Trade_do();\r\n");
	templateBuilder.Append("M_Trade_do.MConfigID = " + M_Config.m_ConfigInfoID.ToString().Trim() + ";\r\n");
	templateBuilder.Append("M_Trade_do.PageIndex = " + pageindex.ToString() + ";\r\n");
	templateBuilder.Append("M_Trade_do.ActStr = '" + Act.ToString() + "';\r\n");
	templateBuilder.Append("M_Trade_do.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	M_Trade_do.HidUserBox();\r\n");
	templateBuilder.Append("}\r\n");
