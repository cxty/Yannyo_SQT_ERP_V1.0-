<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.feessubject" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/feessubject.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:FeesSubjectManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:FeesSubjectManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	int fl__loop__id=0;
	foreach(DataRow fl in FeesList.Rows)
	{
		fl__loop__id++;

	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + fl["FeesSubjectID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:FeesSubjectManage.ShowEditUserBox(" + fl["FeesSubjectID"].ToString().Trim() + ");\">" + fl["fName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td><a href=\"javascript:void(0);\" onclick=\"javascript:FeesSubjectManage.ShowDelUserBox(" + fl["FeesSubjectID"].ToString().Trim() + ");\">删除</a> <a href=\"javascript:void(0);\" onclick=\"javascript:FeesSubjectManage.ShowEditUserBox(" + fl["FeesSubjectID"].ToString().Trim() + ");\">修改</a></td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("var FeesSubjectManage = new TFeesSubjectManage();\r\n");
	templateBuilder.Append("FeesSubjectManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	FeesSubjectManage.HidUserBox();\r\n");
