<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.products" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script src=\"public/js/products.js\" language=\"javascript\" type=\"text/javascript\"></" + "script>\r\n");
	...
	templateBuilder.Append("        <form action=\"\" method=\"post\" name=\"form1\" id=\"form1\" onsubmit=\"javascript:ProductsManage.Search();\">\r\n");
	templateBuilder.Append("<div class=\"toolbar\">\r\n");
	templateBuilder.Append("<div class=\"toolbox\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button1\" style=\"margin:5px\" class=\"B_INPUT\" value=\"删除选中\" onclick=\"javascript:ProductsManage.Delt();\"  />\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button3\" style=\"margin:5px\" class=\"B_INPUT\" value=\"添加\" onclick=\"javascript:ProductsManage.ShowAddUserBox();\"  />\r\n");
	templateBuilder.Append("<INPUT TYPE=\"text\" NAME=\"S_key\" id=\"S_key\" value=\"" + S_key.ToString() + "\"><INPUT TYPE=\"hidden\" NAME=\"Act\" id=\"Act\">\r\n");
	templateBuilder.Append("<input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"查找\" onclick=\"javascript:ProductsManage.Search();\"  />\r\n");
	templateBuilder.Append("    <input type=\"button\" id=\"button5\" style=\"margin:5px\" class=\"B_INPUT\" value=\"导入导出\" onclick=\"javascript:ProductsManage.dataAct();\" />\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<div class=\"list_title\">\r\n");
	templateBuilder.Append("商品列表\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("			<td width=\"10%\">规格</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">小单位</td>\r\n");
	templateBuilder.Append("            <td width=\"5%\">大单位</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">件装数</td>\r\n");
	templateBuilder.Append("			<td width=\"5%\">默认成本</td>\r\n");
	...
	templateBuilder.Append("            <input name=\"cCheck\" type=\"checkbox\" class=\"B_Check\" value=\"" + dl["ProductsID"].ToString().Trim() + "\" />\r\n");
	templateBuilder.Append("            </td>\r\n");
	templateBuilder.Append("			<td><a href=\"/products_show.aspx?pid=" + dl["ProductsID"].ToString().Trim() + "\" target=\"_blank\" >" + dl["pBarcode"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("			<td><a href=\"/products_show.aspx?pid=" + dl["ProductsID"].ToString().Trim() + "\"  target=\"_blank\">" + dl["pName"].ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("            <td>" + dl["pBrand"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td>" + dl["pStandard"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"center\">" + dl["pUnits"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("            <td align=\"center\">" + dl["pMaxUnits"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">1*" + dl["pToBoxNo"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"right\">" + dl["pPrice"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("			<td align=\"center\">\r\n");
	templateBuilder.Append("            <a href=\"javascript:void(0);\" onclick=\"javascript:ProductsManage.SetState(" + dl["ProductsID"].ToString().Trim() + ");\" id=\"p_" + dl["ProductsID"].ToString().Trim() + "\">\r\n");

	if (dl["pState"].ToString() == "0")
	{
	...
	templateBuilder.Append("            <td>\r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ProductsManage.ShowDelUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">删除</a> \r\n");
	templateBuilder.Append("			<a href=\"javascript:void(0);\" onclick=\"javascript:ProductsManage.ShowEditUserBox(" + dl["ProductsID"].ToString().Trim() + ");\">修改</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("          </tr>\r\n");
	...
	templateBuilder.Append("          <tr>\r\n");
	templateBuilder.Append("            <td colspan=\"12\">\r\n");
	...
	templateBuilder.Append("var ProductsManage = new TProductsManage();\r\n");
	templateBuilder.Append("ProductsManage.ini();\r\n");
	templateBuilder.Append("function HidBox()\r\n");
	templateBuilder.Append("{\r\n");
	templateBuilder.Append("	ProductsManage.HidUserBox();\r\n");
