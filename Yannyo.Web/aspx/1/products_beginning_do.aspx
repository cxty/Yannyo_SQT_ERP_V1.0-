<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.products_beginning_do" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("                  <td  align=\"right\" class=\"ltd\">商品名称</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\" class=\"rtd\">\r\n");

	if (Act=="Edit")
	{

	templateBuilder.Append("<h3>" + pi.pName.ToString().Trim() + "</h3>\r\n");
	...
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("                  <td  align=\"right\" class=\"ltd\">" + sl["sName"].ToString().Trim() + "<br>" + sl["sCode"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\" class=\"rtd\">\r\n");
	...
	templateBuilder.Append("                  <input name=\"Quantity_" + sl__loop__id.ToString() + "\" id=\"Quantity_" + sl__loop__id.ToString() + "\" type=\"text\" value=\"" + sl["Quantity"].ToString().Trim() + "\" showtitle=\"只能填写数字格式\"/></td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
