<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.report_out" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script language=\"javascript\" type=\"text/javascript\" src=\"/public/js/jquery.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("<script language=\"javascript\" src=\"public/js/report_out.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("<table class=\"B_INPUT\" border=\"0\" cellspacing=\"2\" cellpadding=\"0\" style=\"width:100%\"> \r\n");
	templateBuilder.Append("  <tr>\r\n");
	templateBuilder.Append("    <td align=\"left\" style=\"width:20%\">时间:\r\n");
	...
	templateBuilder.Append("    <td align=\"left\" style=\"width:13%\">统计类型:<select id=\"ReType\" class=\"B_INPUT\" name=\"ReType\" >\r\n");
	...
	templateBuilder.Append("    <td align=\"left\" style=\"width:10%\">联营:\r\n");
	...
	templateBuilder.Append("    </select></td>\r\n");
	templateBuilder.Append("    <td align=\"left\" style=\"width:8%\"><input type=\"button\"  id=\"bt_sub\" style=\"margin:5px;\" class=\"B_INPUT\" value=\" 确 定 \" /></td>\r\n");
	...
	templateBuilder.Append("width=\"30%\"\r\n");

	}
	else
	{

	templateBuilder.Append("width=\"35%\"\r\n");
	...
	templateBuilder.Append(" align=\"center\">退货</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	...
	templateBuilder.Append("<thead>\r\n");
	templateBuilder.Append("  <tr class=\"tBar\">\r\n");
	templateBuilder.Append("    <td width=\"3%\" align=\"center\">序号</td>\r\n");
	templateBuilder.Append("    <td width=\"82%\" align=\"center\">客户名称</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\">分类</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\" >出货</td>\r\n");
	templateBuilder.Append("    <td width=\"5%\" align=\"center\" >退货</td>\r\n");
	templateBuilder.Append("  </tr>\r\n");
	templateBuilder.Append("</thead>\r\n");
	templateBuilder.Append(" <tbody>\r\n");
	...
	templateBuilder.Append("    <td align=\"left\">&nbsp;" + dl["cClassName"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("    <td  align=\"right\">\r\n");
	 aspxrewriteurl = decimal.Round(Convert.ToDecimal(dl["oMoney"]),2).ToString();
	...
	templateBuilder.Append("  <div id=\"winAll\" style=\"display:none\">\r\n");
	templateBuilder.Append("       <div id=\"winBody\">\r\n");
	templateBuilder.Append("        <table style=\"width:400px;height:280px;\">\r\n");
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("                <td style=\"background-color:#AABE4D;height:40px\"><span style=\"color:White;font-size:larger; padding-left:10px\"><b>导出类型</b></span><span id=\"winClose\">关闭</span></td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("              <tr>\r\n");
	templateBuilder.Append("                <td style=\"border:1px solid #cccccc;\">\r\n");
	templateBuilder.Append("                  <input type=\"checkbox\" name=\"cbox\" value=\"0\" onclick=\"chooseOne(this);\" style=\"width:50px\"/>按单品导出<br /><br />\r\n");
	templateBuilder.Append("                  <input type=\"checkbox\" name=\"cbox\" value=\"1\" onclick=\"chooseOne(this);\" style=\"width:50px\"/>按客户导出<br /><br />\r\n");
	templateBuilder.Append("                  <input type=\"checkbox\" name=\"cbox\" value=\"2\" onclick=\"chooseOne(this);\" style=\"width:50px\"/>按品牌导出<br /><br />\r\n");
	templateBuilder.Append("                  <input type=\"checkbox\" name=\"cbox\" value=\"3\" onclick=\"chooseOne(this);\" style=\"width:50px\"/>按区域导出<br /><br />\r\n");
	templateBuilder.Append("                  <input type=\"checkbox\" name=\"cbox\" value=\"4\" onclick=\"chooseOne(this);\" style=\"width:50px\"/>按业务员导出\r\n");
	templateBuilder.Append("                </td>\r\n");
	templateBuilder.Append("              </tr>\r\n");
	templateBuilder.Append("               <tr>\r\n");
	templateBuilder.Append("                <td style=\"height:40px\">\r\n");
	...
	templateBuilder.Append("var Report_Out = new TReport_Out();\r\n");
	templateBuilder.Append("Report_Out.ini();\r\n");
	templateBuilder.Append("$(document).ready(function () {\r\n");
	templateBuilder.Append("    //提交导出\r\n");
	templateBuilder.Append("    $(\"#export_data\").click(function () {\r\n");
	templateBuilder.Append("        var _url = '/report_out.aspx?Act=Export&bDate=' + $(\"#bDate\").val() + '&eDate=' + $(\"#eDate\").val() + '&ReType=' + $(\"#ReType\").children('option:selected').val() + '&NOJoinSales=' + $(\"#NOJoinSales\").children('option:selected').val();\r\n");
