<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.feessubjectclass" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("<script type=\"text/javascript\" src=\"/public/js/feessubjectclass.js\"></" + "script>\r\n");
	...
	templateBuilder.Append("    <td align=\"left\" style=\"height:100%;width:100%\">\r\n");
	templateBuilder.Append("         <table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"0\" cellspacing=\"0\" style=\"height:100%;\">\r\n");
	templateBuilder.Append("         <tr>\r\n");
	templateBuilder.Append("           <td align=\"left\" style=\"width:25%\">\r\n");
	templateBuilder.Append("               <table width=\"100%\" border=\"0\" cellpadding=\"4\" cellspacing=\"1\" style=\" background-color:#cccccc;height:100%\">\r\n");
	templateBuilder.Append("               <tr><td><b>科目分类</b></td></tr>\r\n");
	templateBuilder.Append("               </table>\r\n");
	templateBuilder.Append("           </td>\r\n");
	templateBuilder.Append("           <td style=\"width:75%\">\r\n");
	templateBuilder.Append("                <table width=\"100%\" border=\"0\" cellpadding=\"4\" cellspacing=\"1\" style=\" background-color:#cccccc;height:100%\">\r\n");
	templateBuilder.Append("                <tr><td colspan=\"6\"> \r\n");
	templateBuilder.Append("                <b>当前选择：</b><input type=\"text\"  id=\"tSel\" disabled=\"disabled\" />&nbsp;&nbsp;&nbsp;\r\n");
	templateBuilder.Append("                <input type=\"hidden\" id=\"dClassID\" name=\"dClassID\" />\r\n");
	...
	templateBuilder.Append("             <table width=\"100%\" border=\"0\" cellpadding=\"4\" cellspacing=\"1\"  style=\"background-color:#EDEDED\">\r\n");
	templateBuilder.Append("             <tr><td style=\"height:26px\">&nbsp;</td></tr>\r\n");
	templateBuilder.Append("                 <tr>\r\n");
	templateBuilder.Append("                     <td>\r\n");
	templateBuilder.Append("                      <div id=\"tTree\" class=\"tTree\" style=\"width:90%;height:370px; border:1px solid #cccccc\"></div>\r\n");
	templateBuilder.Append("                     </td>\r\n");
	templateBuilder.Append("                 </tr>\r\n");
	templateBuilder.Append("             <tr>\r\n");
	templateBuilder.Append("              <td style=\"background-color:#EDEDED;height:26px\"></td>\r\n");
	templateBuilder.Append("             </tr>\r\n");
	templateBuilder.Append("             </table>\r\n");
	templateBuilder.Append("         </td>\r\n");
	templateBuilder.Append("         <td >\r\n");
	templateBuilder.Append("               <table  border=\"0\" cellpadding=\"4\" cellspacing=\"1\" style=\"background-color:#EDEDED;width:100%;height:100%\">\r\n");
	templateBuilder.Append("               <tr style=\"height:24px\">\r\n");
	templateBuilder.Append("                 <td colspan=\"5\">\r\n");
	templateBuilder.Append("                   <div id=\"muen\">\r\n");
	templateBuilder.Append("                    <input type=\"button\" id=\"btn_delete\" name=\"btn_del\" value=\"选中删除 - \" class=\"B_INPUT\" style=\"cursor:pointer\" />\r\n");
	templateBuilder.Append("                    <input type=\"button\" id=\"add_folder\" class=\"B_INPUT\" name=\"add_folder\" value=\"添加分类 + \"  style=\"cursor:pointer\"/>\r\n");
	templateBuilder.Append("                   </div>\r\n");
	templateBuilder.Append("                 </td>\r\n");
	templateBuilder.Append("               </tr>\r\n");
	templateBuilder.Append("               <tr>\r\n");
	templateBuilder.Append("               <td colspan=\"5\" style=\"background-color:#EDEDED\">\r\n");
	templateBuilder.Append("               <!--选项卡1-->\r\n");
	templateBuilder.Append("               <div align=\"center\" id=\"divOne\" style=\"height:372px;width:100%; overflow-y:scroll;background-color:#ffffff; border:1px solid #cccccc\">\r\n");
	templateBuilder.Append("                <table id=\"edTable\" width=\"100%\" border=\"0\" cellspacing=\"2\" cellpadding=\"2\" style=\"margin-top:0px\">\r\n");
	templateBuilder.Append("                <tr class=\"tBar\" align=\"center\">\r\n");
	templateBuilder.Append("                    <td align=\"center\" style=\"width:5%\"><input id=\"Checkbox1\" class=\"B_Check\" name=\"Checkbox1\" type=\"checkbox\"  style=\"width:25px\"/></td>\r\n");
	templateBuilder.Append("                    <td style=\"width:20%\">名称</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">类型</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">借贷关系</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:15%\">上级分类</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:5%\">排序</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">凭证启用状态</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:15%\">操作时间</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">操作</td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	...
	int pl__loop__id=0;
	foreach(DataRow pl in pParent.Rows)
	{
		pl__loop__id++;

	 cState = state(pl["FeesSubjectClassID"].ToString().Trim());
	
	templateBuilder.Append("                 <tr class=\"tBar\"  align=\"center\" style=\"font-weight:normal\">\r\n");
	templateBuilder.Append("                    <td style=\"width:5%\">\r\n");
	templateBuilder.Append("                      <input class=\"checkID\" name=\"checkID\" type=\"checkbox\" value=\"" + pl["FeesSubjectClassID"].ToString().Trim() + "\" style=\"width:25px\"/>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td align=\"left\" style=\"width:20%\">" + pl["cClassName"].ToString().Trim() + "(" + pl["cCode"].ToString().Trim() + ")</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">\r\n");

	if (pl["cType"].ToString()=="0")
	{

	templateBuilder.Append("资产\r\n");

	}	//end if


	if (pl["cType"].ToString()=="1")
	{

	templateBuilder.Append("负债\r\n");

	}	//end if


	if (pl["cType"].ToString()=="2")
	{

	templateBuilder.Append("权益\r\n");

	}	//end if


	if (pl["cType"].ToString()=="3")
	{

	templateBuilder.Append("损益\r\n");

	}	//end if


	if (pl["cType"].ToString()=="4")
	{

	templateBuilder.Append("成本\r\n");
	...
	templateBuilder.Append("" + pl["parentName"].ToString().Trim() + "\r\n");

	}	//end if

	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:5%\">" + pl["cOrder"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">\r\n");
	...
	templateBuilder.Append("                    <a onclick=\"javascript:FeesSubjectClass.ShowMoveBox('" + pl["FeesSubjectClassID"].ToString().Trim() + "','" + pl["cClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">已启用</a>\r\n");

	}
	else
	{

	templateBuilder.Append("                    已启用\r\n");
	...
	templateBuilder.Append("                    未启用\r\n");

	}	//end if

	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                    <td style=\"width:15%\">" + pl["cAppendTime"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                    <td style=\"width:10%\">\r\n");
	templateBuilder.Append("                    <a id=\"upd\" onclick=\"javascript:FeesSubjectClass.ShowEditBox('" + pl["FeesSubjectClassID"].ToString().Trim() + "')\" style=\"cursor:pointer\">修改</a>&nbsp;&nbsp;<a class=\"remove\" onclick=\"javascript:FeesSubjectClass.DeleteNode('" + pl["FeesSubjectClassID"].ToString().Trim() + "','" + pl["cParentID"].ToString().Trim() + "','" + pl["cClassName"].ToString().Trim() + "')\" style=\"cursor:pointer\">删除</a>\r\n");
	templateBuilder.Append("                    </td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	...
	templateBuilder.Append("	var FeesSubjectClass = new TFeesSubjectClass();\r\n");
	templateBuilder.Append("	FeesSubjectClass.ini();\r\n");
	templateBuilder.Append("	function HidBox() {\r\n");
	templateBuilder.Append("	    FeesSubjectClass.HidBox();\r\n");
	templateBuilder.Append("	}\r\n");
	templateBuilder.Append(" </" + "script>\r\n");
