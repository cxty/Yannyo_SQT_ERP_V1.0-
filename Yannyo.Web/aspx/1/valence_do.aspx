<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Yannyo.Web.valence_do" %>
...
override protected void OnLoad(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("                  <td colspan=\"2\" align=\"left\"><h1>变价信息</h1></td>\r\n");
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("                <tr>\r\n");
	...
	templateBuilder.Append("value=\"" + vi.ProductsName.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("value=\"" + vi.ProductsID.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("                  <td  align=\"right\">期间价格</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\">\r\n");
	templateBuilder.Append("                  <input name=\"vPrice\" id=\"vPrice\"  type=\"text\" \r\n");

	if (Act=="Edit")
	{

	templateBuilder.Append("value=\"" + vi.vPrice.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("                </tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("                  <td  align=\"right\">开始时间</td>\r\n");
	templateBuilder.Append("                  <td align=\"left\">\r\n");
	...
	templateBuilder.Append("value=\"" + vi.bDateTime.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("value=\"" + vi.eDateTime.ToString().Trim() + "\"\r\n");
	...
	templateBuilder.Append("					{\r\n");
	templateBuilder.Append("						if(Sys.getObj('vPrice').value != '')\r\n");
	templateBuilder.Append("						{\r\n");
	...
	templateBuilder.Append("							}else\r\n");
	templateBuilder.Append("							{\r\n");
	templateBuilder.Append("								alert('开始时间不能为空!');	\r\n");
	templateBuilder.Append("							}\r\n");
	templateBuilder.Append("						}else\r\n");
	templateBuilder.Append("						{\r\n");
	templateBuilder.Append("							alert('期间价格不能为空!');	\r\n");
	templateBuilder.Append("						}\r\n");
	templateBuilder.Append("					}else\r\n");
	templateBuilder.Append("					{\r\n");
