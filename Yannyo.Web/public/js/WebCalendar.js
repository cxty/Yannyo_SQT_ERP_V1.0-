/*
onclick="SelectDate(this,'yyyy 年')" readonly="true"  
onclick="SelectDate(this,'yyyy 年 MM 月')" readonly="true"
onclick="SelectDate(this,'yyyy\/MM\/dd')" readonly="true" 
onclick="SelectDate(this,'yyyy-MM-dd hh时')" readonly="true"
onclick="SelectDate(this,'yyyy-MM-dd hh:mm')" readonly="true" 
onclick="SelectDate(this,'yyyy年MM月dd日 hh时mm分ss秒',0,-150)"
...
//显示日历,cxty
Calendar.prototype.show = function(dateObj)
{
	SelectDate(dateObj,'yyyy-MM-dd');
}

Calendar.prototype.showB = function (dateObj, popControl) {
