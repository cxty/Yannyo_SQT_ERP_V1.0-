...
function WebFXCheckBoxTreeItem(sText, sAction, bChecked, eParent, sIcon, sOpenIcon, sValue, iAction) {
...
WebFXCheckBoxTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	str += "<input type=\"checkbox\"" +
		...
		" onclick=\"webFXTreeHandler.all[this.parentNode.id].setChecked(this.checked);"+this._iAction+"\"" +
		" />";
	// end insert checkbox
	}
...
WebFXCheckBoxTreeItem.prototype.setCheckedB = function (bChecked) {
		var divEl = document.getElementById(this.id);
		var inputEl = divEl.getElementsByTagName("INPUT")[0];
		this._checked = inputEl.checked = bChecked;
